module github.com/openshift/terraform-providers/alicloud
...
// https://issues.redhat.com/browse/OCPBUGS-11418
replace github.com/hashicorp/vault => github.com/hashicorp/vault v1.11.9
