...
const (
	sdkName             = "ibm-backup-recovery-sdk-go"
...
// Parameters:
//
//	serviceName - the name of the service as defined in the API definition (e.g. "BackupRecoveryV1")
...
func GetComponentInfo() *core.ProblemComponent {
	...
	return core.NewProblemComponent("github.com/IBM/ibm-backup-recovery-sdk-go", Version)
}
