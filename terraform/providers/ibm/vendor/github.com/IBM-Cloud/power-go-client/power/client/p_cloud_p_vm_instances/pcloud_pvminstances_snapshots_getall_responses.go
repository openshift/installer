...
/*PcloudPvminstancesSnapshotsGetallUnauthorized handles this case with default header values.
...
/*PcloudPvminstancesSnapshotsGetallNotFound handles this case with default header values.
