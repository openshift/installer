...
require (
	...
	github.com/nutanix-cloud-native/cluster-api-provider-nutanix v1.9.0
	...
	sigs.k8s.io/cluster-api-provider-azure v1.22.2
...
// Assisted service v0.0.0 replacements
replace (
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20260327095739-acc864619cae
	github.com/openshift/assisted-service/client => github.com/openshift/assisted-service/client v0.0.0-20260327095739-acc864619cae
	github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models v0.0.0-20260327095739-acc864619cae
)
