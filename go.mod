...
replace (
	...
	// Use fork with dual stack support from PR #1582
	sigs.k8s.io/cluster-api-provider-gcp => github.com/barbacbd/k8s-cluster-api-provider-gcp v0.0.0-20260325195325-97ab30c753cd
)
