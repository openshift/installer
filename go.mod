...
// use a local version of capa
replace sigs.k8s.io/cluster-api-provider-aws/v2 => /home/thvo/workspace/cluster-api-provider-aws

// conflicting with IBM cloud, need to use an older version of CAPI
