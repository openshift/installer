...
require (
	...
	github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3 // indirect
...
replace (
	...
	github.com/openshift/machine-api-operator => github.com/mgugino-upstream-stage/machine-api-operator v1.99.1
