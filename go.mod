...
require (
	...
	github.com/hashicorp/terraform-provider-dns v1.0.1-0.20230308072054-5d1b53130260 // indirect
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20230213202419-42edf4f1d905
