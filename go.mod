...
replace (
	...
	github.com/hashicorp/terraform => github.com/openshift/terraform v0.14.6-openshift-1 // Pin to fork with deduplicated rpc types v0.14.6-openshift-1
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/openshift/terraform-provider-aws v1.60.1-0.20210218025915-fa53a829a8e1 // Pin to openshift fork with tag v3.1.0-openshift-1
	github.com/terraform-providers/terraform-provider-azurerm => github.com/openshift/terraform-provider-azurerm v1.44.1-0.20210224232508-7509319df0f4 // Pin to openshift fork with tag v2.48.0-openshift
