...
replace (
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20200903234539-adda352ad43d // Pin MCO so it doesn't get downgraded
