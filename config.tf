...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    tnc_operator                         = "quay.io/coreos/tectonic-node-controller-operator-dev:4ea06d9f277a749f88d8d8d9fb0f5bcd0b4a85ac"
    ...
    tectonic_utility_operator            = "quay.io/coreos/tectonic-utility-operator-dev:4ea06d9f277a749f88d8d8d9fb0f5bcd0b4a85ac"
    tectonic_network_operator            = "quay.io/coreos/tectonic-network-operator-dev:4ea06d9f277a749f88d8d8d9fb0f5bcd0b4a85ac"
  }
}
