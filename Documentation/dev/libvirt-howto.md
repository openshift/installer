...
This will take ~30 minutes to be available. Simply go to `https://$CLUSTER_NAME.BASE_DOMAIN:6443/console/` (e.g. `test1.tt.testing`) and log in using the credentials above.
