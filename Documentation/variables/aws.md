...
| tectonic_aws_etcd_ec2_type | Instance size for the etcd node(s). Example: `t2.medium`. Read the [etcd recommended hardware][etcd-rec-hardware] guide for best performance | string | `t2.medium` |
...
[etcd-rec-hardware]: https://coreos.com/etcd/docs/latest/op-guide/hardware.html
