...
| tectonic_etcd_tls_enabled | (optional) If set to `true`, TLS secure communication for etcd will be used.<br><br>Note: This is variable has no effect if `tectonic_experimental` is set to `true`. | string | `true` |
