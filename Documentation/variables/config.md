...
| tectonic_enable_boot_diagnostics | (optional) Enable boot diagnostics for example the boot logs. It is only supported for Azure cloud provider. Used to collect the boot logs for debug purposes. | string | `false` |
