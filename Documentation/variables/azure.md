...
| tectonic_azure_etcd_vm_size | Instance size for the etcd node(s). Example: Standard_DS2. | string | `Standard_DS2` |
...
| tectonic_azure_master_vm_size | Instance size for the master node(s). Example: Standard_DS2. | string | `Standard_DS2` |
...
| tectonic_azure_worker_vm_size | Instance size for the worker node(s). Example: Standard_DS2. | string | `Standard_DS2` |
