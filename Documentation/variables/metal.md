...
|------|-------------|:----:|:-----:|:-----:|
| tectonic_matchbox_ca | Matchbox CA certificate to trust | string | - | yes |
| tectonic_matchbox_client_cert | Matchbox client TLS certificate | string | - | yes |
| tectonic_matchbox_client_key | Matchbox client TLS key | string | - | yes |
| tectonic_matchbox_http_endpoint | Matchbox HTTP read-only endpoint (e.g. http://matchbox.example.com:8080) | string | - | yes |
| tectonic_matchbox_rpc_endpoint | Matchbox gRPC API endpoint (e.g. matchbox.example.com:8081) | string | - | yes |
