...
output "worker_sg_id" {
  value = data.aws_security_group.worker.id
}
...
output "aws_lb_api_external_dns_name" {
  value = local.public_endpoints ? data.aws_lb.api_external[0].dns_name : null
}

output "aws_lb_api_external_zone_id" {
  value = local.public_endpoints ? data.aws_lb.api_external[0].zone_id : null
}

output "aws_lb_api_internal_dns_name" {
  value = data.aws_lb.api_internal.dns_name
}

output "aws_lb_api_internal_zone_id" {
  value = data.aws_lb.api_internal.zone_id
}
