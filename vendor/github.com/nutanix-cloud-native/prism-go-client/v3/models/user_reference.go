...
func (m *UserReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
