...
func (m *VpcReference) validateKind(formats strfmt.Registry) error {
...
func (m *VpcReference) validateName(formats strfmt.Registry) error {
...
func (m *VpcReference) validateUUID(formats strfmt.Registry) error {
...
func (m *VpcReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VpcReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
