...
func (m *VtepGatewayReference) validateKind(formats strfmt.Registry) error {
...
func (m *VtepGatewayReference) validateName(formats strfmt.Registry) error {
...
func (m *VtepGatewayReference) validateUUID(formats strfmt.Registry) error {
...
func (m *VtepGatewayReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VtepGatewayReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
