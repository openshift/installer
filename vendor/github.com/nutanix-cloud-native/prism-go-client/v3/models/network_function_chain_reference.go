...
func (m *NetworkFunctionChainReference) validateKind(formats strfmt.Registry) error {
...
func (m *NetworkFunctionChainReference) validateName(formats strfmt.Registry) error {
...
func (m *NetworkFunctionChainReference) validateUUID(formats strfmt.Registry) error {
...
func (m *NetworkFunctionChainReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkFunctionChainReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkFunctionChainReference) UnmarshalBinary(b []byte) error {
	var res NetworkFunctionChainReference
