...
func (m *VolumeGroupReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VolumeGroupReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
