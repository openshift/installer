...
func (m *AvailabilityZoneReference) contextValidateKind(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AvailabilityZoneReference) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AvailabilityZoneReference) UnmarshalBinary(b []byte) error {
	var res AvailabilityZoneReference
