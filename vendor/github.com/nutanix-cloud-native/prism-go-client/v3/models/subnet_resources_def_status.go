...
func (m *SubnetResourcesDefStatus) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateIPUsageStats(formats); err != nil {
		res = append(res, err)
	}
...
func (m *SubnetResourcesDefStatus) validateAvailabilityZoneReferenceList(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateIPConfig(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateIPUsageStats(formats strfmt.Registry) error {
	if swag.IsZero(m.IPUsageStats) { // not required
		return nil
	}

	if m.IPUsageStats != nil {
		if err := m.IPUsageStats.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ip_usage_stats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ip_usage_stats")
			}
			return err
		}
	}
...
func (m *SubnetResourcesDefStatus) validateNetworkFunctionChainReference(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateReservedIPAddressList(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateVirtualNetworkReference(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateVirtualSwitchUUID(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) validateVpcReference(formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIPUsageStats(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SubnetResourcesDefStatus) contextValidateAvailabilityZoneReferenceList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) contextValidateIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) contextValidateIPUsageStats(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.IPUsageStats != nil {
		...
		if err := m.IPUsageStats.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ip_usage_stats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ip_usage_stats")
...
func (m *SubnetResourcesDefStatus) contextValidateNetworkFunctionChainReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) contextValidateVirtualNetworkReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) contextValidateVpcReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubnetResourcesDefStatus) UnmarshalBinary(b []byte) error {
	var res SubnetResourcesDefStatus
