	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"server_name": {
				...
				Required:     true,
				ForceNew:     true,
<<<<<<< HEAD:vendor/github.com/terraform-providers/terraform-provider-azurerm/azurerm/internal/services/mariadb/resource_arm_mariadb_virtual_network_rule.go
				ValidateFunc: validate.NoEmptyStrings,
=======
				ValidateFunc: validate.MariaDbServerServerName,
>>>>>>> 5aa20dd53... vendor: bump terraform-provider-azure to version v2.17.0:vendor/github.com/terraform-providers/terraform-provider-azurerm/azurerm/internal/services/mariadb/mariadb_virtual_network_rule_resource.go
			},
