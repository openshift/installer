...
import (
	...
	"github.com/IBM-Cloud/power-go-client/power/client/internal_prometheus"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *PowerIaasAPI {
	...
	cli.InternalPrometheus = internal_prometheus.New(transport, formats)
...
type PowerIaasAPI struct {
	...
	InternalPrometheus internal_prometheus.ClientService
...
func (c *PowerIaasAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.InternalPrometheus.SetTransport(transport)
