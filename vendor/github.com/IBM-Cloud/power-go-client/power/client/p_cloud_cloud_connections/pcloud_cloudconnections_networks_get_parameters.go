...
// NewPcloudCloudconnectionsNetworksGetParams creates a new PcloudCloudconnectionsNetworksGetParams object
// with the default values initialized.
func NewPcloudCloudconnectionsNetworksGetParams() *PcloudCloudconnectionsNetworksGetParams {
	var ()
	return &PcloudCloudconnectionsNetworksGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPcloudCloudconnectionsNetworksGetParamsWithTimeout creates a new PcloudCloudconnectionsNetworksGetParams object
...
// NewPcloudCloudconnectionsNetworksGetParamsWithContext creates a new PcloudCloudconnectionsNetworksGetParams object
...
// NewPcloudCloudconnectionsNetworksGetParamsWithHTTPClient creates a new PcloudCloudconnectionsNetworksGetParams object
...
/*PcloudCloudconnectionsNetworksGetParams contains all the parameters to send to the API endpoint
for the pcloud cloudconnections networks get operation typically these are written to a http.Request
*/
...
func (o *PcloudCloudconnectionsNetworksGetParams) WithTimeout(timeout time.Duration) *PcloudCloudconnectionsNetworksGetParams {
...
func (o *PcloudCloudconnectionsNetworksGetParams) WithContext(ctx context.Context) *PcloudCloudconnectionsNetworksGetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the pcloud cloudconnections networks get params
func (o *PcloudCloudconnectionsNetworksGetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the pcloud cloudconnections networks get params
func (o *PcloudCloudconnectionsNetworksGetParams) WithHTTPClient(client *http.Client) *PcloudCloudconnectionsNetworksGetParams {
...
func (o *PcloudCloudconnectionsNetworksGetParams) WithCloudInstanceID(cloudInstanceID string) *PcloudCloudconnectionsNetworksGetParams {
...
func (o *PcloudCloudconnectionsNetworksGetParams) WithNetworkID(networkID string) *PcloudCloudconnectionsNetworksGetParams {
...
func (o *PcloudCloudconnectionsNetworksGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
