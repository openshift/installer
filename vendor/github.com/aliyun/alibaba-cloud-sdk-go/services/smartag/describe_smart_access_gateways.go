...
type DescribeSmartAccessGatewaysRequest struct {
	*requests.RpcRequest
	...
	CanAssociateQos      requests.Boolean `position:"Query"`
	SoftwareVersion      string           `position:"Query"`
	UnboundAclIds        string           `position:"Query"`
	PageNumber           requests.Integer `position:"Query"`
	VersionComparator    string           `position:"Query"`
	ResourceGroupId      string           `position:"Query"`
	PageSize             requests.Integer `position:"Query"`
	InstanceType         string           `position:"Query"`
	HardwareType         string           `position:"Query"`
	SmartAGIds           *[]string        `position:"Query" name:"SmartAGIds"  type:"Repeated"`
	SerialNumber         string           `position:"Query"`
	ResourceOwnerAccount string           `position:"Query"`
	OwnerAccount         string           `position:"Query"`
	AssociatedCcnId      string           `position:"Query"`
	OwnerId              requests.Integer `position:"Query"`
	BusinessState        string           `position:"Query"`
