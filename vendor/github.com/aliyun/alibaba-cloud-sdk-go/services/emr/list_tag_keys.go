...
// ListTagKeys invokes the emr.ListTagKeys API synchronously
...
// ListTagKeysWithChan invokes the emr.ListTagKeys API asynchronously
...
// ListTagKeysWithCallback invokes the emr.ListTagKeys API asynchronously
...
func CreateListTagKeysRequest() (request *ListTagKeysRequest) {
	...
	request.InitWithApiInfo("Emr", "2016-04-08", "ListTagKeys", "emr", "openAPI")
