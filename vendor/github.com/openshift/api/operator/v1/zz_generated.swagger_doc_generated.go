...
var map_AWSNetworkLoadBalancerParameters = map[string]string{
	...
	"managedSecurityGroup": "managedSecurityGroup specifies whether the service load balancer should create and manage security group for the Network Load Balancer.",
}
