...
var map_AWSNetworkLoadBalancerParameters = map[string]string{
	...
	"securityGroups":       "securityGroups is a list of IDs or Names of Security Groups (SG) instances that are assigned to the Network Load Balancer. The following restrictions apply:\n\nOnly a single Security Group can be added (??). An SG can be allocated to only a single IngressController.\n\nSecurityGroups *AWSSecurityGroups `json:\"securityGroups\"`",
	"managedSecurityGroup": "managedSecurityGroup specifies whether the service load balancer should create and manage security groups for the Network Load Balancer.",
}
