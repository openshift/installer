...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSphereFailureDomainAffinity) DeepCopyInto(out *VSphereFailureDomainAffinity) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSphereFailureDomainAffinity.
func (in *VSphereFailureDomainAffinity) DeepCopy() *VSphereFailureDomainAffinity {
	if in == nil {
		return nil
	}
	out := new(VSphereFailureDomainAffinity)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VSpherePlatformFailureDomainSpec) DeepCopyInto(out *VSpherePlatformFailureDomainSpec) {
	*out = *in
	out.RegionAffinity = in.RegionAffinity
	out.ZoneAffinity = in.ZoneAffinity
