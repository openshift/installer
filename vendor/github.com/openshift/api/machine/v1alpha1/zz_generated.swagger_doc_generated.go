...
var map_FailureDomain = map[string]string{
	"":                        "FailureDomain defines a set of correlated fault domains across different OpenStack services: compute, storage, and network.",
	"computeAvailabilityZone": "ComputeAvailabilityZone is the name of a valid nova availability zone. The server will be created in this availability zone.",
	"storageAvailabilityZone": "StorageAvailabilityZone is the name of a valid cinder availability zone. This will be the availability zone of the root volume if one is specified.",
	"ports":                   "Ports defines a set of ports and their attached networks. These will be prepended to any another ports attached to the server.",
}

func (FailureDomain) SwaggerDoc() map[string]string {
	return map_FailureDomain
}
...
var map_OpenstackProviderSpec = map[string]string{
	...
	"availabilityZone": "The availability zone from which to launch the server. It is an error to set both this and `ComputeAvailabilityZone` in `FailureDomain`.",
	...
	"failureDomain":    "FailureDomain defines the failure domain this machine will be created in.",
}
...
var map_RootVolume = map[string]string{
	...
	"availabilityZone": "availabilityZone specifies the Cinder availability where the root volume will be created. It is an error to set both this and `StorageAvailabilityZone` in `FailureDomain`.",
