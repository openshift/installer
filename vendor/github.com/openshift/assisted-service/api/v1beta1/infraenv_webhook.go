...
// infraEnvCustomValidator handles validation for the InfraEnv resource.
type infraEnvCustomValidator struct{}

// SetupWebhookWithManager will setup the manager to manage the webhooks
func (r *InfraEnv) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, r).
		WithCustomValidator(&infraEnvCustomValidator{}).
		Complete()
}
...
var _ webhook.CustomValidator = &infraEnvCustomValidator{}

// ValidateCreate implements webhook.CustomValidator so a webhook will be registered for the type
func (v *infraEnvCustomValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	r, ok := obj.(*InfraEnv)
	if !ok {
		return nil, fmt.Errorf("expected an InfraEnv object but got %T", obj)
	}
...
func (v *infraEnvCustomValidator) ValidateUpdate(_ context.Context, oldObj runtime.Object, obj runtime.Object) (admission.Warnings, error) {
	r, ok := obj.(*InfraEnv)
	if !ok {
		return nil, fmt.Errorf("expected an InfraEnv object but got %T", obj)
	}
...
func (v *infraEnvCustomValidator) ValidateDelete(_ context.Context, _ runtime.Object) (admission.Warnings, error) {
	return nil, nil
}
