...
const (
	...
	// HostValidationIDInventoryNotPartiallyTruncated captures enum value "inventory-not-partially-truncated"
	HostValidationIDInventoryNotPartiallyTruncated HostValidationID = "inventory-not-partially-truncated"

	// HostValidationIDInventoryNotFullyTruncated captures enum value "inventory-not-fully-truncated"
	HostValidationIDInventoryNotFullyTruncated HostValidationID = "inventory-not-fully-truncated"
