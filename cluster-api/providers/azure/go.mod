...
require (
	...
	github.com/Azure/azure-sdk-for-go/profile/p20200901 v0.1.1 // indirect
...
replace sigs.k8s.io/cluster-api-provider-azure => /home/padillon/go/src/github.com/kubernetes-sigs/cluster-api-provider-azure
