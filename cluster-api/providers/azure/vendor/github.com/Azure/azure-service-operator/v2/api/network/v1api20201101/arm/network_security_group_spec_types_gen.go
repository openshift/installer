...
type NetworkSecurityGroup_Spec struct {
	...
	Properties *NetworkSecurityGroupPropertiesFormat `conversion:"noarmconversion" json:"properties,omitempty"`

	// Tags: Resource tags.
	Tags map[string]string `json:"tags,omitempty"`
}

var _ genruntime.ARMResourceSpec = &NetworkSecurityGroup_Spec{}
