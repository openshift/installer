...
replace sigs.k8s.io/cluster-api-provider-aws/v2 => github.com/vincepri/cluster-api-provider-aws/v2 v2.0.0-20231009215942-ef5186aa7eb8
...
require (
	...
	github.com/openshift-online/ocm-sdk-go v0.1.358 // indirect
