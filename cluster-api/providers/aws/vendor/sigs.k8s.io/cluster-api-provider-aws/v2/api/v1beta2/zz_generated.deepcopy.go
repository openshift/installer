...
func (in *AWSMachineStatus) DeepCopyInto(out *AWSMachineStatus) {
	*out = *in
	if in.SpotRequestStartTime != nil {
		in, out := &in.SpotRequestStartTime, &out.SpotRequestStartTime
		*out = (*in).DeepCopy()
	}
	if in.Addresses != nil {
...
func (in *SpotMarketOptions) DeepCopyInto(out *SpotMarketOptions) {
	*out = *in
	...
	if in.WaitingTimeout != nil {
		in, out := &in.WaitingTimeout, &out.WaitingTimeout
		*out = new(v1.Duration)
		**out = **in
	}
}
