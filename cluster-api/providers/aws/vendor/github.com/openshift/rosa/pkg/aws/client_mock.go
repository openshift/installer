...
//
//	mockgen-v0.4.0 -source=pkg/aws/client.go -package=aws -destination=pkg/aws/client_mock.go
//
...
// DeleteServiceAccountRole mocks base method.
func (m *MockClient) DeleteServiceAccountRole(roleName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteServiceAccountRole", roleName)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteServiceAccountRole indicates an expected call of DeleteServiceAccountRole.
func (mr *MockClientMockRecorder) DeleteServiceAccountRole(roleName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteServiceAccountRole", reflect.TypeOf((*MockClient)(nil).DeleteServiceAccountRole), roleName)
}
...
// GetServiceAccountRoleDetails mocks base method.
func (m *MockClient) GetServiceAccountRoleDetails(roleName string) (*types1.Role, []types1.AttachedPolicy, []string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServiceAccountRoleDetails", roleName)
	ret0, _ := ret[0].(*types1.Role)
	ret1, _ := ret[1].([]types1.AttachedPolicy)
	ret2, _ := ret[2].([]string)
	ret3, _ := ret[3].(error)
	return ret0, ret1, ret2, ret3
}

// GetServiceAccountRoleDetails indicates an expected call of GetServiceAccountRoleDetails.
func (mr *MockClientMockRecorder) GetServiceAccountRoleDetails(roleName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetServiceAccountRoleDetails", reflect.TypeOf((*MockClient)(nil).GetServiceAccountRoleDetails), roleName)
}
...
// ListServiceAccountRoles mocks base method.
func (m *MockClient) ListServiceAccountRoles(clusterName string) ([]types1.Role, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListServiceAccountRoles", clusterName)
	ret0, _ := ret[0].([]types1.Role)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListServiceAccountRoles indicates an expected call of ListServiceAccountRoles.
func (mr *MockClientMockRecorder) ListServiceAccountRoles(clusterName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListServiceAccountRoles", reflect.TypeOf((*MockClient)(nil).ListServiceAccountRoles), clusterName)
}
