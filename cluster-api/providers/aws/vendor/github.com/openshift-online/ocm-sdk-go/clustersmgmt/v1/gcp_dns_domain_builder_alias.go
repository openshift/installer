...
// GcpDnsDomainBuilder contains the data and logic needed to build 'gcp_dns_domain' objects.
//
...
type GcpDnsDomainBuilder = api_v1.GcpDnsDomainBuilder

// NewGcpDnsDomain creates a new builder of 'gcp_dns_domain' objects.
var NewGcpDnsDomain = api_v1.NewGcpDnsDomain
