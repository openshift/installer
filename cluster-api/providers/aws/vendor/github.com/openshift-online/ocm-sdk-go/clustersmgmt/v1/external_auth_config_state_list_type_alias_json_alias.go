...
// the given writer.
var MarshalExternalAuthConfigStateList = api_v1.MarshalExternalAuthConfigStateList

// WriteExternalAuthConfigStateList writes a list of value of the 'external_auth_config_state' type to
// the given stream.
var WriteExternalAuthConfigStateList = api_v1.WriteExternalAuthConfigStateList

// UnmarshalExternalAuthConfigStateList reads a list of values of the 'external_auth_config_state' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthConfigStateList = api_v1.UnmarshalExternalAuthConfigStateList

// ReadExternalAuthConfigStateList reads list of values of the ”external_auth_config_state' type from
// the given iterator.
var ReadExternalAuthConfigStateList = api_v1.ReadExternalAuthConfigStateList
