...
type AzureOperatorsAuthentication = api_v1.AzureOperatorsAuthentication
...
const AzureOperatorsAuthenticationListKind = api_v1.AzureOperatorsAuthenticationListKind
...
const AzureOperatorsAuthenticationListLinkKind = api_v1.AzureOperatorsAuthenticationListLinkKind

// AzureOperatorsAuthenticationNilKind is the name of the type used to nil lists of objects of
// type 'azure_operators_authentication'.
const AzureOperatorsAuthenticationListNilKind = api_v1.AzureOperatorsAuthenticationListNilKind

type AzureOperatorsAuthenticationList = api_v1.AzureOperatorsAuthenticationList
