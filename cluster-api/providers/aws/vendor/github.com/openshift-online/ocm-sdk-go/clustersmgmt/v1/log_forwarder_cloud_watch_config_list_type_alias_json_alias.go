...
// the given writer.
var MarshalLogForwarderCloudWatchConfigList = api_v1.MarshalLogForwarderCloudWatchConfigList

// WriteLogForwarderCloudWatchConfigList writes a list of value of the 'log_forwarder_cloud_watch_config' type to
// the given stream.
var WriteLogForwarderCloudWatchConfigList = api_v1.WriteLogForwarderCloudWatchConfigList
...
var UnmarshalLogForwarderCloudWatchConfigList = api_v1.UnmarshalLogForwarderCloudWatchConfigList

// ReadLogForwarderCloudWatchConfigList reads list of values of the ”log_forwarder_cloud_watch_config' type from
// the given iterator.
var ReadLogForwarderCloudWatchConfigList = api_v1.ReadLogForwarderCloudWatchConfigList
