...
type GcpPrivateServiceConnect = api_v1.GcpPrivateServiceConnect
...
const GcpPrivateServiceConnectListKind = api_v1.GcpPrivateServiceConnectListKind
...
const GcpPrivateServiceConnectListLinkKind = api_v1.GcpPrivateServiceConnectListLinkKind

// GcpPrivateServiceConnectNilKind is the name of the type used to nil lists of objects of
// type 'gcp_private_service_connect'.
const GcpPrivateServiceConnectListNilKind = api_v1.GcpPrivateServiceConnectListNilKind

type GcpPrivateServiceConnectList = api_v1.GcpPrivateServiceConnectList
