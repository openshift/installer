...
const AddOnInstallationBillingKind = api_v1.AddOnInstallationBillingKind
...
const AddOnInstallationBillingLinkKind = api_v1.AddOnInstallationBillingLinkKind

// AddOnInstallationBillingNilKind is the name of the type used to nil references
// to objects of type 'add_on_installation_billing'.
const AddOnInstallationBillingNilKind = api_v1.AddOnInstallationBillingNilKind
...
type AddOnInstallationBilling = api_v1.AddOnInstallationBilling
...
const AddOnInstallationBillingListKind = api_v1.AddOnInstallationBillingListKind
...
const AddOnInstallationBillingListLinkKind = api_v1.AddOnInstallationBillingListLinkKind

// AddOnInstallationBillingNilKind is the name of the type used to nil lists of objects of
// type 'add_on_installation_billing'.
const AddOnInstallationBillingListNilKind = api_v1.AddOnInstallationBillingListNilKind

type AddOnInstallationBillingList = api_v1.AddOnInstallationBillingList
