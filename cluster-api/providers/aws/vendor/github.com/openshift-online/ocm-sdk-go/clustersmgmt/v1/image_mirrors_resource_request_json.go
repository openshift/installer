...
func writeImageMirrorsAddRequest(request *ImageMirrorsAddRequest, writer io.Writer) error {
	return MarshalImageMirror(request.body, writer)
}
func readImageMirrorsAddResponse(response *ImageMirrorsAddResponse, reader io.Reader) error {
	var err error
