...
type ProvisionShardTopology = api_v1.ProvisionShardTopology

const (
	// Provision shard for hosted clusters is configured in a "dedicated" topology.
	ProvisionShardTopologyDedicated ProvisionShardTopology = api_v1.ProvisionShardTopologyDedicated
)
