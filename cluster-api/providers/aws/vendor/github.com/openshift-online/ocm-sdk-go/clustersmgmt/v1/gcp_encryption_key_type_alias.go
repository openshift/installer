...
const GCPEncryptionKeyListLinkKind = api_v1.GCPEncryptionKeyListLinkKind

// GCPEncryptionKeyNilKind is the name of the type used to nil lists of objects of
// type 'GCP_encryption_key'.
const GCPEncryptionKeyListNilKind = api_v1.GCPEncryptionKeyListNilKind

type GCPEncryptionKeyList = api_v1.GCPEncryptionKeyList
