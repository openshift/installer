...
type AzureServiceManagedIdentity = api_v1.AzureServiceManagedIdentity
...
const AzureServiceManagedIdentityListKind = api_v1.AzureServiceManagedIdentityListKind
...
const AzureServiceManagedIdentityListLinkKind = api_v1.AzureServiceManagedIdentityListLinkKind

// AzureServiceManagedIdentityNilKind is the name of the type used to nil lists of objects of
// type 'azure_service_managed_identity'.
const AzureServiceManagedIdentityListNilKind = api_v1.AzureServiceManagedIdentityListNilKind

type AzureServiceManagedIdentityList = api_v1.AzureServiceManagedIdentityList
