...
type PrivateLinkClusterConfiguration = api_v1.PrivateLinkClusterConfiguration
...
const PrivateLinkClusterConfigurationListKind = api_v1.PrivateLinkClusterConfigurationListKind
...
const PrivateLinkClusterConfigurationListLinkKind = api_v1.PrivateLinkClusterConfigurationListLinkKind

// PrivateLinkClusterConfigurationNilKind is the name of the type used to nil lists of objects of
// type 'private_link_cluster_configuration'.
const PrivateLinkClusterConfigurationListNilKind = api_v1.PrivateLinkClusterConfigurationListNilKind

type PrivateLinkClusterConfigurationList = api_v1.PrivateLinkClusterConfigurationList
