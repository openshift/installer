...
type ExternalAuthClientType = api_v1.ExternalAuthClientType
...
const (
	...
	ExternalAuthClientTypeConfidential ExternalAuthClientType = api_v1.ExternalAuthClientTypeConfidential
	// Indicates that the client is public
	//
	// Public clients must not provide a client secret
	ExternalAuthClientTypePublic ExternalAuthClientType = api_v1.ExternalAuthClientTypePublic
)
