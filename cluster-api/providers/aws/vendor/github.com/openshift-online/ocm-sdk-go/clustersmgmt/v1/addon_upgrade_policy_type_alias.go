...
const AddonUpgradePolicyKind = api_v1.AddonUpgradePolicyKind

// AddonUpgradePolicyLinkKind is the name of the type used to represent links
// to objects of type 'addon_upgrade_policy'.
const AddonUpgradePolicyLinkKind = api_v1.AddonUpgradePolicyLinkKind

// AddonUpgradePolicyNilKind is the name of the type used to nil references
// to objects of type 'addon_upgrade_policy'.
const AddonUpgradePolicyNilKind = api_v1.AddonUpgradePolicyNilKind
...
type AddonUpgradePolicy = api_v1.AddonUpgradePolicy

// AddonUpgradePolicyListKind is the name of the type used to represent list of objects of
// type 'addon_upgrade_policy'.
const AddonUpgradePolicyListKind = api_v1.AddonUpgradePolicyListKind
...
const AddonUpgradePolicyListLinkKind = api_v1.AddonUpgradePolicyListLinkKind

// AddonUpgradePolicyNilKind is the name of the type used to nil lists of objects of
// type 'addon_upgrade_policy'.
const AddonUpgradePolicyListNilKind = api_v1.AddonUpgradePolicyListNilKind

type AddonUpgradePolicyList = api_v1.AddonUpgradePolicyList
