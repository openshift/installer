...
// the given writer.
var MarshalLogForwarderGroupList = api_v1.MarshalLogForwarderGroupList

// WriteLogForwarderGroupList writes a list of value of the 'log_forwarder_group' type to
// the given stream.
var WriteLogForwarderGroupList = api_v1.WriteLogForwarderGroupList

// UnmarshalLogForwarderGroupList reads a list of values of the 'log_forwarder_group' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLogForwarderGroupList = api_v1.UnmarshalLogForwarderGroupList

// ReadLogForwarderGroupList reads list of values of the ”log_forwarder_group' type from
// the given iterator.
var ReadLogForwarderGroupList = api_v1.ReadLogForwarderGroupList
