...
const ProductMinimalVersionKind = api_v1.ProductMinimalVersionKind

// ProductMinimalVersionLinkKind is the name of the type used to represent links
// to objects of type 'product_minimal_version'.
const ProductMinimalVersionLinkKind = api_v1.ProductMinimalVersionLinkKind

// ProductMinimalVersionNilKind is the name of the type used to nil references
// to objects of type 'product_minimal_version'.
const ProductMinimalVersionNilKind = api_v1.ProductMinimalVersionNilKind
...
type ProductMinimalVersion = api_v1.ProductMinimalVersion

// ProductMinimalVersionListKind is the name of the type used to represent list of objects of
// type 'product_minimal_version'.
const ProductMinimalVersionListKind = api_v1.ProductMinimalVersionListKind
...
const ProductMinimalVersionListLinkKind = api_v1.ProductMinimalVersionListLinkKind

// ProductMinimalVersionNilKind is the name of the type used to nil lists of objects of
// type 'product_minimal_version'.
const ProductMinimalVersionListNilKind = api_v1.ProductMinimalVersionListNilKind

type ProductMinimalVersionList = api_v1.ProductMinimalVersionList
