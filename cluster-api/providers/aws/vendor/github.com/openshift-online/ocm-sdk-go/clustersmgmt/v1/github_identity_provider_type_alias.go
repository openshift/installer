...
type GithubIdentityProvider = api_v1.GithubIdentityProvider

// GithubIdentityProviderListKind is the name of the type used to represent list of objects of
// type 'github_identity_provider'.
const GithubIdentityProviderListKind = api_v1.GithubIdentityProviderListKind
...
const GithubIdentityProviderListLinkKind = api_v1.GithubIdentityProviderListLinkKind

// GithubIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'github_identity_provider'.
const GithubIdentityProviderListNilKind = api_v1.GithubIdentityProviderListNilKind

type GithubIdentityProviderList = api_v1.GithubIdentityProviderList
