...
//
// ```
type ClusterRegistration = api_v1.ClusterRegistration

// ClusterRegistrationListKind is the name of the type used to represent list of objects of
// type 'cluster_registration'.
const ClusterRegistrationListKind = api_v1.ClusterRegistrationListKind
...
const ClusterRegistrationListLinkKind = api_v1.ClusterRegistrationListLinkKind

// ClusterRegistrationNilKind is the name of the type used to nil lists of objects of
// type 'cluster_registration'.
const ClusterRegistrationListNilKind = api_v1.ClusterRegistrationListNilKind

type ClusterRegistrationList = api_v1.ClusterRegistrationList
