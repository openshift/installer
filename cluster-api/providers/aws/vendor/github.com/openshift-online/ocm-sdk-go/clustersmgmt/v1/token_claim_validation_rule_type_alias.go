...
type TokenClaimValidationRule = api_v1.TokenClaimValidationRule
...
const TokenClaimValidationRuleListKind = api_v1.TokenClaimValidationRuleListKind
...
const TokenClaimValidationRuleListLinkKind = api_v1.TokenClaimValidationRuleListLinkKind

// TokenClaimValidationRuleNilKind is the name of the type used to nil lists of objects of
// type 'token_claim_validation_rule'.
const TokenClaimValidationRuleListNilKind = api_v1.TokenClaimValidationRuleListNilKind

type TokenClaimValidationRuleList = api_v1.TokenClaimValidationRuleList
