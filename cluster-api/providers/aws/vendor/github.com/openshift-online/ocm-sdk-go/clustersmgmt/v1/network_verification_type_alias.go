...
type NetworkVerification = api_v1.NetworkVerification

// NetworkVerificationListKind is the name of the type used to represent list of objects of
// type 'network_verification'.
const NetworkVerificationListKind = api_v1.NetworkVerificationListKind
...
const NetworkVerificationListLinkKind = api_v1.NetworkVerificationListLinkKind

// NetworkVerificationNilKind is the name of the type used to nil lists of objects of
// type 'network_verification'.
const NetworkVerificationListNilKind = api_v1.NetworkVerificationListNilKind

type NetworkVerificationList = api_v1.NetworkVerificationList
