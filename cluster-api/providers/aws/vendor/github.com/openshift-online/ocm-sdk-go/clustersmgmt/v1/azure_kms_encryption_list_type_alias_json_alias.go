...
// the given writer.
var MarshalAzureKmsEncryptionList = api_v1.MarshalAzureKmsEncryptionList

// WriteAzureKmsEncryptionList writes a list of value of the 'azure_kms_encryption' type to
// the given stream.
var WriteAzureKmsEncryptionList = api_v1.WriteAzureKmsEncryptionList

// UnmarshalAzureKmsEncryptionList reads a list of values of the 'azure_kms_encryption' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureKmsEncryptionList = api_v1.UnmarshalAzureKmsEncryptionList

// ReadAzureKmsEncryptionList reads list of values of the ”azure_kms_encryption' type from
// the given iterator.
var ReadAzureKmsEncryptionList = api_v1.ReadAzureKmsEncryptionList
