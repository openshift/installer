...
// the given writer.
var MarshalNodePoolManagementUpgradeList = api_v1.MarshalNodePoolManagementUpgradeList

// WriteNodePoolManagementUpgradeList writes a list of value of the 'node_pool_management_upgrade' type to
// the given stream.
var WriteNodePoolManagementUpgradeList = api_v1.WriteNodePoolManagementUpgradeList

// UnmarshalNodePoolManagementUpgradeList reads a list of values of the 'node_pool_management_upgrade' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalNodePoolManagementUpgradeList = api_v1.UnmarshalNodePoolManagementUpgradeList

// ReadNodePoolManagementUpgradeList reads list of values of the ”node_pool_management_upgrade' type from
// the given iterator.
var ReadNodePoolManagementUpgradeList = api_v1.ReadNodePoolManagementUpgradeList
