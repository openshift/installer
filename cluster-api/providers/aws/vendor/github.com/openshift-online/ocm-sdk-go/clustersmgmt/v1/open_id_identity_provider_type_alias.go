...
type OpenIDIdentityProvider = api_v1.OpenIDIdentityProvider
...
const OpenIDIdentityProviderListKind = api_v1.OpenIDIdentityProviderListKind
...
const OpenIDIdentityProviderListLinkKind = api_v1.OpenIDIdentityProviderListLinkKind

// OpenIDIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'open_ID_identity_provider'.
const OpenIDIdentityProviderListNilKind = api_v1.OpenIDIdentityProviderListNilKind

type OpenIDIdentityProviderList = api_v1.OpenIDIdentityProviderList
