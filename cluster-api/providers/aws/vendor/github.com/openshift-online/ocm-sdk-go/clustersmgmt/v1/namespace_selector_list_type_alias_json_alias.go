...
// the given writer.
var MarshalNamespaceSelectorList = api_v1.MarshalNamespaceSelectorList

// WriteNamespaceSelectorList writes a list of value of the 'namespace_selector' type to
// the given stream.
var WriteNamespaceSelectorList = api_v1.WriteNamespaceSelectorList

// UnmarshalNamespaceSelectorList reads a list of values of the 'namespace_selector' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalNamespaceSelectorList = api_v1.UnmarshalNamespaceSelectorList

// ReadNamespaceSelectorList reads list of values of the ”namespace_selector' type from
// the given iterator.
var ReadNamespaceSelectorList = api_v1.ReadNamespaceSelectorList
