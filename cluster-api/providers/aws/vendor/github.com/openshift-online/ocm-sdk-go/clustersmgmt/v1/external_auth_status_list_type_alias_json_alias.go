...
// the given writer.
var MarshalExternalAuthStatusList = api_v1.MarshalExternalAuthStatusList

// WriteExternalAuthStatusList writes a list of value of the 'external_auth_status' type to
// the given stream.
var WriteExternalAuthStatusList = api_v1.WriteExternalAuthStatusList

// UnmarshalExternalAuthStatusList reads a list of values of the 'external_auth_status' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthStatusList = api_v1.UnmarshalExternalAuthStatusList

// ReadExternalAuthStatusList reads list of values of the ”external_auth_status' type from
// the given iterator.
var ReadExternalAuthStatusList = api_v1.ReadExternalAuthStatusList
