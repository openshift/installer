...
type CPUTotalsNodeRoleOSMetricNode = api_v1.CPUTotalsNodeRoleOSMetricNode
...
const CPUTotalsNodeRoleOSMetricNodeListKind = api_v1.CPUTotalsNodeRoleOSMetricNodeListKind
...
const CPUTotalsNodeRoleOSMetricNodeListLinkKind = api_v1.CPUTotalsNodeRoleOSMetricNodeListLinkKind

// CPUTotalsNodeRoleOSMetricNodeNilKind is the name of the type used to nil lists of objects of
// type 'CPU_totals_node_role_OS_metric_node'.
const CPUTotalsNodeRoleOSMetricNodeListNilKind = api_v1.CPUTotalsNodeRoleOSMetricNodeListNilKind

type CPUTotalsNodeRoleOSMetricNodeList = api_v1.CPUTotalsNodeRoleOSMetricNodeList
