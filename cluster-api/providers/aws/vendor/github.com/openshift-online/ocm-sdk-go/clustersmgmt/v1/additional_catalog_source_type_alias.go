...
type AdditionalCatalogSource = api_v1.AdditionalCatalogSource
...
const AdditionalCatalogSourceListKind = api_v1.AdditionalCatalogSourceListKind
...
const AdditionalCatalogSourceListLinkKind = api_v1.AdditionalCatalogSourceListLinkKind

// AdditionalCatalogSourceNilKind is the name of the type used to nil lists of objects of
// type 'additional_catalog_source'.
const AdditionalCatalogSourceListNilKind = api_v1.AdditionalCatalogSourceListNilKind

type AdditionalCatalogSourceList = api_v1.AdditionalCatalogSourceList
