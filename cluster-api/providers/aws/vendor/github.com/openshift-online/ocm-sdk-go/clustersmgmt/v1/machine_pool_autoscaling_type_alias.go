...
const MachinePoolAutoscalingKind = api_v1.MachinePoolAutoscalingKind
...
const MachinePoolAutoscalingLinkKind = api_v1.MachinePoolAutoscalingLinkKind

// MachinePoolAutoscalingNilKind is the name of the type used to nil references
// to objects of type 'machine_pool_autoscaling'.
const MachinePoolAutoscalingNilKind = api_v1.MachinePoolAutoscalingNilKind
...
type MachinePoolAutoscaling = api_v1.MachinePoolAutoscaling

// MachinePoolAutoscalingListKind is the name of the type used to represent list of objects of
// type 'machine_pool_autoscaling'.
const MachinePoolAutoscalingListKind = api_v1.MachinePoolAutoscalingListKind
...
const MachinePoolAutoscalingListLinkKind = api_v1.MachinePoolAutoscalingListLinkKind

// MachinePoolAutoscalingNilKind is the name of the type used to nil lists of objects of
// type 'machine_pool_autoscaling'.
const MachinePoolAutoscalingListNilKind = api_v1.MachinePoolAutoscalingListNilKind

type MachinePoolAutoscalingList = api_v1.MachinePoolAutoscalingList
