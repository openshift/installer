...
const AWSInfrastructureAccessRoleKind = api_v1.AWSInfrastructureAccessRoleKind
...
const AWSInfrastructureAccessRoleLinkKind = api_v1.AWSInfrastructureAccessRoleLinkKind

// AWSInfrastructureAccessRoleNilKind is the name of the type used to nil references
// to objects of type 'AWS_infrastructure_access_role'.
const AWSInfrastructureAccessRoleNilKind = api_v1.AWSInfrastructureAccessRoleNilKind
...
type AWSInfrastructureAccessRole = api_v1.AWSInfrastructureAccessRole
...
const AWSInfrastructureAccessRoleListKind = api_v1.AWSInfrastructureAccessRoleListKind
...
const AWSInfrastructureAccessRoleListLinkKind = api_v1.AWSInfrastructureAccessRoleListLinkKind

// AWSInfrastructureAccessRoleNilKind is the name of the type used to nil lists of objects of
// type 'AWS_infrastructure_access_role'.
const AWSInfrastructureAccessRoleListNilKind = api_v1.AWSInfrastructureAccessRoleListNilKind

type AWSInfrastructureAccessRoleList = api_v1.AWSInfrastructureAccessRoleList
