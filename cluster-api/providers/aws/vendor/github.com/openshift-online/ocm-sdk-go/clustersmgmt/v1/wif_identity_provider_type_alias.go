...
type WifIdentityProvider = api_v1.WifIdentityProvider

// WifIdentityProviderListKind is the name of the type used to represent list of objects of
// type 'wif_identity_provider'.
const WifIdentityProviderListKind = api_v1.WifIdentityProviderListKind
...
const WifIdentityProviderListLinkKind = api_v1.WifIdentityProviderListLinkKind

// WifIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'wif_identity_provider'.
const WifIdentityProviderListNilKind = api_v1.WifIdentityProviderListNilKind

type WifIdentityProviderList = api_v1.WifIdentityProviderList
