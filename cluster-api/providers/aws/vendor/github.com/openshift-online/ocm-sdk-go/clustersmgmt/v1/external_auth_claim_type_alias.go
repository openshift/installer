...
type ExternalAuthClaim = api_v1.ExternalAuthClaim

// ExternalAuthClaimListKind is the name of the type used to represent list of objects of
// type 'external_auth_claim'.
const ExternalAuthClaimListKind = api_v1.ExternalAuthClaimListKind
...
const ExternalAuthClaimListLinkKind = api_v1.ExternalAuthClaimListLinkKind

// ExternalAuthClaimNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_claim'.
const ExternalAuthClaimListNilKind = api_v1.ExternalAuthClaimListNilKind

type ExternalAuthClaimList = api_v1.ExternalAuthClaimList
