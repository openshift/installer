...
// the given writer.
var MarshalLogForwarderGroupVersionList = api_v1.MarshalLogForwarderGroupVersionList

// WriteLogForwarderGroupVersionList writes a list of value of the 'log_forwarder_group_version' type to
// the given stream.
var WriteLogForwarderGroupVersionList = api_v1.WriteLogForwarderGroupVersionList

// UnmarshalLogForwarderGroupVersionList reads a list of values of the 'log_forwarder_group_version' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLogForwarderGroupVersionList = api_v1.UnmarshalLogForwarderGroupVersionList

// ReadLogForwarderGroupVersionList reads list of values of the ”log_forwarder_group_version' type from
// the given iterator.
var ReadLogForwarderGroupVersionList = api_v1.ReadLogForwarderGroupVersionList
