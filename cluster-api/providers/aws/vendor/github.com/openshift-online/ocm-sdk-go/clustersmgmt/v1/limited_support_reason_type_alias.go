...
const LimitedSupportReasonKind = api_v1.LimitedSupportReasonKind

// LimitedSupportReasonLinkKind is the name of the type used to represent links
// to objects of type 'limited_support_reason'.
const LimitedSupportReasonLinkKind = api_v1.LimitedSupportReasonLinkKind

// LimitedSupportReasonNilKind is the name of the type used to nil references
// to objects of type 'limited_support_reason'.
const LimitedSupportReasonNilKind = api_v1.LimitedSupportReasonNilKind
...
type LimitedSupportReason = api_v1.LimitedSupportReason

// LimitedSupportReasonListKind is the name of the type used to represent list of objects of
// type 'limited_support_reason'.
const LimitedSupportReasonListKind = api_v1.LimitedSupportReasonListKind
...
const LimitedSupportReasonListLinkKind = api_v1.LimitedSupportReasonListLinkKind

// LimitedSupportReasonNilKind is the name of the type used to nil lists of objects of
// type 'limited_support_reason'.
const LimitedSupportReasonListNilKind = api_v1.LimitedSupportReasonListNilKind

type LimitedSupportReasonList = api_v1.LimitedSupportReasonList
