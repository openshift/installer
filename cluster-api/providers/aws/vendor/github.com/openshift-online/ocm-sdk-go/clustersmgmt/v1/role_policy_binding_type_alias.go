...
type RolePolicyBinding = api_v1.RolePolicyBinding

// RolePolicyBindingListKind is the name of the type used to represent list of objects of
// type 'role_policy_binding'.
const RolePolicyBindingListKind = api_v1.RolePolicyBindingListKind
...
const RolePolicyBindingListLinkKind = api_v1.RolePolicyBindingListLinkKind

// RolePolicyBindingNilKind is the name of the type used to nil lists of objects of
// type 'role_policy_binding'.
const RolePolicyBindingListNilKind = api_v1.RolePolicyBindingListNilKind

type RolePolicyBindingList = api_v1.RolePolicyBindingList
