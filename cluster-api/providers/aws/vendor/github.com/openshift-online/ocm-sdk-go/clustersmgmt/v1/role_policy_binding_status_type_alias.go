...
type RolePolicyBindingStatus = api_v1.RolePolicyBindingStatus
...
const RolePolicyBindingStatusListKind = api_v1.RolePolicyBindingStatusListKind
...
const RolePolicyBindingStatusListLinkKind = api_v1.RolePolicyBindingStatusListLinkKind

// RolePolicyBindingStatusNilKind is the name of the type used to nil lists of objects of
// type 'role_policy_binding_status'.
const RolePolicyBindingStatusListNilKind = api_v1.RolePolicyBindingStatusListNilKind

type RolePolicyBindingStatusList = api_v1.RolePolicyBindingStatusList
