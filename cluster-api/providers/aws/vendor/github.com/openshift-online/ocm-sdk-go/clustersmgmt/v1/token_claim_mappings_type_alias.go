...
type TokenClaimMappings = api_v1.TokenClaimMappings

// TokenClaimMappingsListKind is the name of the type used to represent list of objects of
// type 'token_claim_mappings'.
const TokenClaimMappingsListKind = api_v1.TokenClaimMappingsListKind
...
const TokenClaimMappingsListLinkKind = api_v1.TokenClaimMappingsListLinkKind

// TokenClaimMappingsNilKind is the name of the type used to nil lists of objects of
// type 'token_claim_mappings'.
const TokenClaimMappingsListNilKind = api_v1.TokenClaimMappingsListNilKind

type TokenClaimMappingsList = api_v1.TokenClaimMappingsList
