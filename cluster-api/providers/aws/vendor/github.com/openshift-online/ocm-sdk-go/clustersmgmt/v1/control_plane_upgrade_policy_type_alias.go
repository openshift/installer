...
const ControlPlaneUpgradePolicyKind = api_v1.ControlPlaneUpgradePolicyKind
...
const ControlPlaneUpgradePolicyLinkKind = api_v1.ControlPlaneUpgradePolicyLinkKind

// ControlPlaneUpgradePolicyNilKind is the name of the type used to nil references
// to objects of type 'control_plane_upgrade_policy'.
const ControlPlaneUpgradePolicyNilKind = api_v1.ControlPlaneUpgradePolicyNilKind
...
type ControlPlaneUpgradePolicy = api_v1.ControlPlaneUpgradePolicy
...
const ControlPlaneUpgradePolicyListKind = api_v1.ControlPlaneUpgradePolicyListKind
...
const ControlPlaneUpgradePolicyListLinkKind = api_v1.ControlPlaneUpgradePolicyListLinkKind

// ControlPlaneUpgradePolicyNilKind is the name of the type used to nil lists of objects of
// type 'control_plane_upgrade_policy'.
const ControlPlaneUpgradePolicyListNilKind = api_v1.ControlPlaneUpgradePolicyListNilKind

type ControlPlaneUpgradePolicyList = api_v1.ControlPlaneUpgradePolicyList
