...
type WifServiceAccount = api_v1.WifServiceAccount

// WifServiceAccountListKind is the name of the type used to represent list of objects of
// type 'wif_service_account'.
const WifServiceAccountListKind = api_v1.WifServiceAccountListKind
...
const WifServiceAccountListLinkKind = api_v1.WifServiceAccountListLinkKind

// WifServiceAccountNilKind is the name of the type used to nil lists of objects of
// type 'wif_service_account'.
const WifServiceAccountListNilKind = api_v1.WifServiceAccountListNilKind

type WifServiceAccountList = api_v1.WifServiceAccountList
