...
const AddOnRequirementListLinkKind = api_v1.AddOnRequirementListLinkKind

// AddOnRequirementNilKind is the name of the type used to nil lists of objects of
// type 'add_on_requirement'.
const AddOnRequirementListNilKind = api_v1.AddOnRequirementListNilKind

type AddOnRequirementList = api_v1.AddOnRequirementList
