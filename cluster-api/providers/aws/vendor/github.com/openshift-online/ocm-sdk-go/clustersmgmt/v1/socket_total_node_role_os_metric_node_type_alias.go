...
// by node role and OS.
type SocketTotalNodeRoleOSMetricNode = api_v1.SocketTotalNodeRoleOSMetricNode
...
const SocketTotalNodeRoleOSMetricNodeListKind = api_v1.SocketTotalNodeRoleOSMetricNodeListKind
...
const SocketTotalNodeRoleOSMetricNodeListLinkKind = api_v1.SocketTotalNodeRoleOSMetricNodeListLinkKind

// SocketTotalNodeRoleOSMetricNodeNilKind is the name of the type used to nil lists of objects of
// type 'socket_total_node_role_OS_metric_node'.
const SocketTotalNodeRoleOSMetricNodeListNilKind = api_v1.SocketTotalNodeRoleOSMetricNodeListNilKind

type SocketTotalNodeRoleOSMetricNodeList = api_v1.SocketTotalNodeRoleOSMetricNodeList
