...
const RegistryAllowlistKind = api_v1.RegistryAllowlistKind

// RegistryAllowlistLinkKind is the name of the type used to represent links
// to objects of type 'registry_allowlist'.
const RegistryAllowlistLinkKind = api_v1.RegistryAllowlistLinkKind

// RegistryAllowlistNilKind is the name of the type used to nil references
// to objects of type 'registry_allowlist'.
const RegistryAllowlistNilKind = api_v1.RegistryAllowlistNilKind
...
type RegistryAllowlist = api_v1.RegistryAllowlist

// RegistryAllowlistListKind is the name of the type used to represent list of objects of
// type 'registry_allowlist'.
const RegistryAllowlistListKind = api_v1.RegistryAllowlistListKind
...
const RegistryAllowlistListLinkKind = api_v1.RegistryAllowlistListLinkKind

// RegistryAllowlistNilKind is the name of the type used to nil lists of objects of
// type 'registry_allowlist'.
const RegistryAllowlistListNilKind = api_v1.RegistryAllowlistListNilKind

type RegistryAllowlistList = api_v1.RegistryAllowlistList
