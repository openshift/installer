...
const ExternalAuthConfigKind = api_v1.ExternalAuthConfigKind

// ExternalAuthConfigLinkKind is the name of the type used to represent links
// to objects of type 'external_auth_config'.
const ExternalAuthConfigLinkKind = api_v1.ExternalAuthConfigLinkKind

// ExternalAuthConfigNilKind is the name of the type used to nil references
// to objects of type 'external_auth_config'.
const ExternalAuthConfigNilKind = api_v1.ExternalAuthConfigNilKind
...
type ExternalAuthConfig = api_v1.ExternalAuthConfig

// ExternalAuthConfigListKind is the name of the type used to represent list of objects of
// type 'external_auth_config'.
const ExternalAuthConfigListKind = api_v1.ExternalAuthConfigListKind
...
const ExternalAuthConfigListLinkKind = api_v1.ExternalAuthConfigListLinkKind

// ExternalAuthConfigNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_config'.
const ExternalAuthConfigListNilKind = api_v1.ExternalAuthConfigListNilKind

type ExternalAuthConfigList = api_v1.ExternalAuthConfigList
