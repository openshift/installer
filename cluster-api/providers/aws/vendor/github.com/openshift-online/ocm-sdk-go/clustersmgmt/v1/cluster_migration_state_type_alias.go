...
type ClusterMigrationState = api_v1.ClusterMigrationState

// ClusterMigrationStateListKind is the name of the type used to represent list of objects of
// type 'cluster_migration_state'.
const ClusterMigrationStateListKind = api_v1.ClusterMigrationStateListKind
...
const ClusterMigrationStateListLinkKind = api_v1.ClusterMigrationStateListLinkKind

// ClusterMigrationStateNilKind is the name of the type used to nil lists of objects of
// type 'cluster_migration_state'.
const ClusterMigrationStateListNilKind = api_v1.ClusterMigrationStateListNilKind

type ClusterMigrationStateList = api_v1.ClusterMigrationStateList
