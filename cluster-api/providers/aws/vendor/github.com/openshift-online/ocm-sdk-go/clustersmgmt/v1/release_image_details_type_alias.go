...
type ReleaseImageDetails = api_v1.ReleaseImageDetails

// ReleaseImageDetailsListKind is the name of the type used to represent list of objects of
// type 'release_image_details'.
const ReleaseImageDetailsListKind = api_v1.ReleaseImageDetailsListKind
...
const ReleaseImageDetailsListLinkKind = api_v1.ReleaseImageDetailsListLinkKind

// ReleaseImageDetailsNilKind is the name of the type used to nil lists of objects of
// type 'release_image_details'.
const ReleaseImageDetailsListNilKind = api_v1.ReleaseImageDetailsListNilKind

type ReleaseImageDetailsList = api_v1.ReleaseImageDetailsList
