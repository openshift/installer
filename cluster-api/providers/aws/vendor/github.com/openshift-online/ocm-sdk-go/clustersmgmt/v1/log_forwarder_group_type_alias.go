...
type LogForwarderGroup = api_v1.LogForwarderGroup

// LogForwarderGroupListKind is the name of the type used to represent list of objects of
// type 'log_forwarder_group'.
const LogForwarderGroupListKind = api_v1.LogForwarderGroupListKind
...
const LogForwarderGroupListLinkKind = api_v1.LogForwarderGroupListLinkKind

// LogForwarderGroupNilKind is the name of the type used to nil lists of objects of
// type 'log_forwarder_group'.
const LogForwarderGroupListNilKind = api_v1.LogForwarderGroupListNilKind

type LogForwarderGroupList = api_v1.LogForwarderGroupList
