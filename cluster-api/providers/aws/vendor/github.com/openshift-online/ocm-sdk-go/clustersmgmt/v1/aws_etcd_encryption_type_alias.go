...
type AwsEtcdEncryption = api_v1.AwsEtcdEncryption

// AwsEtcdEncryptionListKind is the name of the type used to represent list of objects of
// type 'aws_etcd_encryption'.
const AwsEtcdEncryptionListKind = api_v1.AwsEtcdEncryptionListKind
...
const AwsEtcdEncryptionListLinkKind = api_v1.AwsEtcdEncryptionListLinkKind

// AwsEtcdEncryptionNilKind is the name of the type used to nil lists of objects of
// type 'aws_etcd_encryption'.
const AwsEtcdEncryptionListNilKind = api_v1.AwsEtcdEncryptionListNilKind

type AwsEtcdEncryptionList = api_v1.AwsEtcdEncryptionList
