...
type AzureKmsEncryption = api_v1.AzureKmsEncryption

// AzureKmsEncryptionListKind is the name of the type used to represent list of objects of
// type 'azure_kms_encryption'.
const AzureKmsEncryptionListKind = api_v1.AzureKmsEncryptionListKind
...
const AzureKmsEncryptionListLinkKind = api_v1.AzureKmsEncryptionListLinkKind

// AzureKmsEncryptionNilKind is the name of the type used to nil lists of objects of
// type 'azure_kms_encryption'.
const AzureKmsEncryptionListNilKind = api_v1.AzureKmsEncryptionListNilKind

type AzureKmsEncryptionList = api_v1.AzureKmsEncryptionList
