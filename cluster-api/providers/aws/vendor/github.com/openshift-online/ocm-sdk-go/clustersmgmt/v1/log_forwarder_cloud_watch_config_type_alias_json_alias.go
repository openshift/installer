...
var MarshalLogForwarderCloudWatchConfig = api_v1.MarshalLogForwarderCloudWatchConfig

// WriteLogForwarderCloudWatchConfig writes a value of the 'log_forwarder_cloud_watch_config' type to the given stream.
var WriteLogForwarderCloudWatchConfig = api_v1.WriteLogForwarderCloudWatchConfig
...
var UnmarshalLogForwarderCloudWatchConfig = api_v1.UnmarshalLogForwarderCloudWatchConfig

// ReadLogForwarderCloudWatchConfig reads a value of the 'log_forwarder_cloud_watch_config' type from the given iterator.
var ReadLogForwarderCloudWatchConfig = api_v1.ReadLogForwarderCloudWatchConfig
