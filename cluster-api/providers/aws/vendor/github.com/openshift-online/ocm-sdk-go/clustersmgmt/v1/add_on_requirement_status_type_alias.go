...
type AddOnRequirementStatus = api_v1.AddOnRequirementStatus
...
const AddOnRequirementStatusListKind = api_v1.AddOnRequirementStatusListKind
...
const AddOnRequirementStatusListLinkKind = api_v1.AddOnRequirementStatusListLinkKind

// AddOnRequirementStatusNilKind is the name of the type used to nil lists of objects of
// type 'add_on_requirement_status'.
const AddOnRequirementStatusListNilKind = api_v1.AddOnRequirementStatusListNilKind

type AddOnRequirementStatusList = api_v1.AddOnRequirementStatusList
