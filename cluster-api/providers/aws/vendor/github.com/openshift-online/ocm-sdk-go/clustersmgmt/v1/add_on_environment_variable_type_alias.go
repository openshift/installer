...
const AddOnEnvironmentVariableKind = api_v1.AddOnEnvironmentVariableKind
...
const AddOnEnvironmentVariableLinkKind = api_v1.AddOnEnvironmentVariableLinkKind

// AddOnEnvironmentVariableNilKind is the name of the type used to nil references
// to objects of type 'add_on_environment_variable'.
const AddOnEnvironmentVariableNilKind = api_v1.AddOnEnvironmentVariableNilKind
...
type AddOnEnvironmentVariable = api_v1.AddOnEnvironmentVariable
...
const AddOnEnvironmentVariableListKind = api_v1.AddOnEnvironmentVariableListKind
...
const AddOnEnvironmentVariableListLinkKind = api_v1.AddOnEnvironmentVariableListLinkKind

// AddOnEnvironmentVariableNilKind is the name of the type used to nil lists of objects of
// type 'add_on_environment_variable'.
const AddOnEnvironmentVariableListNilKind = api_v1.AddOnEnvironmentVariableListNilKind

type AddOnEnvironmentVariableList = api_v1.AddOnEnvironmentVariableList
