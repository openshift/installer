...
const PrivateLinkPrincipalListLinkKind = api_v1.PrivateLinkPrincipalListLinkKind

// PrivateLinkPrincipalNilKind is the name of the type used to nil lists of objects of
// type 'private_link_principal'.
const PrivateLinkPrincipalListNilKind = api_v1.PrivateLinkPrincipalListNilKind

type PrivateLinkPrincipalList = api_v1.PrivateLinkPrincipalList
