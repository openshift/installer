...
type AzureNodesOutboundConnectivity = api_v1.AzureNodesOutboundConnectivity
...
const AzureNodesOutboundConnectivityListKind = api_v1.AzureNodesOutboundConnectivityListKind
...
const AzureNodesOutboundConnectivityListLinkKind = api_v1.AzureNodesOutboundConnectivityListLinkKind

// AzureNodesOutboundConnectivityNilKind is the name of the type used to nil lists of objects of
// type 'azure_nodes_outbound_connectivity'.
const AzureNodesOutboundConnectivityListNilKind = api_v1.AzureNodesOutboundConnectivityListNilKind

type AzureNodesOutboundConnectivityList = api_v1.AzureNodesOutboundConnectivityList
