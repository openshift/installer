...
type ExternalAuthStatus = api_v1.ExternalAuthStatus

// ExternalAuthStatusListKind is the name of the type used to represent list of objects of
// type 'external_auth_status'.
const ExternalAuthStatusListKind = api_v1.ExternalAuthStatusListKind
...
const ExternalAuthStatusListLinkKind = api_v1.ExternalAuthStatusListLinkKind

// ExternalAuthStatusNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_status'.
const ExternalAuthStatusListNilKind = api_v1.ExternalAuthStatusListNilKind

type ExternalAuthStatusList = api_v1.ExternalAuthStatusList
