...
const InstanceIAMRolesListLinkKind = api_v1.InstanceIAMRolesListLinkKind

// InstanceIAMRolesNilKind is the name of the type used to nil lists of objects of
// type 'instance_IAM_roles'.
const InstanceIAMRolesListNilKind = api_v1.InstanceIAMRolesListNilKind

type InstanceIAMRolesList = api_v1.InstanceIAMRolesList
