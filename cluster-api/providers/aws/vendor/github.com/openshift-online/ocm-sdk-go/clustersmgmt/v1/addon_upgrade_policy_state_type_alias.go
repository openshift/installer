...
const AddonUpgradePolicyStateKind = api_v1.AddonUpgradePolicyStateKind
...
const AddonUpgradePolicyStateLinkKind = api_v1.AddonUpgradePolicyStateLinkKind

// AddonUpgradePolicyStateNilKind is the name of the type used to nil references
// to objects of type 'addon_upgrade_policy_state'.
const AddonUpgradePolicyStateNilKind = api_v1.AddonUpgradePolicyStateNilKind
...
type AddonUpgradePolicyState = api_v1.AddonUpgradePolicyState
...
const AddonUpgradePolicyStateListKind = api_v1.AddonUpgradePolicyStateListKind
...
const AddonUpgradePolicyStateListLinkKind = api_v1.AddonUpgradePolicyStateListLinkKind

// AddonUpgradePolicyStateNilKind is the name of the type used to nil lists of objects of
// type 'addon_upgrade_policy_state'.
const AddonUpgradePolicyStateListNilKind = api_v1.AddonUpgradePolicyStateListNilKind

type AddonUpgradePolicyStateList = api_v1.AddonUpgradePolicyStateList
