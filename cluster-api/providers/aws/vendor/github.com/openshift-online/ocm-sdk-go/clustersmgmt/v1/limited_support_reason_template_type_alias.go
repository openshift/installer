...
const LimitedSupportReasonTemplateKind = api_v1.LimitedSupportReasonTemplateKind
...
const LimitedSupportReasonTemplateLinkKind = api_v1.LimitedSupportReasonTemplateLinkKind

// LimitedSupportReasonTemplateNilKind is the name of the type used to nil references
// to objects of type 'limited_support_reason_template'.
const LimitedSupportReasonTemplateNilKind = api_v1.LimitedSupportReasonTemplateNilKind
...
type LimitedSupportReasonTemplate = api_v1.LimitedSupportReasonTemplate
...
const LimitedSupportReasonTemplateListKind = api_v1.LimitedSupportReasonTemplateListKind
...
const LimitedSupportReasonTemplateListLinkKind = api_v1.LimitedSupportReasonTemplateListLinkKind

// LimitedSupportReasonTemplateNilKind is the name of the type used to nil lists of objects of
// type 'limited_support_reason_template'.
const LimitedSupportReasonTemplateListNilKind = api_v1.LimitedSupportReasonTemplateListNilKind

type LimitedSupportReasonTemplateList = api_v1.LimitedSupportReasonTemplateList
