...
const ClusterDeploymentListLinkKind = api_v1.ClusterDeploymentListLinkKind

// ClusterDeploymentNilKind is the name of the type used to nil lists of objects of
// type 'cluster_deployment'.
const ClusterDeploymentListNilKind = api_v1.ClusterDeploymentListNilKind

type ClusterDeploymentList = api_v1.ClusterDeploymentList
