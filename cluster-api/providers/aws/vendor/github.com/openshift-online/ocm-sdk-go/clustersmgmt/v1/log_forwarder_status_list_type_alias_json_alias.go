...
// the given writer.
var MarshalLogForwarderStatusList = api_v1.MarshalLogForwarderStatusList

// WriteLogForwarderStatusList writes a list of value of the 'log_forwarder_status' type to
// the given stream.
var WriteLogForwarderStatusList = api_v1.WriteLogForwarderStatusList

// UnmarshalLogForwarderStatusList reads a list of values of the 'log_forwarder_status' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLogForwarderStatusList = api_v1.UnmarshalLogForwarderStatusList

// ReadLogForwarderStatusList reads list of values of the ”log_forwarder_status' type from
// the given iterator.
var ReadLogForwarderStatusList = api_v1.ReadLogForwarderStatusList
