...
type ManagementClusterParent = api_v1.ManagementClusterParent
...
const ManagementClusterParentListKind = api_v1.ManagementClusterParentListKind
...
const ManagementClusterParentListLinkKind = api_v1.ManagementClusterParentListLinkKind

// ManagementClusterParentNilKind is the name of the type used to nil lists of objects of
// type 'management_cluster_parent'.
const ManagementClusterParentListNilKind = api_v1.ManagementClusterParentListNilKind

type ManagementClusterParentList = api_v1.ManagementClusterParentList
