...
type Subnetwork = api_v1alpha1.Subnetwork

// SubnetworkListKind is the name of the type used to represent list of objects of
// type 'subnetwork'.
const SubnetworkListKind = api_v1alpha1.SubnetworkListKind

// SubnetworkListLinkKind is the name of the type used to represent links to list
// of objects of type 'subnetwork'.
const SubnetworkListLinkKind = api_v1alpha1.SubnetworkListLinkKind

// SubnetworkNilKind is the name of the type used to nil lists of objects of
// type 'subnetwork'.
const SubnetworkListNilKind = api_v1alpha1.SubnetworkListNilKind

type SubnetworkList = api_v1alpha1.SubnetworkList
