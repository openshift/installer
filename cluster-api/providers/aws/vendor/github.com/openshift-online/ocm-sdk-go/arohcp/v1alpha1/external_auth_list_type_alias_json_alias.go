...
// the given writer.
var MarshalExternalAuthList = api_v1alpha1.MarshalExternalAuthList

// WriteExternalAuthList writes a list of value of the 'external_auth' type to
// the given stream.
var WriteExternalAuthList = api_v1alpha1.WriteExternalAuthList

// UnmarshalExternalAuthList reads a list of values of the 'external_auth' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthList = api_v1alpha1.UnmarshalExternalAuthList

// ReadExternalAuthList reads list of values of the ”external_auth' type from
// the given iterator.
var ReadExternalAuthList = api_v1alpha1.ReadExternalAuthList
