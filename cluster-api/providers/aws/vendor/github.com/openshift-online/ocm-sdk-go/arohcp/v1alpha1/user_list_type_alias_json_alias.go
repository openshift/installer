...
// the given writer.
var MarshalUserList = api_v1alpha1.MarshalUserList

// WriteUserList writes a list of value of the 'user' type to
// the given stream.
var WriteUserList = api_v1alpha1.WriteUserList

// UnmarshalUserList reads a list of values of the 'user' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalUserList = api_v1alpha1.UnmarshalUserList

// ReadUserList reads list of values of the ”user' type from
// the given iterator.
var ReadUserList = api_v1alpha1.ReadUserList
