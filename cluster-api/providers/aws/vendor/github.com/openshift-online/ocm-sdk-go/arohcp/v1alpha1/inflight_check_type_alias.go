...
const InflightCheckKind = api_v1alpha1.InflightCheckKind

// InflightCheckLinkKind is the name of the type used to represent links
// to objects of type 'inflight_check'.
const InflightCheckLinkKind = api_v1alpha1.InflightCheckLinkKind

// InflightCheckNilKind is the name of the type used to nil references
// to objects of type 'inflight_check'.
const InflightCheckNilKind = api_v1alpha1.InflightCheckNilKind
...
type InflightCheck = api_v1alpha1.InflightCheck

// InflightCheckListKind is the name of the type used to represent list of objects of
// type 'inflight_check'.
const InflightCheckListKind = api_v1alpha1.InflightCheckListKind

// InflightCheckListLinkKind is the name of the type used to represent links to list
// of objects of type 'inflight_check'.
const InflightCheckListLinkKind = api_v1alpha1.InflightCheckListLinkKind

// InflightCheckNilKind is the name of the type used to nil lists of objects of
// type 'inflight_check'.
const InflightCheckListNilKind = api_v1alpha1.InflightCheckListNilKind

type InflightCheckList = api_v1alpha1.InflightCheckList
