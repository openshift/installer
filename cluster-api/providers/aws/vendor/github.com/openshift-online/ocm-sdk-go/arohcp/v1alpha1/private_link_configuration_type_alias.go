...
type PrivateLinkConfiguration = api_v1alpha1.PrivateLinkConfiguration
...
const PrivateLinkConfigurationListKind = api_v1alpha1.PrivateLinkConfigurationListKind
...
const PrivateLinkConfigurationListLinkKind = api_v1alpha1.PrivateLinkConfigurationListLinkKind

// PrivateLinkConfigurationNilKind is the name of the type used to nil lists of objects of
// type 'private_link_configuration'.
const PrivateLinkConfigurationListNilKind = api_v1alpha1.PrivateLinkConfigurationListNilKind

type PrivateLinkConfigurationList = api_v1alpha1.PrivateLinkConfigurationList
