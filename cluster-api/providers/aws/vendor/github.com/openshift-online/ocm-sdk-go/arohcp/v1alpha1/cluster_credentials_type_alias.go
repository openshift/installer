...
const ClusterCredentialsListLinkKind = api_v1alpha1.ClusterCredentialsListLinkKind

// ClusterCredentialsNilKind is the name of the type used to nil lists of objects of
// type 'cluster_credentials'.
const ClusterCredentialsListNilKind = api_v1alpha1.ClusterCredentialsListNilKind

type ClusterCredentialsList = api_v1alpha1.ClusterCredentialsList
