...
// the given writer.
var MarshalCloudProviderDataList = api_v1alpha1.MarshalCloudProviderDataList

// WriteCloudProviderDataList writes a list of value of the 'cloud_provider_data' type to
// the given stream.
var WriteCloudProviderDataList = api_v1alpha1.WriteCloudProviderDataList

// UnmarshalCloudProviderDataList reads a list of values of the 'cloud_provider_data' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalCloudProviderDataList = api_v1alpha1.UnmarshalCloudProviderDataList

// ReadCloudProviderDataList reads list of values of the ”cloud_provider_data' type from
// the given iterator.
var ReadCloudProviderDataList = api_v1alpha1.ReadCloudProviderDataList
