...
// the given writer.
var MarshalClusterAutoscalerList = api_v1alpha1.MarshalClusterAutoscalerList

// WriteClusterAutoscalerList writes a list of value of the 'cluster_autoscaler' type to
// the given stream.
var WriteClusterAutoscalerList = api_v1alpha1.WriteClusterAutoscalerList

// UnmarshalClusterAutoscalerList reads a list of values of the 'cluster_autoscaler' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterAutoscalerList = api_v1alpha1.UnmarshalClusterAutoscalerList

// ReadClusterAutoscalerList reads list of values of the ”cluster_autoscaler' type from
// the given iterator.
var ReadClusterAutoscalerList = api_v1alpha1.ReadClusterAutoscalerList
