...
// the given writer.
var MarshalAutoscalerResourceLimitsGPULimitList = api_v1alpha1.MarshalAutoscalerResourceLimitsGPULimitList

// WriteAutoscalerResourceLimitsGPULimitList writes a list of value of the 'autoscaler_resource_limits_GPU_limit' type to
// the given stream.
var WriteAutoscalerResourceLimitsGPULimitList = api_v1alpha1.WriteAutoscalerResourceLimitsGPULimitList
...
var UnmarshalAutoscalerResourceLimitsGPULimitList = api_v1alpha1.UnmarshalAutoscalerResourceLimitsGPULimitList

// ReadAutoscalerResourceLimitsGPULimitList reads list of values of the ”autoscaler_resource_limits_GPU_limit' type from
// the given iterator.
var ReadAutoscalerResourceLimitsGPULimitList = api_v1alpha1.ReadAutoscalerResourceLimitsGPULimitList
