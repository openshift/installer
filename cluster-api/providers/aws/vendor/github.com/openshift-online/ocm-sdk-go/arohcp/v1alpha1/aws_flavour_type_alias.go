...
type AWSFlavour = api_v1alpha1.AWSFlavour

// AWSFlavourListKind is the name of the type used to represent list of objects of
// type 'AWS_flavour'.
const AWSFlavourListKind = api_v1alpha1.AWSFlavourListKind

// AWSFlavourListLinkKind is the name of the type used to represent links to list
// of objects of type 'AWS_flavour'.
const AWSFlavourListLinkKind = api_v1alpha1.AWSFlavourListLinkKind

// AWSFlavourNilKind is the name of the type used to nil lists of objects of
// type 'AWS_flavour'.
const AWSFlavourListNilKind = api_v1alpha1.AWSFlavourListNilKind

type AWSFlavourList = api_v1alpha1.AWSFlavourList
