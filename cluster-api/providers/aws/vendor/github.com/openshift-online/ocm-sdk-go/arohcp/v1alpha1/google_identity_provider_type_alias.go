...
type GoogleIdentityProvider = api_v1alpha1.GoogleIdentityProvider

// GoogleIdentityProviderListKind is the name of the type used to represent list of objects of
// type 'google_identity_provider'.
const GoogleIdentityProviderListKind = api_v1alpha1.GoogleIdentityProviderListKind
...
const GoogleIdentityProviderListLinkKind = api_v1alpha1.GoogleIdentityProviderListLinkKind

// GoogleIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'google_identity_provider'.
const GoogleIdentityProviderListNilKind = api_v1alpha1.GoogleIdentityProviderListNilKind

type GoogleIdentityProviderList = api_v1alpha1.GoogleIdentityProviderList
