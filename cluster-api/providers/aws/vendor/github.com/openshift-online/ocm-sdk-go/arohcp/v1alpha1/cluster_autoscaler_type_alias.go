...
const ClusterAutoscalerListLinkKind = api_v1alpha1.ClusterAutoscalerListLinkKind

// ClusterAutoscalerNilKind is the name of the type used to nil lists of objects of
// type 'cluster_autoscaler'.
const ClusterAutoscalerListNilKind = api_v1alpha1.ClusterAutoscalerListNilKind

type ClusterAutoscalerList = api_v1alpha1.ClusterAutoscalerList
