...
type AWSCapacityReservation = api_v1alpha1.AWSCapacityReservation

// AWSCapacityReservationListKind is the name of the type used to represent list of objects of
// type 'AWS_capacity_reservation'.
const AWSCapacityReservationListKind = api_v1alpha1.AWSCapacityReservationListKind
...
const AWSCapacityReservationListLinkKind = api_v1alpha1.AWSCapacityReservationListLinkKind

// AWSCapacityReservationNilKind is the name of the type used to nil lists of objects of
// type 'AWS_capacity_reservation'.
const AWSCapacityReservationListNilKind = api_v1alpha1.AWSCapacityReservationListNilKind

type AWSCapacityReservationList = api_v1alpha1.AWSCapacityReservationList
