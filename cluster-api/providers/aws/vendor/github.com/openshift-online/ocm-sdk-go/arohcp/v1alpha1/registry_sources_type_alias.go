...
type RegistrySources = api_v1alpha1.RegistrySources

// RegistrySourcesListKind is the name of the type used to represent list of objects of
// type 'registry_sources'.
const RegistrySourcesListKind = api_v1alpha1.RegistrySourcesListKind

// RegistrySourcesListLinkKind is the name of the type used to represent links to list
// of objects of type 'registry_sources'.
const RegistrySourcesListLinkKind = api_v1alpha1.RegistrySourcesListLinkKind

// RegistrySourcesNilKind is the name of the type used to nil lists of objects of
// type 'registry_sources'.
const RegistrySourcesListNilKind = api_v1alpha1.RegistrySourcesListNilKind

type RegistrySourcesList = api_v1alpha1.RegistrySourcesList
