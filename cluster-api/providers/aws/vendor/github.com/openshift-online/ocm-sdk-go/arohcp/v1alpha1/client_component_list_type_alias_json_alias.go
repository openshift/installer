...
// the given writer.
var MarshalClientComponentList = api_v1alpha1.MarshalClientComponentList

// WriteClientComponentList writes a list of value of the 'client_component' type to
// the given stream.
var WriteClientComponentList = api_v1alpha1.WriteClientComponentList

// UnmarshalClientComponentList reads a list of values of the 'client_component' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClientComponentList = api_v1alpha1.UnmarshalClientComponentList

// ReadClientComponentList reads list of values of the ”client_component' type from
// the given iterator.
var ReadClientComponentList = api_v1alpha1.ReadClientComponentList
