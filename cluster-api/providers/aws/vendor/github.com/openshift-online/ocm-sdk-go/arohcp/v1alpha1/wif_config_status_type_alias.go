...
type WifConfigStatus = api_v1alpha1.WifConfigStatus

// WifConfigStatusListKind is the name of the type used to represent list of objects of
// type 'wif_config_status'.
const WifConfigStatusListKind = api_v1alpha1.WifConfigStatusListKind

// WifConfigStatusListLinkKind is the name of the type used to represent links to list
// of objects of type 'wif_config_status'.
const WifConfigStatusListLinkKind = api_v1alpha1.WifConfigStatusListLinkKind

// WifConfigStatusNilKind is the name of the type used to nil lists of objects of
// type 'wif_config_status'.
const WifConfigStatusListNilKind = api_v1alpha1.WifConfigStatusListNilKind

type WifConfigStatusList = api_v1alpha1.WifConfigStatusList
