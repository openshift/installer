...
// the given writer.
var MarshalClusterImageRegistryList = api_v1alpha1.MarshalClusterImageRegistryList

// WriteClusterImageRegistryList writes a list of value of the 'cluster_image_registry' type to
// the given stream.
var WriteClusterImageRegistryList = api_v1alpha1.WriteClusterImageRegistryList

// UnmarshalClusterImageRegistryList reads a list of values of the 'cluster_image_registry' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterImageRegistryList = api_v1alpha1.UnmarshalClusterImageRegistryList

// ReadClusterImageRegistryList reads list of values of the ”cluster_image_registry' type from
// the given iterator.
var ReadClusterImageRegistryList = api_v1alpha1.ReadClusterImageRegistryList
