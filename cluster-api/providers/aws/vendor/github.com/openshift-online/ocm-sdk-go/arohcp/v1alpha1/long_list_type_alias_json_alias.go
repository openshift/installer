...
// the given writer.
var MarshalLongList = api_v1alpha1.MarshalLongList

// WriteLongList writes a list of value of the 'long' type to
// the given stream.
var WriteLongList = api_v1alpha1.WriteLongList

// UnmarshalLongList reads a list of values of the 'long' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLongList = api_v1alpha1.UnmarshalLongList

// ReadLongList reads list of values of the ”long' type from
// the given iterator.
var ReadLongList = api_v1alpha1.ReadLongList
