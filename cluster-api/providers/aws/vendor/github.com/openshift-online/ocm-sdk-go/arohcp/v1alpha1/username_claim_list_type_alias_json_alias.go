...
// the given writer.
var MarshalUsernameClaimList = api_v1alpha1.MarshalUsernameClaimList

// WriteUsernameClaimList writes a list of value of the 'username_claim' type to
// the given stream.
var WriteUsernameClaimList = api_v1alpha1.WriteUsernameClaimList

// UnmarshalUsernameClaimList reads a list of values of the 'username_claim' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalUsernameClaimList = api_v1alpha1.UnmarshalUsernameClaimList

// ReadUsernameClaimList reads list of values of the ”username_claim' type from
// the given iterator.
var ReadUsernameClaimList = api_v1alpha1.ReadUsernameClaimList
