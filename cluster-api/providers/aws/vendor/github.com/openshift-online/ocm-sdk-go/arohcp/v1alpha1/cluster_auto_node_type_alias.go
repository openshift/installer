...
type ClusterAutoNode = api_v1alpha1.ClusterAutoNode

// ClusterAutoNodeListKind is the name of the type used to represent list of objects of
// type 'cluster_auto_node'.
const ClusterAutoNodeListKind = api_v1alpha1.ClusterAutoNodeListKind

// ClusterAutoNodeListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_auto_node'.
const ClusterAutoNodeListLinkKind = api_v1alpha1.ClusterAutoNodeListLinkKind

// ClusterAutoNodeNilKind is the name of the type used to nil lists of objects of
// type 'cluster_auto_node'.
const ClusterAutoNodeListNilKind = api_v1alpha1.ClusterAutoNodeListNilKind

type ClusterAutoNodeList = api_v1alpha1.ClusterAutoNodeList
