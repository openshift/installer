...
type RegistryLocation = api_v1alpha1.RegistryLocation

// RegistryLocationListKind is the name of the type used to represent list of objects of
// type 'registry_location'.
const RegistryLocationListKind = api_v1alpha1.RegistryLocationListKind

// RegistryLocationListLinkKind is the name of the type used to represent links to list
// of objects of type 'registry_location'.
const RegistryLocationListLinkKind = api_v1alpha1.RegistryLocationListLinkKind

// RegistryLocationNilKind is the name of the type used to nil lists of objects of
// type 'registry_location'.
const RegistryLocationListNilKind = api_v1alpha1.RegistryLocationListNilKind

type RegistryLocationList = api_v1alpha1.RegistryLocationList
