...
type AddOnSubOperator = api_v1alpha1.AddOnSubOperator

// AddOnSubOperatorListKind is the name of the type used to represent list of objects of
// type 'add_on_sub_operator'.
const AddOnSubOperatorListKind = api_v1alpha1.AddOnSubOperatorListKind
...
const AddOnSubOperatorListLinkKind = api_v1alpha1.AddOnSubOperatorListLinkKind

// AddOnSubOperatorNilKind is the name of the type used to nil lists of objects of
// type 'add_on_sub_operator'.
const AddOnSubOperatorListNilKind = api_v1alpha1.AddOnSubOperatorListNilKind

type AddOnSubOperatorList = api_v1alpha1.AddOnSubOperatorList
