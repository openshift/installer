...
type AzureKmsKey = api_v1alpha1.AzureKmsKey

// AzureKmsKeyListKind is the name of the type used to represent list of objects of
// type 'azure_kms_key'.
const AzureKmsKeyListKind = api_v1alpha1.AzureKmsKeyListKind

// AzureKmsKeyListLinkKind is the name of the type used to represent links to list
// of objects of type 'azure_kms_key'.
const AzureKmsKeyListLinkKind = api_v1alpha1.AzureKmsKeyListLinkKind

// AzureKmsKeyNilKind is the name of the type used to nil lists of objects of
// type 'azure_kms_key'.
const AzureKmsKeyListNilKind = api_v1alpha1.AzureKmsKeyListNilKind

type AzureKmsKeyList = api_v1alpha1.AzureKmsKeyList
