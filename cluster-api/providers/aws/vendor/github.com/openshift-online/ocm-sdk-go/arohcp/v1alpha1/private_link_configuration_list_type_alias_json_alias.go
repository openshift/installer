...
// the given writer.
var MarshalPrivateLinkConfigurationList = api_v1alpha1.MarshalPrivateLinkConfigurationList

// WritePrivateLinkConfigurationList writes a list of value of the 'private_link_configuration' type to
// the given stream.
var WritePrivateLinkConfigurationList = api_v1alpha1.WritePrivateLinkConfigurationList

// UnmarshalPrivateLinkConfigurationList reads a list of values of the 'private_link_configuration' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalPrivateLinkConfigurationList = api_v1alpha1.UnmarshalPrivateLinkConfigurationList

// ReadPrivateLinkConfigurationList reads list of values of the ”private_link_configuration' type from
// the given iterator.
var ReadPrivateLinkConfigurationList = api_v1alpha1.ReadPrivateLinkConfigurationList
