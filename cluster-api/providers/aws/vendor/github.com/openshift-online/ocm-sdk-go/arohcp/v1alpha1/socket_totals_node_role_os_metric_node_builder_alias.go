...
type SocketTotalsNodeRoleOSMetricNodeBuilder = api_v1alpha1.SocketTotalsNodeRoleOSMetricNodeBuilder

// NewSocketTotalsNodeRoleOSMetricNode creates a new builder of 'socket_totals_node_role_OS_metric_node' objects.
var NewSocketTotalsNodeRoleOSMetricNode = api_v1alpha1.NewSocketTotalsNodeRoleOSMetricNode
