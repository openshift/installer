...
// the given writer.
var MarshalNodeInfoList = api_v1alpha1.MarshalNodeInfoList

// WriteNodeInfoList writes a list of value of the 'node_info' type to
// the given stream.
var WriteNodeInfoList = api_v1alpha1.WriteNodeInfoList

// UnmarshalNodeInfoList reads a list of values of the 'node_info' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalNodeInfoList = api_v1alpha1.UnmarshalNodeInfoList

// ReadNodeInfoList reads list of values of the ”node_info' type from
// the given iterator.
var ReadNodeInfoList = api_v1alpha1.ReadNodeInfoList
