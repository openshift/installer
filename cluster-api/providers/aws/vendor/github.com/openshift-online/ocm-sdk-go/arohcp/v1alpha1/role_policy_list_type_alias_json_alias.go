...
// the given writer.
var MarshalRolePolicyList = api_v1alpha1.MarshalRolePolicyList

// WriteRolePolicyList writes a list of value of the 'role_policy' type to
// the given stream.
var WriteRolePolicyList = api_v1alpha1.WriteRolePolicyList

// UnmarshalRolePolicyList reads a list of values of the 'role_policy' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalRolePolicyList = api_v1alpha1.UnmarshalRolePolicyList

// ReadRolePolicyList reads list of values of the ”role_policy' type from
// the given iterator.
var ReadRolePolicyList = api_v1alpha1.ReadRolePolicyList
