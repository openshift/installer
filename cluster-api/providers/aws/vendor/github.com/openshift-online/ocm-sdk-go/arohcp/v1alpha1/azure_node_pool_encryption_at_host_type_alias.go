...
type AzureNodePoolEncryptionAtHost = api_v1alpha1.AzureNodePoolEncryptionAtHost
...
const AzureNodePoolEncryptionAtHostListKind = api_v1alpha1.AzureNodePoolEncryptionAtHostListKind
...
const AzureNodePoolEncryptionAtHostListLinkKind = api_v1alpha1.AzureNodePoolEncryptionAtHostListLinkKind

// AzureNodePoolEncryptionAtHostNilKind is the name of the type used to nil lists of objects of
// type 'azure_node_pool_encryption_at_host'.
const AzureNodePoolEncryptionAtHostListNilKind = api_v1alpha1.AzureNodePoolEncryptionAtHostListNilKind

type AzureNodePoolEncryptionAtHostList = api_v1alpha1.AzureNodePoolEncryptionAtHostList
