...
// the given writer.
var MarshalRegistryAllowlistList = api_v1alpha1.MarshalRegistryAllowlistList

// WriteRegistryAllowlistList writes a list of value of the 'registry_allowlist' type to
// the given stream.
var WriteRegistryAllowlistList = api_v1alpha1.WriteRegistryAllowlistList

// UnmarshalRegistryAllowlistList reads a list of values of the 'registry_allowlist' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalRegistryAllowlistList = api_v1alpha1.UnmarshalRegistryAllowlistList

// ReadRegistryAllowlistList reads list of values of the ”registry_allowlist' type from
// the given iterator.
var ReadRegistryAllowlistList = api_v1alpha1.ReadRegistryAllowlistList
