...
// the given writer.
var MarshalGoogleIdentityProviderList = api_v1alpha1.MarshalGoogleIdentityProviderList

// WriteGoogleIdentityProviderList writes a list of value of the 'google_identity_provider' type to
// the given stream.
var WriteGoogleIdentityProviderList = api_v1alpha1.WriteGoogleIdentityProviderList

// UnmarshalGoogleIdentityProviderList reads a list of values of the 'google_identity_provider' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGoogleIdentityProviderList = api_v1alpha1.UnmarshalGoogleIdentityProviderList

// ReadGoogleIdentityProviderList reads list of values of the ”google_identity_provider' type from
// the given iterator.
var ReadGoogleIdentityProviderList = api_v1alpha1.ReadGoogleIdentityProviderList
