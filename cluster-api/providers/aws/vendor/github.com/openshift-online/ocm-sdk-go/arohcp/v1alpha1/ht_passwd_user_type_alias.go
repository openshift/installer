...
type HTPasswdUser = api_v1alpha1.HTPasswdUser

// HTPasswdUserListKind is the name of the type used to represent list of objects of
// type 'HT_passwd_user'.
const HTPasswdUserListKind = api_v1alpha1.HTPasswdUserListKind

// HTPasswdUserListLinkKind is the name of the type used to represent links to list
// of objects of type 'HT_passwd_user'.
const HTPasswdUserListLinkKind = api_v1alpha1.HTPasswdUserListLinkKind

// HTPasswdUserNilKind is the name of the type used to nil lists of objects of
// type 'HT_passwd_user'.
const HTPasswdUserListNilKind = api_v1alpha1.HTPasswdUserListNilKind

type HTPasswdUserList = api_v1alpha1.HTPasswdUserList
