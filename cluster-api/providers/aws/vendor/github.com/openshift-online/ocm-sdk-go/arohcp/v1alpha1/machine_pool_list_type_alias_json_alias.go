...
// the given writer.
var MarshalMachinePoolList = api_v1alpha1.MarshalMachinePoolList

// WriteMachinePoolList writes a list of value of the 'machine_pool' type to
// the given stream.
var WriteMachinePoolList = api_v1alpha1.WriteMachinePoolList

// UnmarshalMachinePoolList reads a list of values of the 'machine_pool' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalMachinePoolList = api_v1alpha1.UnmarshalMachinePoolList

// ReadMachinePoolList reads list of values of the ”machine_pool' type from
// the given iterator.
var ReadMachinePoolList = api_v1alpha1.ReadMachinePoolList
