...
type SocketTotalsNodeRoleOSMetricNode = api_v1alpha1.SocketTotalsNodeRoleOSMetricNode
...
const SocketTotalsNodeRoleOSMetricNodeListKind = api_v1alpha1.SocketTotalsNodeRoleOSMetricNodeListKind
...
const SocketTotalsNodeRoleOSMetricNodeListLinkKind = api_v1alpha1.SocketTotalsNodeRoleOSMetricNodeListLinkKind

// SocketTotalsNodeRoleOSMetricNodeNilKind is the name of the type used to nil lists of objects of
// type 'socket_totals_node_role_OS_metric_node'.
const SocketTotalsNodeRoleOSMetricNodeListNilKind = api_v1alpha1.SocketTotalsNodeRoleOSMetricNodeListNilKind

type SocketTotalsNodeRoleOSMetricNodeList = api_v1alpha1.SocketTotalsNodeRoleOSMetricNodeList
