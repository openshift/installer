...
type AlertInfo = api_v1alpha1.AlertInfo

// AlertInfoListKind is the name of the type used to represent list of objects of
// type 'alert_info'.
const AlertInfoListKind = api_v1alpha1.AlertInfoListKind

// AlertInfoListLinkKind is the name of the type used to represent links to list
// of objects of type 'alert_info'.
const AlertInfoListLinkKind = api_v1alpha1.AlertInfoListLinkKind

// AlertInfoNilKind is the name of the type used to nil lists of objects of
// type 'alert_info'.
const AlertInfoListNilKind = api_v1alpha1.AlertInfoListNilKind

type AlertInfoList = api_v1alpha1.AlertInfoList
