...
type ClusterOperatorInfo = api_v1alpha1.ClusterOperatorInfo

// ClusterOperatorInfoListKind is the name of the type used to represent list of objects of
// type 'cluster_operator_info'.
const ClusterOperatorInfoListKind = api_v1alpha1.ClusterOperatorInfoListKind
...
const ClusterOperatorInfoListLinkKind = api_v1alpha1.ClusterOperatorInfoListLinkKind

// ClusterOperatorInfoNilKind is the name of the type used to nil lists of objects of
// type 'cluster_operator_info'.
const ClusterOperatorInfoListNilKind = api_v1alpha1.ClusterOperatorInfoListNilKind

type ClusterOperatorInfoList = api_v1alpha1.ClusterOperatorInfoList
