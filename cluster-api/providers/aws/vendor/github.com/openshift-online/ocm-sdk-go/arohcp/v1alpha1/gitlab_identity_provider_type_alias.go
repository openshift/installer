...
type GitlabIdentityProvider = api_v1alpha1.GitlabIdentityProvider

// GitlabIdentityProviderListKind is the name of the type used to represent list of objects of
// type 'gitlab_identity_provider'.
const GitlabIdentityProviderListKind = api_v1alpha1.GitlabIdentityProviderListKind
...
const GitlabIdentityProviderListLinkKind = api_v1alpha1.GitlabIdentityProviderListLinkKind

// GitlabIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'gitlab_identity_provider'.
const GitlabIdentityProviderListNilKind = api_v1alpha1.GitlabIdentityProviderListNilKind

type GitlabIdentityProviderList = api_v1alpha1.GitlabIdentityProviderList
