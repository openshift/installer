...
type MachinePoolSecurityGroupFilter = api_v1alpha1.MachinePoolSecurityGroupFilter
...
const MachinePoolSecurityGroupFilterListKind = api_v1alpha1.MachinePoolSecurityGroupFilterListKind
...
const MachinePoolSecurityGroupFilterListLinkKind = api_v1alpha1.MachinePoolSecurityGroupFilterListLinkKind

// MachinePoolSecurityGroupFilterNilKind is the name of the type used to nil lists of objects of
// type 'machine_pool_security_group_filter'.
const MachinePoolSecurityGroupFilterListNilKind = api_v1alpha1.MachinePoolSecurityGroupFilterListNilKind

type MachinePoolSecurityGroupFilterList = api_v1alpha1.MachinePoolSecurityGroupFilterList
