...
const LimitedSupportReasonOverrideKind = api_v1alpha1.LimitedSupportReasonOverrideKind
...
const LimitedSupportReasonOverrideLinkKind = api_v1alpha1.LimitedSupportReasonOverrideLinkKind

// LimitedSupportReasonOverrideNilKind is the name of the type used to nil references
// to objects of type 'limited_support_reason_override'.
const LimitedSupportReasonOverrideNilKind = api_v1alpha1.LimitedSupportReasonOverrideNilKind
...
type LimitedSupportReasonOverride = api_v1alpha1.LimitedSupportReasonOverride
...
const LimitedSupportReasonOverrideListKind = api_v1alpha1.LimitedSupportReasonOverrideListKind
...
const LimitedSupportReasonOverrideListLinkKind = api_v1alpha1.LimitedSupportReasonOverrideListLinkKind

// LimitedSupportReasonOverrideNilKind is the name of the type used to nil lists of objects of
// type 'limited_support_reason_override'.
const LimitedSupportReasonOverrideListNilKind = api_v1alpha1.LimitedSupportReasonOverrideListNilKind

type LimitedSupportReasonOverrideList = api_v1alpha1.LimitedSupportReasonOverrideList
