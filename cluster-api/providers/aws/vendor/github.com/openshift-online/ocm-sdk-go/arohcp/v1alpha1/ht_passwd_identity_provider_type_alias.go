...
type HTPasswdIdentityProvider = api_v1alpha1.HTPasswdIdentityProvider
...
const HTPasswdIdentityProviderListKind = api_v1alpha1.HTPasswdIdentityProviderListKind
...
const HTPasswdIdentityProviderListLinkKind = api_v1alpha1.HTPasswdIdentityProviderListLinkKind

// HTPasswdIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'HT_passwd_identity_provider'.
const HTPasswdIdentityProviderListNilKind = api_v1alpha1.HTPasswdIdentityProviderListNilKind

type HTPasswdIdentityProviderList = api_v1alpha1.HTPasswdIdentityProviderList
