...
// the given writer.
var MarshalAzureKmsEncryptionVisibilityList = api_v1alpha1.MarshalAzureKmsEncryptionVisibilityList

// WriteAzureKmsEncryptionVisibilityList writes a list of value of the 'azure_kms_encryption_visibility' type to
// the given stream.
var WriteAzureKmsEncryptionVisibilityList = api_v1alpha1.WriteAzureKmsEncryptionVisibilityList
...
var UnmarshalAzureKmsEncryptionVisibilityList = api_v1alpha1.UnmarshalAzureKmsEncryptionVisibilityList

// ReadAzureKmsEncryptionVisibilityList reads list of values of the ”azure_kms_encryption_visibility' type from
// the given iterator.
var ReadAzureKmsEncryptionVisibilityList = api_v1alpha1.ReadAzureKmsEncryptionVisibilityList
