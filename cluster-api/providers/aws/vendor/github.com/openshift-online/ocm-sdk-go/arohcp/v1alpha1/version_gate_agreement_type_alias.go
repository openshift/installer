...
const VersionGateAgreementKind = api_v1alpha1.VersionGateAgreementKind

// VersionGateAgreementLinkKind is the name of the type used to represent links
// to objects of type 'version_gate_agreement'.
const VersionGateAgreementLinkKind = api_v1alpha1.VersionGateAgreementLinkKind

// VersionGateAgreementNilKind is the name of the type used to nil references
// to objects of type 'version_gate_agreement'.
const VersionGateAgreementNilKind = api_v1alpha1.VersionGateAgreementNilKind
...
type VersionGateAgreement = api_v1alpha1.VersionGateAgreement

// VersionGateAgreementListKind is the name of the type used to represent list of objects of
// type 'version_gate_agreement'.
const VersionGateAgreementListKind = api_v1alpha1.VersionGateAgreementListKind
...
const VersionGateAgreementListLinkKind = api_v1alpha1.VersionGateAgreementListLinkKind

// VersionGateAgreementNilKind is the name of the type used to nil lists of objects of
// type 'version_gate_agreement'.
const VersionGateAgreementListNilKind = api_v1alpha1.VersionGateAgreementListNilKind

type VersionGateAgreementList = api_v1alpha1.VersionGateAgreementList
