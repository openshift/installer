...
type ClusterOperatorsInfoListBuilder = api_v1alpha1.ClusterOperatorsInfoListBuilder

// NewClusterOperatorsInfoList creates a new builder of 'cluster_operators_info' objects.
var NewClusterOperatorsInfoList = api_v1alpha1.NewClusterOperatorsInfoList
