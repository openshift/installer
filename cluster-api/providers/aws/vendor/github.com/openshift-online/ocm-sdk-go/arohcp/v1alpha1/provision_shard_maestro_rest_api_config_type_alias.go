...
type ProvisionShardMaestroRestApiConfig = api_v1alpha1.ProvisionShardMaestroRestApiConfig
...
const ProvisionShardMaestroRestApiConfigListKind = api_v1alpha1.ProvisionShardMaestroRestApiConfigListKind
...
const ProvisionShardMaestroRestApiConfigListLinkKind = api_v1alpha1.ProvisionShardMaestroRestApiConfigListLinkKind

// ProvisionShardMaestroRestApiConfigNilKind is the name of the type used to nil lists of objects of
// type 'provision_shard_maestro_rest_api_config'.
const ProvisionShardMaestroRestApiConfigListNilKind = api_v1alpha1.ProvisionShardMaestroRestApiConfigListNilKind

type ProvisionShardMaestroRestApiConfigList = api_v1alpha1.ProvisionShardMaestroRestApiConfigList
