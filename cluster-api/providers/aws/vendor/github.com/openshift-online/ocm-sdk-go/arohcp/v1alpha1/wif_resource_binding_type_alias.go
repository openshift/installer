...
type WifResourceBinding = api_v1alpha1.WifResourceBinding

// WifResourceBindingListKind is the name of the type used to represent list of objects of
// type 'wif_resource_binding'.
const WifResourceBindingListKind = api_v1alpha1.WifResourceBindingListKind
...
const WifResourceBindingListLinkKind = api_v1alpha1.WifResourceBindingListLinkKind

// WifResourceBindingNilKind is the name of the type used to nil lists of objects of
// type 'wif_resource_binding'.
const WifResourceBindingListNilKind = api_v1alpha1.WifResourceBindingListNilKind

type WifResourceBindingList = api_v1alpha1.WifResourceBindingList
