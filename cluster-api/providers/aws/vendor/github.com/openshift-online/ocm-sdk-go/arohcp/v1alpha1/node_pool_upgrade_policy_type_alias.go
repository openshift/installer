...
const NodePoolUpgradePolicyKind = api_v1alpha1.NodePoolUpgradePolicyKind

// NodePoolUpgradePolicyLinkKind is the name of the type used to represent links
// to objects of type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyLinkKind = api_v1alpha1.NodePoolUpgradePolicyLinkKind

// NodePoolUpgradePolicyNilKind is the name of the type used to nil references
// to objects of type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyNilKind = api_v1alpha1.NodePoolUpgradePolicyNilKind
...
type NodePoolUpgradePolicy = api_v1alpha1.NodePoolUpgradePolicy

// NodePoolUpgradePolicyListKind is the name of the type used to represent list of objects of
// type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyListKind = api_v1alpha1.NodePoolUpgradePolicyListKind
...
const NodePoolUpgradePolicyListLinkKind = api_v1alpha1.NodePoolUpgradePolicyListLinkKind

// NodePoolUpgradePolicyNilKind is the name of the type used to nil lists of objects of
// type 'node_pool_upgrade_policy'.
const NodePoolUpgradePolicyListNilKind = api_v1alpha1.NodePoolUpgradePolicyListNilKind

type NodePoolUpgradePolicyList = api_v1alpha1.NodePoolUpgradePolicyList
