...
// the given writer.
var MarshalClusterAutoNodeStatusList = api_v1alpha1.MarshalClusterAutoNodeStatusList

// WriteClusterAutoNodeStatusList writes a list of value of the 'cluster_auto_node_status' type to
// the given stream.
var WriteClusterAutoNodeStatusList = api_v1alpha1.WriteClusterAutoNodeStatusList

// UnmarshalClusterAutoNodeStatusList reads a list of values of the 'cluster_auto_node_status' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterAutoNodeStatusList = api_v1alpha1.UnmarshalClusterAutoNodeStatusList

// ReadClusterAutoNodeStatusList reads list of values of the ”cluster_auto_node_status' type from
// the given iterator.
var ReadClusterAutoNodeStatusList = api_v1alpha1.ReadClusterAutoNodeStatusList
