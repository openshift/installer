...
type AzureEtcdEncryption = api_v1alpha1.AzureEtcdEncryption

// AzureEtcdEncryptionListKind is the name of the type used to represent list of objects of
// type 'azure_etcd_encryption'.
const AzureEtcdEncryptionListKind = api_v1alpha1.AzureEtcdEncryptionListKind
...
const AzureEtcdEncryptionListLinkKind = api_v1alpha1.AzureEtcdEncryptionListLinkKind

// AzureEtcdEncryptionNilKind is the name of the type used to nil lists of objects of
// type 'azure_etcd_encryption'.
const AzureEtcdEncryptionListNilKind = api_v1alpha1.AzureEtcdEncryptionListNilKind

type AzureEtcdEncryptionList = api_v1alpha1.AzureEtcdEncryptionList
