...
type OidcThumbprintInput = api_v1alpha1.OidcThumbprintInput

// OidcThumbprintInputListKind is the name of the type used to represent list of objects of
// type 'oidc_thumbprint_input'.
const OidcThumbprintInputListKind = api_v1alpha1.OidcThumbprintInputListKind
...
const OidcThumbprintInputListLinkKind = api_v1alpha1.OidcThumbprintInputListLinkKind

// OidcThumbprintInputNilKind is the name of the type used to nil lists of objects of
// type 'oidc_thumbprint_input'.
const OidcThumbprintInputListNilKind = api_v1alpha1.OidcThumbprintInputListNilKind

type OidcThumbprintInputList = api_v1alpha1.OidcThumbprintInputList
