...
type ProvisionShardMaestroGrpcApiConfig = api_v1alpha1.ProvisionShardMaestroGrpcApiConfig
...
const ProvisionShardMaestroGrpcApiConfigListKind = api_v1alpha1.ProvisionShardMaestroGrpcApiConfigListKind
...
const ProvisionShardMaestroGrpcApiConfigListLinkKind = api_v1alpha1.ProvisionShardMaestroGrpcApiConfigListLinkKind

// ProvisionShardMaestroGrpcApiConfigNilKind is the name of the type used to nil lists of objects of
// type 'provision_shard_maestro_grpc_api_config'.
const ProvisionShardMaestroGrpcApiConfigListNilKind = api_v1alpha1.ProvisionShardMaestroGrpcApiConfigListNilKind

type ProvisionShardMaestroGrpcApiConfigList = api_v1alpha1.ProvisionShardMaestroGrpcApiConfigList
