...
//
// Manages the collection of upgrade policies for a node pool.
...
//
// Adds a new upgrade policy to the node pool.
...
//
// Reference to the service that manages a specific upgrade policy for the node pool.
