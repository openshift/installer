...
// the given writer.
var MarshalDetectionTypeList = api_v1alpha1.MarshalDetectionTypeList

// WriteDetectionTypeList writes a list of value of the 'detection_type' type to
// the given stream.
var WriteDetectionTypeList = api_v1alpha1.WriteDetectionTypeList

// UnmarshalDetectionTypeList reads a list of values of the 'detection_type' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalDetectionTypeList = api_v1alpha1.UnmarshalDetectionTypeList

// ReadDetectionTypeList reads list of values of the ”detection_type' type from
// the given iterator.
var ReadDetectionTypeList = api_v1alpha1.ReadDetectionTypeList
