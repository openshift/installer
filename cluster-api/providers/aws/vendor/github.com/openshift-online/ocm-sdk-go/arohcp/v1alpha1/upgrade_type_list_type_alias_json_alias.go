...
// the given writer.
var MarshalUpgradeTypeList = api_v1alpha1.MarshalUpgradeTypeList

// WriteUpgradeTypeList writes a list of value of the 'upgrade_type' type to
// the given stream.
var WriteUpgradeTypeList = api_v1alpha1.WriteUpgradeTypeList

// UnmarshalUpgradeTypeList reads a list of values of the 'upgrade_type' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalUpgradeTypeList = api_v1alpha1.UnmarshalUpgradeTypeList

// ReadUpgradeTypeList reads list of values of the ”upgrade_type' type from
// the given iterator.
var ReadUpgradeTypeList = api_v1alpha1.ReadUpgradeTypeList
