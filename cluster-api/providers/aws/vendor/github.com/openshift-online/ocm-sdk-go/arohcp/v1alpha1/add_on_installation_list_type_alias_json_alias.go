...
// the given writer.
var MarshalAddOnInstallationList = api_v1alpha1.MarshalAddOnInstallationList

// WriteAddOnInstallationList writes a list of value of the 'add_on_installation' type to
// the given stream.
var WriteAddOnInstallationList = api_v1alpha1.WriteAddOnInstallationList

// UnmarshalAddOnInstallationList reads a list of values of the 'add_on_installation' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAddOnInstallationList = api_v1alpha1.UnmarshalAddOnInstallationList

// ReadAddOnInstallationList reads list of values of the ”add_on_installation' type from
// the given iterator.
var ReadAddOnInstallationList = api_v1alpha1.ReadAddOnInstallationList
