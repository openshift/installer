...
type WifCredentialRequest = api_v1alpha1.WifCredentialRequest

// WifCredentialRequestListKind is the name of the type used to represent list of objects of
// type 'wif_credential_request'.
const WifCredentialRequestListKind = api_v1alpha1.WifCredentialRequestListKind
...
const WifCredentialRequestListLinkKind = api_v1alpha1.WifCredentialRequestListLinkKind

// WifCredentialRequestNilKind is the name of the type used to nil lists of objects of
// type 'wif_credential_request'.
const WifCredentialRequestListNilKind = api_v1alpha1.WifCredentialRequestListNilKind

type WifCredentialRequestList = api_v1alpha1.WifCredentialRequestList
