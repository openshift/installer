...
// the given writer.
var MarshalAWSInfrastructureAccessRoleStateList = api_v1alpha1.MarshalAWSInfrastructureAccessRoleStateList

// WriteAWSInfrastructureAccessRoleStateList writes a list of value of the 'AWS_infrastructure_access_role_state' type to
// the given stream.
var WriteAWSInfrastructureAccessRoleStateList = api_v1alpha1.WriteAWSInfrastructureAccessRoleStateList
...
var UnmarshalAWSInfrastructureAccessRoleStateList = api_v1alpha1.UnmarshalAWSInfrastructureAccessRoleStateList

// ReadAWSInfrastructureAccessRoleStateList reads list of values of the ”AWS_infrastructure_access_role_state' type from
// the given iterator.
var ReadAWSInfrastructureAccessRoleStateList = api_v1alpha1.ReadAWSInfrastructureAccessRoleStateList
