...
// the given writer.
var MarshalAzureNodePoolOsDiskList = api_v1alpha1.MarshalAzureNodePoolOsDiskList

// WriteAzureNodePoolOsDiskList writes a list of value of the 'azure_node_pool_os_disk' type to
// the given stream.
var WriteAzureNodePoolOsDiskList = api_v1alpha1.WriteAzureNodePoolOsDiskList

// UnmarshalAzureNodePoolOsDiskList reads a list of values of the 'azure_node_pool_os_disk' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureNodePoolOsDiskList = api_v1alpha1.UnmarshalAzureNodePoolOsDiskList

// ReadAzureNodePoolOsDiskList reads list of values of the ”azure_node_pool_os_disk' type from
// the given iterator.
var ReadAzureNodePoolOsDiskList = api_v1alpha1.ReadAzureNodePoolOsDiskList
