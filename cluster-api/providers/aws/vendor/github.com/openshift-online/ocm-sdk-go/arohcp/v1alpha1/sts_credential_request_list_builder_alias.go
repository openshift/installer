...
type STSCredentialRequestListBuilder = api_v1alpha1.STSCredentialRequestListBuilder

// NewSTSCredentialRequestList creates a new builder of 'STS_credential_request' objects.
var NewSTSCredentialRequestList = api_v1alpha1.NewSTSCredentialRequestList
