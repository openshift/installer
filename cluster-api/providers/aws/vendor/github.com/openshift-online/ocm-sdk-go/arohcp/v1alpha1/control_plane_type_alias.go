...
type ControlPlane = api_v1alpha1.ControlPlane

// ControlPlaneListKind is the name of the type used to represent list of objects of
// type 'control_plane'.
const ControlPlaneListKind = api_v1alpha1.ControlPlaneListKind

// ControlPlaneListLinkKind is the name of the type used to represent links to list
// of objects of type 'control_plane'.
const ControlPlaneListLinkKind = api_v1alpha1.ControlPlaneListLinkKind

// ControlPlaneNilKind is the name of the type used to nil lists of objects of
// type 'control_plane'.
const ControlPlaneListNilKind = api_v1alpha1.ControlPlaneListNilKind

type ControlPlaneList = api_v1alpha1.ControlPlaneList
