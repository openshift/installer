...
// the given writer.
var MarshalFlavourList = api_v1alpha1.MarshalFlavourList

// WriteFlavourList writes a list of value of the 'flavour' type to
// the given stream.
var WriteFlavourList = api_v1alpha1.WriteFlavourList

// UnmarshalFlavourList reads a list of values of the 'flavour' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalFlavourList = api_v1alpha1.UnmarshalFlavourList

// ReadFlavourList reads list of values of the ”flavour' type from
// the given iterator.
var ReadFlavourList = api_v1alpha1.ReadFlavourList
