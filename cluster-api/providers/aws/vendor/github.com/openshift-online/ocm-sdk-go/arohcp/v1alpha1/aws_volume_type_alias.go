...
type AWSVolume = api_v1alpha1.AWSVolume

// AWSVolumeListKind is the name of the type used to represent list of objects of
// type 'AWS_volume'.
const AWSVolumeListKind = api_v1alpha1.AWSVolumeListKind

// AWSVolumeListLinkKind is the name of the type used to represent links to list
// of objects of type 'AWS_volume'.
const AWSVolumeListLinkKind = api_v1alpha1.AWSVolumeListLinkKind

// AWSVolumeNilKind is the name of the type used to nil lists of objects of
// type 'AWS_volume'.
const AWSVolumeListNilKind = api_v1alpha1.AWSVolumeListNilKind

type AWSVolumeList = api_v1alpha1.AWSVolumeList
