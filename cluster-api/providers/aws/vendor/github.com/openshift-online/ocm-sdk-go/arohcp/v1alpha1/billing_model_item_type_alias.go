...
const BillingModelItemListLinkKind = api_v1alpha1.BillingModelItemListLinkKind

// BillingModelItemNilKind is the name of the type used to nil lists of objects of
// type 'billing_model_item'.
const BillingModelItemListNilKind = api_v1alpha1.BillingModelItemListNilKind

type BillingModelItemList = api_v1alpha1.BillingModelItemList
