...
type UsernameClaim = api_v1alpha1.UsernameClaim

// UsernameClaimListKind is the name of the type used to represent list of objects of
// type 'username_claim'.
const UsernameClaimListKind = api_v1alpha1.UsernameClaimListKind

// UsernameClaimListLinkKind is the name of the type used to represent links to list
// of objects of type 'username_claim'.
const UsernameClaimListLinkKind = api_v1alpha1.UsernameClaimListLinkKind

// UsernameClaimNilKind is the name of the type used to nil lists of objects of
// type 'username_claim'.
const UsernameClaimListNilKind = api_v1alpha1.UsernameClaimListNilKind

type UsernameClaimList = api_v1alpha1.UsernameClaimList
