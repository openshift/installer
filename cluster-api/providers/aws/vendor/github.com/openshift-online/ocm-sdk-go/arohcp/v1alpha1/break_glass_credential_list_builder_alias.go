...
type BreakGlassCredentialListBuilder = api_v1alpha1.BreakGlassCredentialListBuilder

// NewBreakGlassCredentialList creates a new builder of 'break_glass_credential' objects.
var NewBreakGlassCredentialList = api_v1alpha1.NewBreakGlassCredentialList
