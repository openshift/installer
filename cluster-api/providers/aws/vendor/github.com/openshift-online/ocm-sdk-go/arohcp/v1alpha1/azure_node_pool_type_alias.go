...
type AzureNodePool = api_v1alpha1.AzureNodePool

// AzureNodePoolListKind is the name of the type used to represent list of objects of
// type 'azure_node_pool'.
const AzureNodePoolListKind = api_v1alpha1.AzureNodePoolListKind

// AzureNodePoolListLinkKind is the name of the type used to represent links to list
// of objects of type 'azure_node_pool'.
const AzureNodePoolListLinkKind = api_v1alpha1.AzureNodePoolListLinkKind

// AzureNodePoolNilKind is the name of the type used to nil lists of objects of
// type 'azure_node_pool'.
const AzureNodePoolListNilKind = api_v1alpha1.AzureNodePoolListNilKind

type AzureNodePoolList = api_v1alpha1.AzureNodePoolList
