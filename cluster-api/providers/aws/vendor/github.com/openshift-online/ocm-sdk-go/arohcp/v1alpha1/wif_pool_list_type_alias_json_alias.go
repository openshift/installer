...
// the given writer.
var MarshalWifPoolList = api_v1alpha1.MarshalWifPoolList

// WriteWifPoolList writes a list of value of the 'wif_pool' type to
// the given stream.
var WriteWifPoolList = api_v1alpha1.WriteWifPoolList

// UnmarshalWifPoolList reads a list of values of the 'wif_pool' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalWifPoolList = api_v1alpha1.UnmarshalWifPoolList

// ReadWifPoolList reads list of values of the ”wif_pool' type from
// the given iterator.
var ReadWifPoolList = api_v1alpha1.ReadWifPoolList
