...
const PrivateLinkPrincipalsKind = api_v1alpha1.PrivateLinkPrincipalsKind

// PrivateLinkPrincipalsLinkKind is the name of the type used to represent links
// to objects of type 'private_link_principals'.
const PrivateLinkPrincipalsLinkKind = api_v1alpha1.PrivateLinkPrincipalsLinkKind

// PrivateLinkPrincipalsNilKind is the name of the type used to nil references
// to objects of type 'private_link_principals'.
const PrivateLinkPrincipalsNilKind = api_v1alpha1.PrivateLinkPrincipalsNilKind
...
type PrivateLinkPrincipals = api_v1alpha1.PrivateLinkPrincipals

// PrivateLinkPrincipalsListKind is the name of the type used to represent list of objects of
// type 'private_link_principals'.
const PrivateLinkPrincipalsListKind = api_v1alpha1.PrivateLinkPrincipalsListKind
...
const PrivateLinkPrincipalsListLinkKind = api_v1alpha1.PrivateLinkPrincipalsListLinkKind

// PrivateLinkPrincipalsNilKind is the name of the type used to nil lists of objects of
// type 'private_link_principals'.
const PrivateLinkPrincipalsListNilKind = api_v1alpha1.PrivateLinkPrincipalsListNilKind

type PrivateLinkPrincipalsList = api_v1alpha1.PrivateLinkPrincipalsList
