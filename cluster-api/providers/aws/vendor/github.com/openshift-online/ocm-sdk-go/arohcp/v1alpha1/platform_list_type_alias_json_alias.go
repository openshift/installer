...
// the given writer.
var MarshalPlatformList = api_v1alpha1.MarshalPlatformList

// WritePlatformList writes a list of value of the 'platform' type to
// the given stream.
var WritePlatformList = api_v1alpha1.WritePlatformList

// UnmarshalPlatformList reads a list of values of the 'platform' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalPlatformList = api_v1alpha1.UnmarshalPlatformList

// ReadPlatformList reads list of values of the ”platform' type from
// the given iterator.
var ReadPlatformList = api_v1alpha1.ReadPlatformList
