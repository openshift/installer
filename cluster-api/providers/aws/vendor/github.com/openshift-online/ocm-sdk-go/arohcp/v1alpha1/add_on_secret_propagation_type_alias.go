...
type AddOnSecretPropagation = api_v1alpha1.AddOnSecretPropagation
...
const AddOnSecretPropagationListKind = api_v1alpha1.AddOnSecretPropagationListKind
...
const AddOnSecretPropagationListLinkKind = api_v1alpha1.AddOnSecretPropagationListLinkKind

// AddOnSecretPropagationNilKind is the name of the type used to nil lists of objects of
// type 'add_on_secret_propagation'.
const AddOnSecretPropagationListNilKind = api_v1alpha1.AddOnSecretPropagationListNilKind

type AddOnSecretPropagationList = api_v1alpha1.AddOnSecretPropagationList
