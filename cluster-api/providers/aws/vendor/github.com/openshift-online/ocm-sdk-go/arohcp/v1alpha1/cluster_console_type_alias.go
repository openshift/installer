...
type ClusterConsole = api_v1alpha1.ClusterConsole

// ClusterConsoleListKind is the name of the type used to represent list of objects of
// type 'cluster_console'.
const ClusterConsoleListKind = api_v1alpha1.ClusterConsoleListKind

// ClusterConsoleListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_console'.
const ClusterConsoleListLinkKind = api_v1alpha1.ClusterConsoleListLinkKind

// ClusterConsoleNilKind is the name of the type used to nil lists of objects of
// type 'cluster_console'.
const ClusterConsoleListNilKind = api_v1alpha1.ClusterConsoleListNilKind

type ClusterConsoleList = api_v1alpha1.ClusterConsoleList
