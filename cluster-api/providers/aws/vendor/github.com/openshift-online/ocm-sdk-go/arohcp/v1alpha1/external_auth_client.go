...
// ExternalAuthDeleteRequest is the request for the 'async_delete' method.
...
// ExternalAuthDeleteResponse is the response for the 'async_delete' method.
...
// ExternalAuthUpdateRequest is the request for the 'async_update' method.
...
func (r *ExternalAuthUpdateRequest) SendContext(ctx context.Context) (result *ExternalAuthUpdateResponse, err error) {
	...
	header := helpers.CopyHeader(r.header)
	buffer := &bytes.Buffer{}
	err = writeExternalAuthAsyncUpdateRequest(r, buffer)
	if err != nil {
		return
	}
	uri := &url.URL{
	...
	err = readExternalAuthAsyncUpdateResponse(result, reader)
	if err != nil {
		return
	}
	return
...
// ExternalAuthUpdateResponse is the response for the 'async_update' method.
