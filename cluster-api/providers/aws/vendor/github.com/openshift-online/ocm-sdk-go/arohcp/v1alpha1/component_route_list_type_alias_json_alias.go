...
// the given writer.
var MarshalComponentRouteList = api_v1alpha1.MarshalComponentRouteList

// WriteComponentRouteList writes a list of value of the 'component_route' type to
// the given stream.
var WriteComponentRouteList = api_v1alpha1.WriteComponentRouteList

// UnmarshalComponentRouteList reads a list of values of the 'component_route' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalComponentRouteList = api_v1alpha1.UnmarshalComponentRouteList

// ReadComponentRouteList reads list of values of the ”component_route' type from
// the given iterator.
var ReadComponentRouteList = api_v1alpha1.ReadComponentRouteList
