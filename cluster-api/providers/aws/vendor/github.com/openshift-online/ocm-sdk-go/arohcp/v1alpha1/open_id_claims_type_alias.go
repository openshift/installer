...
type OpenIDClaims = api_v1alpha1.OpenIDClaims

// OpenIDClaimsListKind is the name of the type used to represent list of objects of
// type 'open_ID_claims'.
const OpenIDClaimsListKind = api_v1alpha1.OpenIDClaimsListKind

// OpenIDClaimsListLinkKind is the name of the type used to represent links to list
// of objects of type 'open_ID_claims'.
const OpenIDClaimsListLinkKind = api_v1alpha1.OpenIDClaimsListLinkKind

// OpenIDClaimsNilKind is the name of the type used to nil lists of objects of
// type 'open_ID_claims'.
const OpenIDClaimsListNilKind = api_v1alpha1.OpenIDClaimsListNilKind

type OpenIDClaimsList = api_v1alpha1.OpenIDClaimsList
