...
// the given writer.
var MarshalNodePoolUpgradePolicyList = api_v1alpha1.MarshalNodePoolUpgradePolicyList

// WriteNodePoolUpgradePolicyList writes a list of value of the 'node_pool_upgrade_policy' type to
// the given stream.
var WriteNodePoolUpgradePolicyList = api_v1alpha1.WriteNodePoolUpgradePolicyList

// UnmarshalNodePoolUpgradePolicyList reads a list of values of the 'node_pool_upgrade_policy' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalNodePoolUpgradePolicyList = api_v1alpha1.UnmarshalNodePoolUpgradePolicyList

// ReadNodePoolUpgradePolicyList reads list of values of the ”node_pool_upgrade_policy' type from
// the given iterator.
var ReadNodePoolUpgradePolicyList = api_v1alpha1.ReadNodePoolUpgradePolicyList
