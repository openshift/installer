...
// the given writer.
var MarshalExternalAuthClientTypeList = api_v1alpha1.MarshalExternalAuthClientTypeList

// WriteExternalAuthClientTypeList writes a list of value of the 'external_auth_client_type' type to
// the given stream.
var WriteExternalAuthClientTypeList = api_v1alpha1.WriteExternalAuthClientTypeList

// UnmarshalExternalAuthClientTypeList reads a list of values of the 'external_auth_client_type' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthClientTypeList = api_v1alpha1.UnmarshalExternalAuthClientTypeList

// ReadExternalAuthClientTypeList reads list of values of the ”external_auth_client_type' type from
// the given iterator.
var ReadExternalAuthClientTypeList = api_v1alpha1.ReadExternalAuthClientTypeList
