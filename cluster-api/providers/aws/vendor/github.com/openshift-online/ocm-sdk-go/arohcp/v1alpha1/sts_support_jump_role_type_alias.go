...
type StsSupportJumpRole = api_v1alpha1.StsSupportJumpRole

// StsSupportJumpRoleListKind is the name of the type used to represent list of objects of
// type 'sts_support_jump_role'.
const StsSupportJumpRoleListKind = api_v1alpha1.StsSupportJumpRoleListKind
...
const StsSupportJumpRoleListLinkKind = api_v1alpha1.StsSupportJumpRoleListLinkKind

// StsSupportJumpRoleNilKind is the name of the type used to nil lists of objects of
// type 'sts_support_jump_role'.
const StsSupportJumpRoleListNilKind = api_v1alpha1.StsSupportJumpRoleListNilKind

type StsSupportJumpRoleList = api_v1alpha1.StsSupportJumpRoleList
