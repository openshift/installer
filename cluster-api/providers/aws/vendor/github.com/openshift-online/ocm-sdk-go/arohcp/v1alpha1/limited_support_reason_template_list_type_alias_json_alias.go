...
// the given writer.
var MarshalLimitedSupportReasonTemplateList = api_v1alpha1.MarshalLimitedSupportReasonTemplateList

// WriteLimitedSupportReasonTemplateList writes a list of value of the 'limited_support_reason_template' type to
// the given stream.
var WriteLimitedSupportReasonTemplateList = api_v1alpha1.WriteLimitedSupportReasonTemplateList
...
var UnmarshalLimitedSupportReasonTemplateList = api_v1alpha1.UnmarshalLimitedSupportReasonTemplateList

// ReadLimitedSupportReasonTemplateList reads list of values of the ”limited_support_reason_template' type from
// the given iterator.
var ReadLimitedSupportReasonTemplateList = api_v1alpha1.ReadLimitedSupportReasonTemplateList
