...
type STSCredentialRequest = api_v1alpha1.STSCredentialRequest

// STSCredentialRequestListKind is the name of the type used to represent list of objects of
// type 'STS_credential_request'.
const STSCredentialRequestListKind = api_v1alpha1.STSCredentialRequestListKind
...
const STSCredentialRequestListLinkKind = api_v1alpha1.STSCredentialRequestListLinkKind

// STSCredentialRequestNilKind is the name of the type used to nil lists of objects of
// type 'STS_credential_request'.
const STSCredentialRequestListNilKind = api_v1alpha1.STSCredentialRequestListNilKind

type STSCredentialRequestList = api_v1alpha1.STSCredentialRequestList
