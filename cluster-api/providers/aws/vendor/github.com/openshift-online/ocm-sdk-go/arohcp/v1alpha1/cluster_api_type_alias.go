...
type ClusterAPI = api_v1alpha1.ClusterAPI

// ClusterAPIListKind is the name of the type used to represent list of objects of
// type 'cluster_API'.
const ClusterAPIListKind = api_v1alpha1.ClusterAPIListKind

// ClusterAPIListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_API'.
const ClusterAPIListLinkKind = api_v1alpha1.ClusterAPIListLinkKind

// ClusterAPINilKind is the name of the type used to nil lists of objects of
// type 'cluster_API'.
const ClusterAPIListNilKind = api_v1alpha1.ClusterAPIListNilKind

type ClusterAPIList = api_v1alpha1.ClusterAPIList
