...
// the given writer.
var MarshalAddOnSubOperatorList = api_v1alpha1.MarshalAddOnSubOperatorList

// WriteAddOnSubOperatorList writes a list of value of the 'add_on_sub_operator' type to
// the given stream.
var WriteAddOnSubOperatorList = api_v1alpha1.WriteAddOnSubOperatorList

// UnmarshalAddOnSubOperatorList reads a list of values of the 'add_on_sub_operator' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAddOnSubOperatorList = api_v1alpha1.UnmarshalAddOnSubOperatorList

// ReadAddOnSubOperatorList reads list of values of the ”add_on_sub_operator' type from
// the given iterator.
var ReadAddOnSubOperatorList = api_v1alpha1.ReadAddOnSubOperatorList
