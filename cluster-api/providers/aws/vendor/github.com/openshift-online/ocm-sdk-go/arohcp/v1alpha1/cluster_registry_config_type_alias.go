...
//
// ```
type ClusterRegistryConfig = api_v1alpha1.ClusterRegistryConfig

// ClusterRegistryConfigListKind is the name of the type used to represent list of objects of
// type 'cluster_registry_config'.
const ClusterRegistryConfigListKind = api_v1alpha1.ClusterRegistryConfigListKind
...
const ClusterRegistryConfigListLinkKind = api_v1alpha1.ClusterRegistryConfigListLinkKind

// ClusterRegistryConfigNilKind is the name of the type used to nil lists of objects of
// type 'cluster_registry_config'.
const ClusterRegistryConfigListNilKind = api_v1alpha1.ClusterRegistryConfigListNilKind

type ClusterRegistryConfigList = api_v1alpha1.ClusterRegistryConfigList
