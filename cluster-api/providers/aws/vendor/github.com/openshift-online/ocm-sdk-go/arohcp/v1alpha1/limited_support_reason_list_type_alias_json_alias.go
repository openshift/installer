...
// the given writer.
var MarshalLimitedSupportReasonList = api_v1alpha1.MarshalLimitedSupportReasonList

// WriteLimitedSupportReasonList writes a list of value of the 'limited_support_reason' type to
// the given stream.
var WriteLimitedSupportReasonList = api_v1alpha1.WriteLimitedSupportReasonList

// UnmarshalLimitedSupportReasonList reads a list of values of the 'limited_support_reason' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLimitedSupportReasonList = api_v1alpha1.UnmarshalLimitedSupportReasonList

// ReadLimitedSupportReasonList reads list of values of the ”limited_support_reason' type from
// the given iterator.
var ReadLimitedSupportReasonList = api_v1alpha1.ReadLimitedSupportReasonList
