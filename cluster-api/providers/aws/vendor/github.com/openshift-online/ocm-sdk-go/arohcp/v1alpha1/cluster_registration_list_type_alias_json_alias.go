...
// the given writer.
var MarshalClusterRegistrationList = api_v1alpha1.MarshalClusterRegistrationList

// WriteClusterRegistrationList writes a list of value of the 'cluster_registration' type to
// the given stream.
var WriteClusterRegistrationList = api_v1alpha1.WriteClusterRegistrationList

// UnmarshalClusterRegistrationList reads a list of values of the 'cluster_registration' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterRegistrationList = api_v1alpha1.UnmarshalClusterRegistrationList

// ReadClusterRegistrationList reads list of values of the ”cluster_registration' type from
// the given iterator.
var ReadClusterRegistrationList = api_v1alpha1.ReadClusterRegistrationList
