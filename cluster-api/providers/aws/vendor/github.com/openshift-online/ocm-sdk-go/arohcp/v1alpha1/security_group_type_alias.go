...
type SecurityGroup = api_v1alpha1.SecurityGroup

// SecurityGroupListKind is the name of the type used to represent list of objects of
// type 'security_group'.
const SecurityGroupListKind = api_v1alpha1.SecurityGroupListKind

// SecurityGroupListLinkKind is the name of the type used to represent links to list
// of objects of type 'security_group'.
const SecurityGroupListLinkKind = api_v1alpha1.SecurityGroupListLinkKind

// SecurityGroupNilKind is the name of the type used to nil lists of objects of
// type 'security_group'.
const SecurityGroupListNilKind = api_v1alpha1.SecurityGroupListNilKind

type SecurityGroupList = api_v1alpha1.SecurityGroupList
