...
// the given writer.
var MarshalClusterCredentialsList = api_v1alpha1.MarshalClusterCredentialsList

// WriteClusterCredentialsList writes a list of value of the 'cluster_credentials' type to
// the given stream.
var WriteClusterCredentialsList = api_v1alpha1.WriteClusterCredentialsList

// UnmarshalClusterCredentialsList reads a list of values of the 'cluster_credentials' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterCredentialsList = api_v1alpha1.UnmarshalClusterCredentialsList

// ReadClusterCredentialsList reads list of values of the ”cluster_credentials' type from
// the given iterator.
var ReadClusterCredentialsList = api_v1alpha1.ReadClusterCredentialsList
