...
type Hypershift = api_v1alpha1.Hypershift

// HypershiftListKind is the name of the type used to represent list of objects of
// type 'hypershift'.
const HypershiftListKind = api_v1alpha1.HypershiftListKind

// HypershiftListLinkKind is the name of the type used to represent links to list
// of objects of type 'hypershift'.
const HypershiftListLinkKind = api_v1alpha1.HypershiftListLinkKind

// HypershiftNilKind is the name of the type used to nil lists of objects of
// type 'hypershift'.
const HypershiftListNilKind = api_v1alpha1.HypershiftListNilKind

type HypershiftList = api_v1alpha1.HypershiftList
