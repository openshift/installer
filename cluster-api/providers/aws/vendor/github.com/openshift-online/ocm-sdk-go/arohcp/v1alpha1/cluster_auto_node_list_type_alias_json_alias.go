...
// the given writer.
var MarshalClusterAutoNodeList = api_v1alpha1.MarshalClusterAutoNodeList

// WriteClusterAutoNodeList writes a list of value of the 'cluster_auto_node' type to
// the given stream.
var WriteClusterAutoNodeList = api_v1alpha1.WriteClusterAutoNodeList

// UnmarshalClusterAutoNodeList reads a list of values of the 'cluster_auto_node' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterAutoNodeList = api_v1alpha1.UnmarshalClusterAutoNodeList

// ReadClusterAutoNodeList reads list of values of the ”cluster_auto_node' type from
// the given iterator.
var ReadClusterAutoNodeList = api_v1alpha1.ReadClusterAutoNodeList
