...
const AWSInfrastructureAccessRoleGrantKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantKind
...
const AWSInfrastructureAccessRoleGrantLinkKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantLinkKind

// AWSInfrastructureAccessRoleGrantNilKind is the name of the type used to nil references
// to objects of type 'AWS_infrastructure_access_role_grant'.
const AWSInfrastructureAccessRoleGrantNilKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantNilKind
...
type AWSInfrastructureAccessRoleGrant = api_v1alpha1.AWSInfrastructureAccessRoleGrant
...
const AWSInfrastructureAccessRoleGrantListKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantListKind
...
const AWSInfrastructureAccessRoleGrantListLinkKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantListLinkKind

// AWSInfrastructureAccessRoleGrantNilKind is the name of the type used to nil lists of objects of
// type 'AWS_infrastructure_access_role_grant'.
const AWSInfrastructureAccessRoleGrantListNilKind = api_v1alpha1.AWSInfrastructureAccessRoleGrantListNilKind

type AWSInfrastructureAccessRoleGrantList = api_v1alpha1.AWSInfrastructureAccessRoleGrantList
