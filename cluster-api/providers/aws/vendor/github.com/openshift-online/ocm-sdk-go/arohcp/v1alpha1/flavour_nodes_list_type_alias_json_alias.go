...
// the given writer.
var MarshalFlavourNodesList = api_v1alpha1.MarshalFlavourNodesList

// WriteFlavourNodesList writes a list of value of the 'flavour_nodes' type to
// the given stream.
var WriteFlavourNodesList = api_v1alpha1.WriteFlavourNodesList

// UnmarshalFlavourNodesList reads a list of values of the 'flavour_nodes' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalFlavourNodesList = api_v1alpha1.UnmarshalFlavourNodesList

// ReadFlavourNodesList reads list of values of the ”flavour_nodes' type from
// the given iterator.
var ReadFlavourNodesList = api_v1alpha1.ReadFlavourNodesList
