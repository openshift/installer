...
// the given writer.
var MarshalEventList = api_v1alpha1.MarshalEventList

// WriteEventList writes a list of value of the 'event' type to
// the given stream.
var WriteEventList = api_v1alpha1.WriteEventList

// UnmarshalEventList reads a list of values of the 'event' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalEventList = api_v1alpha1.UnmarshalEventList

// ReadEventList reads list of values of the ”event' type from
// the given iterator.
var ReadEventList = api_v1alpha1.ReadEventList
