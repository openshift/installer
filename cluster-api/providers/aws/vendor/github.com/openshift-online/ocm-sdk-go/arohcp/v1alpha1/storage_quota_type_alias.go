...
type StorageQuota = api_v1alpha1.StorageQuota

// StorageQuotaListKind is the name of the type used to represent list of objects of
// type 'storage_quota'.
const StorageQuotaListKind = api_v1alpha1.StorageQuotaListKind

// StorageQuotaListLinkKind is the name of the type used to represent links to list
// of objects of type 'storage_quota'.
const StorageQuotaListLinkKind = api_v1alpha1.StorageQuotaListLinkKind

// StorageQuotaNilKind is the name of the type used to nil lists of objects of
// type 'storage_quota'.
const StorageQuotaListNilKind = api_v1alpha1.StorageQuotaListNilKind

type StorageQuotaList = api_v1alpha1.StorageQuotaList
