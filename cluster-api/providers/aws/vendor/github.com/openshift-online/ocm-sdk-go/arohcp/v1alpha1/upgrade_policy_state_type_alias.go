...
const UpgradePolicyStateKind = api_v1alpha1.UpgradePolicyStateKind

// UpgradePolicyStateLinkKind is the name of the type used to represent links
// to objects of type 'upgrade_policy_state'.
const UpgradePolicyStateLinkKind = api_v1alpha1.UpgradePolicyStateLinkKind

// UpgradePolicyStateNilKind is the name of the type used to nil references
// to objects of type 'upgrade_policy_state'.
const UpgradePolicyStateNilKind = api_v1alpha1.UpgradePolicyStateNilKind
...
type UpgradePolicyState = api_v1alpha1.UpgradePolicyState

// UpgradePolicyStateListKind is the name of the type used to represent list of objects of
// type 'upgrade_policy_state'.
const UpgradePolicyStateListKind = api_v1alpha1.UpgradePolicyStateListKind
...
const UpgradePolicyStateListLinkKind = api_v1alpha1.UpgradePolicyStateListLinkKind

// UpgradePolicyStateNilKind is the name of the type used to nil lists of objects of
// type 'upgrade_policy_state'.
const UpgradePolicyStateListNilKind = api_v1alpha1.UpgradePolicyStateListNilKind

type UpgradePolicyStateList = api_v1alpha1.UpgradePolicyStateList
