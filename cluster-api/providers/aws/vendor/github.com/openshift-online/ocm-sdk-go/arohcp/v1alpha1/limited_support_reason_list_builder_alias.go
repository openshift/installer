...
type LimitedSupportReasonListBuilder = api_v1alpha1.LimitedSupportReasonListBuilder

// NewLimitedSupportReasonList creates a new builder of 'limited_support_reason' objects.
var NewLimitedSupportReasonList = api_v1alpha1.NewLimitedSupportReasonList
