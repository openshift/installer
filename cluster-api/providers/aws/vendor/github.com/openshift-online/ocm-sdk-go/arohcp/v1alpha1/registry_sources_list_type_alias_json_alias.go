...
// the given writer.
var MarshalRegistrySourcesList = api_v1alpha1.MarshalRegistrySourcesList

// WriteRegistrySourcesList writes a list of value of the 'registry_sources' type to
// the given stream.
var WriteRegistrySourcesList = api_v1alpha1.WriteRegistrySourcesList

// UnmarshalRegistrySourcesList reads a list of values of the 'registry_sources' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalRegistrySourcesList = api_v1alpha1.UnmarshalRegistrySourcesList

// ReadRegistrySourcesList reads list of values of the ”registry_sources' type from
// the given iterator.
var ReadRegistrySourcesList = api_v1alpha1.ReadRegistrySourcesList
