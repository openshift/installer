...
// the given writer.
var MarshalImageMirrorList = api_v1alpha1.MarshalImageMirrorList

// WriteImageMirrorList writes a list of value of the 'image_mirror' type to
// the given stream.
var WriteImageMirrorList = api_v1alpha1.WriteImageMirrorList

// UnmarshalImageMirrorList reads a list of values of the 'image_mirror' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalImageMirrorList = api_v1alpha1.UnmarshalImageMirrorList

// ReadImageMirrorList reads list of values of the ”image_mirror' type from
// the given iterator.
var ReadImageMirrorList = api_v1alpha1.ReadImageMirrorList
