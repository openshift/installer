...
// the given writer.
var MarshalVersionGateAgreementList = api_v1alpha1.MarshalVersionGateAgreementList

// WriteVersionGateAgreementList writes a list of value of the 'version_gate_agreement' type to
// the given stream.
var WriteVersionGateAgreementList = api_v1alpha1.WriteVersionGateAgreementList

// UnmarshalVersionGateAgreementList reads a list of values of the 'version_gate_agreement' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalVersionGateAgreementList = api_v1alpha1.UnmarshalVersionGateAgreementList

// ReadVersionGateAgreementList reads list of values of the ”version_gate_agreement' type from
// the given iterator.
var ReadVersionGateAgreementList = api_v1alpha1.ReadVersionGateAgreementList
