...
type GCPFlavour = api_v1alpha1.GCPFlavour

// GCPFlavourListKind is the name of the type used to represent list of objects of
// type 'GCP_flavour'.
const GCPFlavourListKind = api_v1alpha1.GCPFlavourListKind

// GCPFlavourListLinkKind is the name of the type used to represent links to list
// of objects of type 'GCP_flavour'.
const GCPFlavourListLinkKind = api_v1alpha1.GCPFlavourListLinkKind

// GCPFlavourNilKind is the name of the type used to nil lists of objects of
// type 'GCP_flavour'.
const GCPFlavourListNilKind = api_v1alpha1.GCPFlavourListNilKind

type GCPFlavourList = api_v1alpha1.GCPFlavourList
