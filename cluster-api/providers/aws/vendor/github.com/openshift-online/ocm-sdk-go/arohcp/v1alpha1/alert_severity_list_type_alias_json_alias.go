...
// the given writer.
var MarshalAlertSeverityList = api_v1alpha1.MarshalAlertSeverityList

// WriteAlertSeverityList writes a list of value of the 'alert_severity' type to
// the given stream.
var WriteAlertSeverityList = api_v1alpha1.WriteAlertSeverityList

// UnmarshalAlertSeverityList reads a list of values of the 'alert_severity' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAlertSeverityList = api_v1alpha1.UnmarshalAlertSeverityList

// ReadAlertSeverityList reads list of values of the ”alert_severity' type from
// the given iterator.
var ReadAlertSeverityList = api_v1alpha1.ReadAlertSeverityList
