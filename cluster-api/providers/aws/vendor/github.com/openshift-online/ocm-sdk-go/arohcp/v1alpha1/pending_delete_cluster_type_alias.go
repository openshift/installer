...
const PendingDeleteClusterKind = api_v1alpha1.PendingDeleteClusterKind

// PendingDeleteClusterLinkKind is the name of the type used to represent links
// to objects of type 'pending_delete_cluster'.
const PendingDeleteClusterLinkKind = api_v1alpha1.PendingDeleteClusterLinkKind

// PendingDeleteClusterNilKind is the name of the type used to nil references
// to objects of type 'pending_delete_cluster'.
const PendingDeleteClusterNilKind = api_v1alpha1.PendingDeleteClusterNilKind
...
type PendingDeleteCluster = api_v1alpha1.PendingDeleteCluster

// PendingDeleteClusterListKind is the name of the type used to represent list of objects of
// type 'pending_delete_cluster'.
const PendingDeleteClusterListKind = api_v1alpha1.PendingDeleteClusterListKind
...
const PendingDeleteClusterListLinkKind = api_v1alpha1.PendingDeleteClusterListLinkKind

// PendingDeleteClusterNilKind is the name of the type used to nil lists of objects of
// type 'pending_delete_cluster'.
const PendingDeleteClusterListNilKind = api_v1alpha1.PendingDeleteClusterListNilKind

type PendingDeleteClusterList = api_v1alpha1.PendingDeleteClusterList
