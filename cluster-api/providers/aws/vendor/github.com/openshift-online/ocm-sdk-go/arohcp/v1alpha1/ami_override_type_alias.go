...
const AMIOverrideKind = api_v1alpha1.AMIOverrideKind

// AMIOverrideLinkKind is the name of the type used to represent links
// to objects of type 'AMI_override'.
const AMIOverrideLinkKind = api_v1alpha1.AMIOverrideLinkKind

// AMIOverrideNilKind is the name of the type used to nil references
// to objects of type 'AMI_override'.
const AMIOverrideNilKind = api_v1alpha1.AMIOverrideNilKind
...
type AMIOverride = api_v1alpha1.AMIOverride

// AMIOverrideListKind is the name of the type used to represent list of objects of
// type 'AMI_override'.
const AMIOverrideListKind = api_v1alpha1.AMIOverrideListKind

// AMIOverrideListLinkKind is the name of the type used to represent links to list
// of objects of type 'AMI_override'.
const AMIOverrideListLinkKind = api_v1alpha1.AMIOverrideListLinkKind

// AMIOverrideNilKind is the name of the type used to nil lists of objects of
// type 'AMI_override'.
const AMIOverrideListNilKind = api_v1alpha1.AMIOverrideListNilKind

type AMIOverrideList = api_v1alpha1.AMIOverrideList
