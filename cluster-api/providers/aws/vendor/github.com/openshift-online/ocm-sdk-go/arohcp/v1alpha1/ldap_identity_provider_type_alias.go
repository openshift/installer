...
type LDAPIdentityProvider = api_v1alpha1.LDAPIdentityProvider

// LDAPIdentityProviderListKind is the name of the type used to represent list of objects of
// type 'LDAP_identity_provider'.
const LDAPIdentityProviderListKind = api_v1alpha1.LDAPIdentityProviderListKind
...
const LDAPIdentityProviderListLinkKind = api_v1alpha1.LDAPIdentityProviderListLinkKind

// LDAPIdentityProviderNilKind is the name of the type used to nil lists of objects of
// type 'LDAP_identity_provider'.
const LDAPIdentityProviderListNilKind = api_v1alpha1.LDAPIdentityProviderListNilKind

type LDAPIdentityProviderList = api_v1alpha1.LDAPIdentityProviderList
