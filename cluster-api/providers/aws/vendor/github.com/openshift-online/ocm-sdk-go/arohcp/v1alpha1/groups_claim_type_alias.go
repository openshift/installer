...
type GroupsClaim = api_v1alpha1.GroupsClaim

// GroupsClaimListKind is the name of the type used to represent list of objects of
// type 'groups_claim'.
const GroupsClaimListKind = api_v1alpha1.GroupsClaimListKind

// GroupsClaimListLinkKind is the name of the type used to represent links to list
// of objects of type 'groups_claim'.
const GroupsClaimListLinkKind = api_v1alpha1.GroupsClaimListLinkKind

// GroupsClaimNilKind is the name of the type used to nil lists of objects of
// type 'groups_claim'.
const GroupsClaimListNilKind = api_v1alpha1.GroupsClaimListNilKind

type GroupsClaimList = api_v1alpha1.GroupsClaimList
