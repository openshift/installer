...
// the given writer.
var MarshalAddOnInstallationStateList = api_v1alpha1.MarshalAddOnInstallationStateList

// WriteAddOnInstallationStateList writes a list of value of the 'add_on_installation_state' type to
// the given stream.
var WriteAddOnInstallationStateList = api_v1alpha1.WriteAddOnInstallationStateList

// UnmarshalAddOnInstallationStateList reads a list of values of the 'add_on_installation_state' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAddOnInstallationStateList = api_v1alpha1.UnmarshalAddOnInstallationStateList

// ReadAddOnInstallationStateList reads list of values of the ”add_on_installation_state' type from
// the given iterator.
var ReadAddOnInstallationStateList = api_v1alpha1.ReadAddOnInstallationStateList
