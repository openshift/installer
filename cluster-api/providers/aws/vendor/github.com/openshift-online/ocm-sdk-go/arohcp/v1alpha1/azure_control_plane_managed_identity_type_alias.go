...
type AzureControlPlaneManagedIdentity = api_v1alpha1.AzureControlPlaneManagedIdentity
...
const AzureControlPlaneManagedIdentityListKind = api_v1alpha1.AzureControlPlaneManagedIdentityListKind
...
const AzureControlPlaneManagedIdentityListLinkKind = api_v1alpha1.AzureControlPlaneManagedIdentityListLinkKind

// AzureControlPlaneManagedIdentityNilKind is the name of the type used to nil lists of objects of
// type 'azure_control_plane_managed_identity'.
const AzureControlPlaneManagedIdentityListNilKind = api_v1alpha1.AzureControlPlaneManagedIdentityListNilKind

type AzureControlPlaneManagedIdentityList = api_v1alpha1.AzureControlPlaneManagedIdentityList
