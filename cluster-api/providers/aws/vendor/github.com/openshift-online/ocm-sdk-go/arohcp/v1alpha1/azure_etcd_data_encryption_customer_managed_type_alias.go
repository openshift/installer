...
type AzureEtcdDataEncryptionCustomerManaged = api_v1alpha1.AzureEtcdDataEncryptionCustomerManaged
...
const AzureEtcdDataEncryptionCustomerManagedListKind = api_v1alpha1.AzureEtcdDataEncryptionCustomerManagedListKind
...
const AzureEtcdDataEncryptionCustomerManagedListLinkKind = api_v1alpha1.AzureEtcdDataEncryptionCustomerManagedListLinkKind

// AzureEtcdDataEncryptionCustomerManagedNilKind is the name of the type used to nil lists of objects of
// type 'azure_etcd_data_encryption_customer_managed'.
const AzureEtcdDataEncryptionCustomerManagedListNilKind = api_v1alpha1.AzureEtcdDataEncryptionCustomerManagedListNilKind

type AzureEtcdDataEncryptionCustomerManagedList = api_v1alpha1.AzureEtcdDataEncryptionCustomerManagedList
