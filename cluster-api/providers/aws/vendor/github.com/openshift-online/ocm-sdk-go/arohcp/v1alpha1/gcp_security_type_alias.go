...
type GcpSecurity = api_v1alpha1.GcpSecurity

// GcpSecurityListKind is the name of the type used to represent list of objects of
// type 'gcp_security'.
const GcpSecurityListKind = api_v1alpha1.GcpSecurityListKind

// GcpSecurityListLinkKind is the name of the type used to represent links to list
// of objects of type 'gcp_security'.
const GcpSecurityListLinkKind = api_v1alpha1.GcpSecurityListLinkKind

// GcpSecurityNilKind is the name of the type used to nil lists of objects of
// type 'gcp_security'.
const GcpSecurityListNilKind = api_v1alpha1.GcpSecurityListNilKind

type GcpSecurityList = api_v1alpha1.GcpSecurityList
