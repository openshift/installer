...
// the given writer.
var MarshalProvisionShardMaestroConfigList = api_v1alpha1.MarshalProvisionShardMaestroConfigList

// WriteProvisionShardMaestroConfigList writes a list of value of the 'provision_shard_maestro_config' type to
// the given stream.
var WriteProvisionShardMaestroConfigList = api_v1alpha1.WriteProvisionShardMaestroConfigList

// UnmarshalProvisionShardMaestroConfigList reads a list of values of the 'provision_shard_maestro_config' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalProvisionShardMaestroConfigList = api_v1alpha1.UnmarshalProvisionShardMaestroConfigList

// ReadProvisionShardMaestroConfigList reads list of values of the ”provision_shard_maestro_config' type from
// the given iterator.
var ReadProvisionShardMaestroConfigList = api_v1alpha1.ReadProvisionShardMaestroConfigList
