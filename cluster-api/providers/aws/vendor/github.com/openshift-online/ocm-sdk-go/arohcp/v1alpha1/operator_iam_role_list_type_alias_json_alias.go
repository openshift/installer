...
// the given writer.
var MarshalOperatorIAMRoleList = api_v1alpha1.MarshalOperatorIAMRoleList

// WriteOperatorIAMRoleList writes a list of value of the 'operator_IAM_role' type to
// the given stream.
var WriteOperatorIAMRoleList = api_v1alpha1.WriteOperatorIAMRoleList

// UnmarshalOperatorIAMRoleList reads a list of values of the 'operator_IAM_role' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalOperatorIAMRoleList = api_v1alpha1.UnmarshalOperatorIAMRoleList

// ReadOperatorIAMRoleList reads list of values of the ”operator_IAM_role' type from
// the given iterator.
var ReadOperatorIAMRoleList = api_v1alpha1.ReadOperatorIAMRoleList
