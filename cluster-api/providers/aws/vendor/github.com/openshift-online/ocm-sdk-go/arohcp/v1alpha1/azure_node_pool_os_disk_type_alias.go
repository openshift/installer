...
type AzureNodePoolOsDisk = api_v1alpha1.AzureNodePoolOsDisk

// AzureNodePoolOsDiskListKind is the name of the type used to represent list of objects of
// type 'azure_node_pool_os_disk'.
const AzureNodePoolOsDiskListKind = api_v1alpha1.AzureNodePoolOsDiskListKind
...
const AzureNodePoolOsDiskListLinkKind = api_v1alpha1.AzureNodePoolOsDiskListLinkKind

// AzureNodePoolOsDiskNilKind is the name of the type used to nil lists of objects of
// type 'azure_node_pool_os_disk'.
const AzureNodePoolOsDiskListNilKind = api_v1alpha1.AzureNodePoolOsDiskListNilKind

type AzureNodePoolOsDiskList = api_v1alpha1.AzureNodePoolOsDiskList
