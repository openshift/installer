...
type ClientComponent = api_v1alpha1.ClientComponent

// ClientComponentListKind is the name of the type used to represent list of objects of
// type 'client_component'.
const ClientComponentListKind = api_v1alpha1.ClientComponentListKind

// ClientComponentListLinkKind is the name of the type used to represent links to list
// of objects of type 'client_component'.
const ClientComponentListLinkKind = api_v1alpha1.ClientComponentListLinkKind

// ClientComponentNilKind is the name of the type used to nil lists of objects of
// type 'client_component'.
const ClientComponentListNilKind = api_v1alpha1.ClientComponentListNilKind

type ClientComponentList = api_v1alpha1.ClientComponentList
