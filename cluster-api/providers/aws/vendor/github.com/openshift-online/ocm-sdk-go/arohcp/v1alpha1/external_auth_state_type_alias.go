...
type ExternalAuthState = api_v1alpha1.ExternalAuthState

// ExternalAuthStateListKind is the name of the type used to represent list of objects of
// type 'external_auth_state'.
const ExternalAuthStateListKind = api_v1alpha1.ExternalAuthStateListKind
...
const ExternalAuthStateListLinkKind = api_v1alpha1.ExternalAuthStateListLinkKind

// ExternalAuthStateNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_state'.
const ExternalAuthStateListNilKind = api_v1alpha1.ExternalAuthStateListNilKind

type ExternalAuthStateList = api_v1alpha1.ExternalAuthStateList
