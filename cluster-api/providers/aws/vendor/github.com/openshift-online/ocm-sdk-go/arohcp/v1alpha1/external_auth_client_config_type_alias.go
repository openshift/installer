...
type ExternalAuthClientConfig = api_v1alpha1.ExternalAuthClientConfig
...
const ExternalAuthClientConfigListKind = api_v1alpha1.ExternalAuthClientConfigListKind
...
const ExternalAuthClientConfigListLinkKind = api_v1alpha1.ExternalAuthClientConfigListLinkKind

// ExternalAuthClientConfigNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_client_config'.
const ExternalAuthClientConfigListNilKind = api_v1alpha1.ExternalAuthClientConfigListNilKind

type ExternalAuthClientConfigList = api_v1alpha1.ExternalAuthClientConfigList
