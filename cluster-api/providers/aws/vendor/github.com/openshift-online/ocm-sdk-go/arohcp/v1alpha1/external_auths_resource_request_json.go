...
func writeExternalAuthsAsyncAddRequest(request *ExternalAuthsAddRequest, writer io.Writer) error {
	return MarshalExternalAuth(request.body, writer)
}
func readExternalAuthsAsyncAddResponse(response *ExternalAuthsAddResponse, reader io.Reader) error {
	var err error
...
func readExternalAuthsListResponse(response *ExternalAuthsListResponse, reader io.Reader) error {
	...
	for {
		...
		case "items":
			...
			responseItems := &ExternalAuthList{}
