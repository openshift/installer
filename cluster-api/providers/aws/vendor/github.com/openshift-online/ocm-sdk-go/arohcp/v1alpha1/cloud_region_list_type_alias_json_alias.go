...
// the given writer.
var MarshalCloudRegionList = api_v1alpha1.MarshalCloudRegionList

// WriteCloudRegionList writes a list of value of the 'cloud_region' type to
// the given stream.
var WriteCloudRegionList = api_v1alpha1.WriteCloudRegionList

// UnmarshalCloudRegionList reads a list of values of the 'cloud_region' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalCloudRegionList = api_v1alpha1.UnmarshalCloudRegionList

// ReadCloudRegionList reads list of values of the ”cloud_region' type from
// the given iterator.
var ReadCloudRegionList = api_v1alpha1.ReadCloudRegionList
