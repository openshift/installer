...
// the given writer.
var MarshalCIDRBlockAccessList = api_v1alpha1.MarshalCIDRBlockAccessList

// WriteCIDRBlockAccessList writes a list of value of the 'CIDR_block_access' type to
// the given stream.
var WriteCIDRBlockAccessList = api_v1alpha1.WriteCIDRBlockAccessList

// UnmarshalCIDRBlockAccessList reads a list of values of the 'CIDR_block_access' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalCIDRBlockAccessList = api_v1alpha1.UnmarshalCIDRBlockAccessList

// ReadCIDRBlockAccessList reads list of values of the ”CIDR_block_access' type from
// the given iterator.
var ReadCIDRBlockAccessList = api_v1alpha1.ReadCIDRBlockAccessList
