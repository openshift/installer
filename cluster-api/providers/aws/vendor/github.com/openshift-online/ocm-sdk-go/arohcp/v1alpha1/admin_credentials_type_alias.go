...
// cluster.
type AdminCredentials = api_v1alpha1.AdminCredentials

// AdminCredentialsListKind is the name of the type used to represent list of objects of
// type 'admin_credentials'.
const AdminCredentialsListKind = api_v1alpha1.AdminCredentialsListKind

// AdminCredentialsListLinkKind is the name of the type used to represent links to list
// of objects of type 'admin_credentials'.
const AdminCredentialsListLinkKind = api_v1alpha1.AdminCredentialsListLinkKind

// AdminCredentialsNilKind is the name of the type used to nil lists of objects of
// type 'admin_credentials'.
const AdminCredentialsListNilKind = api_v1alpha1.AdminCredentialsListNilKind

type AdminCredentialsList = api_v1alpha1.AdminCredentialsList
