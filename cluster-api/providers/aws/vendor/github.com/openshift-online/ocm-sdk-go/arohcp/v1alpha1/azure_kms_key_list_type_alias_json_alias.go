...
// the given writer.
var MarshalAzureKmsKeyList = api_v1alpha1.MarshalAzureKmsKeyList

// WriteAzureKmsKeyList writes a list of value of the 'azure_kms_key' type to
// the given stream.
var WriteAzureKmsKeyList = api_v1alpha1.WriteAzureKmsKeyList

// UnmarshalAzureKmsKeyList reads a list of values of the 'azure_kms_key' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureKmsKeyList = api_v1alpha1.UnmarshalAzureKmsKeyList

// ReadAzureKmsKeyList reads list of values of the ”azure_kms_key' type from
// the given iterator.
var ReadAzureKmsKeyList = api_v1alpha1.ReadAzureKmsKeyList
