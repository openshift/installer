...
// the given writer.
var MarshalProvisionShardList = api_v1alpha1.MarshalProvisionShardList

// WriteProvisionShardList writes a list of value of the 'provision_shard' type to
// the given stream.
var WriteProvisionShardList = api_v1alpha1.WriteProvisionShardList

// UnmarshalProvisionShardList reads a list of values of the 'provision_shard' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalProvisionShardList = api_v1alpha1.UnmarshalProvisionShardList

// ReadProvisionShardList reads list of values of the ”provision_shard' type from
// the given iterator.
var ReadProvisionShardList = api_v1alpha1.ReadProvisionShardList
