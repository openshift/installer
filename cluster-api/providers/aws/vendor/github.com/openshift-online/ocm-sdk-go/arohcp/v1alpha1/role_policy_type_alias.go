...
type RolePolicy = api_v1alpha1.RolePolicy

// RolePolicyListKind is the name of the type used to represent list of objects of
// type 'role_policy'.
const RolePolicyListKind = api_v1alpha1.RolePolicyListKind

// RolePolicyListLinkKind is the name of the type used to represent links to list
// of objects of type 'role_policy'.
const RolePolicyListLinkKind = api_v1alpha1.RolePolicyListLinkKind

// RolePolicyNilKind is the name of the type used to nil lists of objects of
// type 'role_policy'.
const RolePolicyListNilKind = api_v1alpha1.RolePolicyListNilKind

type RolePolicyList = api_v1alpha1.RolePolicyList
