...
// the given writer.
var MarshalSocketTotalsNodeRoleOSMetricNodeList = api_v1alpha1.MarshalSocketTotalsNodeRoleOSMetricNodeList

// WriteSocketTotalsNodeRoleOSMetricNodeList writes a list of value of the 'socket_totals_node_role_OS_metric_node' type to
// the given stream.
var WriteSocketTotalsNodeRoleOSMetricNodeList = api_v1alpha1.WriteSocketTotalsNodeRoleOSMetricNodeList
...
var UnmarshalSocketTotalsNodeRoleOSMetricNodeList = api_v1alpha1.UnmarshalSocketTotalsNodeRoleOSMetricNodeList

// ReadSocketTotalsNodeRoleOSMetricNodeList reads list of values of the ”socket_totals_node_role_OS_metric_node' type from
// the given iterator.
var ReadSocketTotalsNodeRoleOSMetricNodeList = api_v1alpha1.ReadSocketTotalsNodeRoleOSMetricNodeList
