...
// the given writer.
var MarshalInflightCheckStateList = api_v1alpha1.MarshalInflightCheckStateList

// WriteInflightCheckStateList writes a list of value of the 'inflight_check_state' type to
// the given stream.
var WriteInflightCheckStateList = api_v1alpha1.WriteInflightCheckStateList

// UnmarshalInflightCheckStateList reads a list of values of the 'inflight_check_state' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalInflightCheckStateList = api_v1alpha1.UnmarshalInflightCheckStateList

// ReadInflightCheckStateList reads list of values of the ”inflight_check_state' type from
// the given iterator.
var ReadInflightCheckStateList = api_v1alpha1.ReadInflightCheckStateList
