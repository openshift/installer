...
// the given writer.
var MarshalProductMinimalVersionList = api_v1alpha1.MarshalProductMinimalVersionList

// WriteProductMinimalVersionList writes a list of value of the 'product_minimal_version' type to
// the given stream.
var WriteProductMinimalVersionList = api_v1alpha1.WriteProductMinimalVersionList

// UnmarshalProductMinimalVersionList reads a list of values of the 'product_minimal_version' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalProductMinimalVersionList = api_v1alpha1.UnmarshalProductMinimalVersionList

// ReadProductMinimalVersionList reads list of values of the ”product_minimal_version' type from
// the given iterator.
var ReadProductMinimalVersionList = api_v1alpha1.ReadProductMinimalVersionList
