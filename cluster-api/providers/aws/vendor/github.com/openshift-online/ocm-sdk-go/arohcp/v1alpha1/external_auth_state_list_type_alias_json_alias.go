...
// the given writer.
var MarshalExternalAuthStateList = api_v1alpha1.MarshalExternalAuthStateList

// WriteExternalAuthStateList writes a list of value of the 'external_auth_state' type to
// the given stream.
var WriteExternalAuthStateList = api_v1alpha1.WriteExternalAuthStateList

// UnmarshalExternalAuthStateList reads a list of values of the 'external_auth_state' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthStateList = api_v1alpha1.UnmarshalExternalAuthStateList

// ReadExternalAuthStateList reads list of values of the ”external_auth_state' type from
// the given iterator.
var ReadExternalAuthStateList = api_v1alpha1.ReadExternalAuthStateList
