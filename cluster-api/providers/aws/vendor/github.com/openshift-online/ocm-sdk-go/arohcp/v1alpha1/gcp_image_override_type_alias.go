...
const GCPImageOverrideListKind = api_v1alpha1.GCPImageOverrideListKind
...
const GCPImageOverrideListLinkKind = api_v1alpha1.GCPImageOverrideListLinkKind

// GCPImageOverrideNilKind is the name of the type used to nil lists of objects of
// type 'GCP_image_override'.
const GCPImageOverrideListNilKind = api_v1alpha1.GCPImageOverrideListNilKind
