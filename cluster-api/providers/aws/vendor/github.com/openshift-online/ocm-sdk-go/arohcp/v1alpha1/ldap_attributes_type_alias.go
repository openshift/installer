...
type LDAPAttributes = api_v1alpha1.LDAPAttributes

// LDAPAttributesListKind is the name of the type used to represent list of objects of
// type 'LDAP_attributes'.
const LDAPAttributesListKind = api_v1alpha1.LDAPAttributesListKind

// LDAPAttributesListLinkKind is the name of the type used to represent links to list
// of objects of type 'LDAP_attributes'.
const LDAPAttributesListLinkKind = api_v1alpha1.LDAPAttributesListLinkKind

// LDAPAttributesNilKind is the name of the type used to nil lists of objects of
// type 'LDAP_attributes'.
const LDAPAttributesListNilKind = api_v1alpha1.LDAPAttributesListNilKind

type LDAPAttributesList = api_v1alpha1.LDAPAttributesList
