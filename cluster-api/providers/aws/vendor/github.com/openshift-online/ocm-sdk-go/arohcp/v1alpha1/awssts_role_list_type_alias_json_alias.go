...
// the given writer.
var MarshalAWSSTSRoleList = api_v1alpha1.MarshalAWSSTSRoleList

// WriteAWSSTSRoleList writes a list of value of the 'AWSSTS_role' type to
// the given stream.
var WriteAWSSTSRoleList = api_v1alpha1.WriteAWSSTSRoleList

// UnmarshalAWSSTSRoleList reads a list of values of the 'AWSSTS_role' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAWSSTSRoleList = api_v1alpha1.UnmarshalAWSSTSRoleList

// ReadAWSSTSRoleList reads list of values of the ”AWSSTS_role' type from
// the given iterator.
var ReadAWSSTSRoleList = api_v1alpha1.ReadAWSSTSRoleList
