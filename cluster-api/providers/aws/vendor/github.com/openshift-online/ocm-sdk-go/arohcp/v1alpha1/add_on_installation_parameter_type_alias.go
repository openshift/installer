...
const AddOnInstallationParameterKind = api_v1alpha1.AddOnInstallationParameterKind
...
const AddOnInstallationParameterLinkKind = api_v1alpha1.AddOnInstallationParameterLinkKind

// AddOnInstallationParameterNilKind is the name of the type used to nil references
// to objects of type 'add_on_installation_parameter'.
const AddOnInstallationParameterNilKind = api_v1alpha1.AddOnInstallationParameterNilKind
...
type AddOnInstallationParameter = api_v1alpha1.AddOnInstallationParameter
...
const AddOnInstallationParameterListKind = api_v1alpha1.AddOnInstallationParameterListKind
...
const AddOnInstallationParameterListLinkKind = api_v1alpha1.AddOnInstallationParameterListLinkKind

// AddOnInstallationParameterNilKind is the name of the type used to nil lists of objects of
// type 'add_on_installation_parameter'.
const AddOnInstallationParameterListNilKind = api_v1alpha1.AddOnInstallationParameterListNilKind

type AddOnInstallationParameterList = api_v1alpha1.AddOnInstallationParameterList
