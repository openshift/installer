...
type FlavourNodes = api_v1alpha1.FlavourNodes

// FlavourNodesListKind is the name of the type used to represent list of objects of
// type 'flavour_nodes'.
const FlavourNodesListKind = api_v1alpha1.FlavourNodesListKind

// FlavourNodesListLinkKind is the name of the type used to represent links to list
// of objects of type 'flavour_nodes'.
const FlavourNodesListLinkKind = api_v1alpha1.FlavourNodesListLinkKind

// FlavourNodesNilKind is the name of the type used to nil lists of objects of
// type 'flavour_nodes'.
const FlavourNodesListNilKind = api_v1alpha1.FlavourNodesListNilKind

type FlavourNodesList = api_v1alpha1.FlavourNodesList
