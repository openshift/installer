...
// the given writer.
var MarshalCloudVPCList = api_v1alpha1.MarshalCloudVPCList

// WriteCloudVPCList writes a list of value of the 'cloud_VPC' type to
// the given stream.
var WriteCloudVPCList = api_v1alpha1.WriteCloudVPCList

// UnmarshalCloudVPCList reads a list of values of the 'cloud_VPC' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalCloudVPCList = api_v1alpha1.UnmarshalCloudVPCList

// ReadCloudVPCList reads list of values of the ”cloud_VPC' type from
// the given iterator.
var ReadCloudVPCList = api_v1alpha1.ReadCloudVPCList
