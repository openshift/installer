...
const ProvisionShardKind = api_v1alpha1.ProvisionShardKind

// ProvisionShardLinkKind is the name of the type used to represent links
// to objects of type 'provision_shard'.
const ProvisionShardLinkKind = api_v1alpha1.ProvisionShardLinkKind

// ProvisionShardNilKind is the name of the type used to nil references
// to objects of type 'provision_shard'.
const ProvisionShardNilKind = api_v1alpha1.ProvisionShardNilKind
...
const ProvisionShardListKind = api_v1alpha1.ProvisionShardListKind

// ProvisionShardListLinkKind is the name of the type used to represent links to list
// of objects of type 'provision_shard'.
const ProvisionShardListLinkKind = api_v1alpha1.ProvisionShardListLinkKind

// ProvisionShardNilKind is the name of the type used to nil lists of objects of
// type 'provision_shard'.
const ProvisionShardListNilKind = api_v1alpha1.ProvisionShardListNilKind

type ProvisionShardList = api_v1alpha1.ProvisionShardList
