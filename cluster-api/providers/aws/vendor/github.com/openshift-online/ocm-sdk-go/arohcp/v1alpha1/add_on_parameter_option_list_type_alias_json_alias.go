...
// the given writer.
var MarshalAddOnParameterOptionList = api_v1alpha1.MarshalAddOnParameterOptionList

// WriteAddOnParameterOptionList writes a list of value of the 'add_on_parameter_option' type to
// the given stream.
var WriteAddOnParameterOptionList = api_v1alpha1.WriteAddOnParameterOptionList

// UnmarshalAddOnParameterOptionList reads a list of values of the 'add_on_parameter_option' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAddOnParameterOptionList = api_v1alpha1.UnmarshalAddOnParameterOptionList

// ReadAddOnParameterOptionList reads list of values of the ”add_on_parameter_option' type from
// the given iterator.
var ReadAddOnParameterOptionList = api_v1alpha1.ReadAddOnParameterOptionList
