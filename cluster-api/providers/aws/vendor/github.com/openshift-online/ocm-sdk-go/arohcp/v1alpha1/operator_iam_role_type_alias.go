...
type OperatorIAMRole = api_v1alpha1.OperatorIAMRole

// OperatorIAMRoleListKind is the name of the type used to represent list of objects of
// type 'operator_IAM_role'.
const OperatorIAMRoleListKind = api_v1alpha1.OperatorIAMRoleListKind

// OperatorIAMRoleListLinkKind is the name of the type used to represent links to list
// of objects of type 'operator_IAM_role'.
const OperatorIAMRoleListLinkKind = api_v1alpha1.OperatorIAMRoleListLinkKind

// OperatorIAMRoleNilKind is the name of the type used to nil lists of objects of
// type 'operator_IAM_role'.
const OperatorIAMRoleListNilKind = api_v1alpha1.OperatorIAMRoleListNilKind

type OperatorIAMRoleList = api_v1alpha1.OperatorIAMRoleList
