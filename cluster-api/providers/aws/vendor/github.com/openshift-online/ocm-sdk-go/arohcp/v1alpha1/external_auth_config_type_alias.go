...
const ExternalAuthConfigListKind = api_v1alpha1.ExternalAuthConfigListKind
...
const ExternalAuthConfigListLinkKind = api_v1alpha1.ExternalAuthConfigListLinkKind

// ExternalAuthConfigNilKind is the name of the type used to nil lists of objects of
// type 'external_auth_config'.
const ExternalAuthConfigListNilKind = api_v1alpha1.ExternalAuthConfigListNilKind

type ExternalAuthConfigList = api_v1alpha1.ExternalAuthConfigList
