...
type NodesInfo = api_v1alpha1.NodesInfo

// NodesInfoListKind is the name of the type used to represent list of objects of
// type 'nodes_info'.
const NodesInfoListKind = api_v1alpha1.NodesInfoListKind

// NodesInfoListLinkKind is the name of the type used to represent links to list
// of objects of type 'nodes_info'.
const NodesInfoListLinkKind = api_v1alpha1.NodesInfoListLinkKind

// NodesInfoNilKind is the name of the type used to nil lists of objects of
// type 'nodes_info'.
const NodesInfoListNilKind = api_v1alpha1.NodesInfoListNilKind

type NodesInfoList = api_v1alpha1.NodesInfoList
