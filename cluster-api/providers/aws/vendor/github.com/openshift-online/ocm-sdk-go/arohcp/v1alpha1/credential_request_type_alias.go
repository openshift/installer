...
type CredentialRequest = api_v1alpha1.CredentialRequest

// CredentialRequestListKind is the name of the type used to represent list of objects of
// type 'credential_request'.
const CredentialRequestListKind = api_v1alpha1.CredentialRequestListKind
...
const CredentialRequestListLinkKind = api_v1alpha1.CredentialRequestListLinkKind

// CredentialRequestNilKind is the name of the type used to nil lists of objects of
// type 'credential_request'.
const CredentialRequestListNilKind = api_v1alpha1.CredentialRequestListNilKind

type CredentialRequestList = api_v1alpha1.CredentialRequestList
