...
type ClusterOperatorsInfo = api_v1alpha1.ClusterOperatorsInfo

// ClusterOperatorsInfoListKind is the name of the type used to represent list of objects of
// type 'cluster_operators_info'.
const ClusterOperatorsInfoListKind = api_v1alpha1.ClusterOperatorsInfoListKind
...
const ClusterOperatorsInfoListLinkKind = api_v1alpha1.ClusterOperatorsInfoListLinkKind

// ClusterOperatorsInfoNilKind is the name of the type used to nil lists of objects of
// type 'cluster_operators_info'.
const ClusterOperatorsInfoListNilKind = api_v1alpha1.ClusterOperatorsInfoListNilKind

type ClusterOperatorsInfoList = api_v1alpha1.ClusterOperatorsInfoList
