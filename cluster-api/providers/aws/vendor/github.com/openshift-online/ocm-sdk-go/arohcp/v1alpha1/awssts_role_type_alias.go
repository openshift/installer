...
type AWSSTSRole = api_v1alpha1.AWSSTSRole

// AWSSTSRoleListKind is the name of the type used to represent list of objects of
// type 'AWSSTS_role'.
const AWSSTSRoleListKind = api_v1alpha1.AWSSTSRoleListKind

// AWSSTSRoleListLinkKind is the name of the type used to represent links to list
// of objects of type 'AWSSTS_role'.
const AWSSTSRoleListLinkKind = api_v1alpha1.AWSSTSRoleListLinkKind

// AWSSTSRoleNilKind is the name of the type used to nil lists of objects of
// type 'AWSSTS_role'.
const AWSSTSRoleListNilKind = api_v1alpha1.AWSSTSRoleListNilKind

type AWSSTSRoleList = api_v1alpha1.AWSSTSRoleList
