...
type ExternalAuthConfigState = api_v1alpha1.ExternalAuthConfigState

const (
	// Indicates that the cluster does not support configuration of external authentication providers
	ExternalAuthConfigStateDisabled ExternalAuthConfigState = api_v1alpha1.ExternalAuthConfigStateDisabled
	// Indicates that the cluster supports configuration of external authentication providers
	ExternalAuthConfigStateEnabled ExternalAuthConfigState = api_v1alpha1.ExternalAuthConfigStateEnabled
)
