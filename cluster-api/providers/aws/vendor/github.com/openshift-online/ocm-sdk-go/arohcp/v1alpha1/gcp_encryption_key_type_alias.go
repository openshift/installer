...
type GCPEncryptionKey = api_v1alpha1.GCPEncryptionKey

// GCPEncryptionKeyListKind is the name of the type used to represent list of objects of
// type 'GCP_encryption_key'.
const GCPEncryptionKeyListKind = api_v1alpha1.GCPEncryptionKeyListKind
...
const GCPEncryptionKeyListLinkKind = api_v1alpha1.GCPEncryptionKeyListLinkKind

// GCPEncryptionKeyNilKind is the name of the type used to nil lists of objects of
// type 'GCP_encryption_key'.
const GCPEncryptionKeyListNilKind = api_v1alpha1.GCPEncryptionKeyListNilKind

type GCPEncryptionKeyList = api_v1alpha1.GCPEncryptionKeyList
