...
type ClusterAutoNodeStatus = api_v1alpha1.ClusterAutoNodeStatus

// ClusterAutoNodeStatusListKind is the name of the type used to represent list of objects of
// type 'cluster_auto_node_status'.
const ClusterAutoNodeStatusListKind = api_v1alpha1.ClusterAutoNodeStatusListKind
...
const ClusterAutoNodeStatusListLinkKind = api_v1alpha1.ClusterAutoNodeStatusListLinkKind

// ClusterAutoNodeStatusNilKind is the name of the type used to nil lists of objects of
// type 'cluster_auto_node_status'.
const ClusterAutoNodeStatusListNilKind = api_v1alpha1.ClusterAutoNodeStatusListNilKind

type ClusterAutoNodeStatusList = api_v1alpha1.ClusterAutoNodeStatusList
