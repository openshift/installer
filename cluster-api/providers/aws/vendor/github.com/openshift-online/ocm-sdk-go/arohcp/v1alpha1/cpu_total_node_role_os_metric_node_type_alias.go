...
type CPUTotalNodeRoleOSMetricNode = api_v1alpha1.CPUTotalNodeRoleOSMetricNode
...
const CPUTotalNodeRoleOSMetricNodeListKind = api_v1alpha1.CPUTotalNodeRoleOSMetricNodeListKind
...
const CPUTotalNodeRoleOSMetricNodeListLinkKind = api_v1alpha1.CPUTotalNodeRoleOSMetricNodeListLinkKind

// CPUTotalNodeRoleOSMetricNodeNilKind is the name of the type used to nil lists of objects of
// type 'CPU_total_node_role_OS_metric_node'.
const CPUTotalNodeRoleOSMetricNodeListNilKind = api_v1alpha1.CPUTotalNodeRoleOSMetricNodeListNilKind

type CPUTotalNodeRoleOSMetricNodeList = api_v1alpha1.CPUTotalNodeRoleOSMetricNodeList
