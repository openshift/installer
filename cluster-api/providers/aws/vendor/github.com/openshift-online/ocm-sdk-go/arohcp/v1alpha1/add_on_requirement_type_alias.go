...
type AddOnRequirement = api_v1alpha1.AddOnRequirement

// AddOnRequirementListKind is the name of the type used to represent list of objects of
// type 'add_on_requirement'.
const AddOnRequirementListKind = api_v1alpha1.AddOnRequirementListKind
...
const AddOnRequirementListLinkKind = api_v1alpha1.AddOnRequirementListLinkKind

// AddOnRequirementNilKind is the name of the type used to nil lists of objects of
// type 'add_on_requirement'.
const AddOnRequirementListNilKind = api_v1alpha1.AddOnRequirementListNilKind

type AddOnRequirementList = api_v1alpha1.AddOnRequirementList
