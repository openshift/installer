...
// the given writer.
var MarshalLabelList = api_v1alpha1.MarshalLabelList

// WriteLabelList writes a list of value of the 'label' type to
// the given stream.
var WriteLabelList = api_v1alpha1.WriteLabelList

// UnmarshalLabelList reads a list of values of the 'label' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalLabelList = api_v1alpha1.UnmarshalLabelList

// ReadLabelList reads list of values of the ”label' type from
// the given iterator.
var ReadLabelList = api_v1alpha1.ReadLabelList
