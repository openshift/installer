...
type LDAPIdentityProviderListBuilder = api_v1alpha1.LDAPIdentityProviderListBuilder

// NewLDAPIdentityProviderList creates a new builder of 'LDAP_identity_provider' objects.
var NewLDAPIdentityProviderList = api_v1alpha1.NewLDAPIdentityProviderList
