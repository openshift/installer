...
type STSOperator = api_v1alpha1.STSOperator

// STSOperatorListKind is the name of the type used to represent list of objects of
// type 'STS_operator'.
const STSOperatorListKind = api_v1alpha1.STSOperatorListKind

// STSOperatorListLinkKind is the name of the type used to represent links to list
// of objects of type 'STS_operator'.
const STSOperatorListLinkKind = api_v1alpha1.STSOperatorListLinkKind

// STSOperatorNilKind is the name of the type used to nil lists of objects of
// type 'STS_operator'.
const STSOperatorListNilKind = api_v1alpha1.STSOperatorListNilKind

type STSOperatorList = api_v1alpha1.STSOperatorList
