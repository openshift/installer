...
const ProductTechnologyPreviewKind = api_v1alpha1.ProductTechnologyPreviewKind
...
const ProductTechnologyPreviewLinkKind = api_v1alpha1.ProductTechnologyPreviewLinkKind

// ProductTechnologyPreviewNilKind is the name of the type used to nil references
// to objects of type 'product_technology_preview'.
const ProductTechnologyPreviewNilKind = api_v1alpha1.ProductTechnologyPreviewNilKind
...
type ProductTechnologyPreview = api_v1alpha1.ProductTechnologyPreview
...
const ProductTechnologyPreviewListKind = api_v1alpha1.ProductTechnologyPreviewListKind
...
const ProductTechnologyPreviewListLinkKind = api_v1alpha1.ProductTechnologyPreviewListLinkKind

// ProductTechnologyPreviewNilKind is the name of the type used to nil lists of objects of
// type 'product_technology_preview'.
const ProductTechnologyPreviewListNilKind = api_v1alpha1.ProductTechnologyPreviewListNilKind

type ProductTechnologyPreviewList = api_v1alpha1.ProductTechnologyPreviewList
