...
// the given writer.
var MarshalAzureEtcdEncryptionList = api_v1alpha1.MarshalAzureEtcdEncryptionList

// WriteAzureEtcdEncryptionList writes a list of value of the 'azure_etcd_encryption' type to
// the given stream.
var WriteAzureEtcdEncryptionList = api_v1alpha1.WriteAzureEtcdEncryptionList

// UnmarshalAzureEtcdEncryptionList reads a list of values of the 'azure_etcd_encryption' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureEtcdEncryptionList = api_v1alpha1.UnmarshalAzureEtcdEncryptionList

// ReadAzureEtcdEncryptionList reads list of values of the ”azure_etcd_encryption' type from
// the given iterator.
var ReadAzureEtcdEncryptionList = api_v1alpha1.ReadAzureEtcdEncryptionList
