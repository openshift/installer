...
const NodePoolManagementUpgradeKind = api_v1alpha1.NodePoolManagementUpgradeKind
...
const NodePoolManagementUpgradeLinkKind = api_v1alpha1.NodePoolManagementUpgradeLinkKind

// NodePoolManagementUpgradeNilKind is the name of the type used to nil references
// to objects of type 'node_pool_management_upgrade'.
const NodePoolManagementUpgradeNilKind = api_v1alpha1.NodePoolManagementUpgradeNilKind
...
type NodePoolManagementUpgrade = api_v1alpha1.NodePoolManagementUpgrade
...
const NodePoolManagementUpgradeListKind = api_v1alpha1.NodePoolManagementUpgradeListKind
...
const NodePoolManagementUpgradeListLinkKind = api_v1alpha1.NodePoolManagementUpgradeListLinkKind

// NodePoolManagementUpgradeNilKind is the name of the type used to nil lists of objects of
// type 'node_pool_management_upgrade'.
const NodePoolManagementUpgradeListNilKind = api_v1alpha1.NodePoolManagementUpgradeListNilKind

type NodePoolManagementUpgradeList = api_v1alpha1.NodePoolManagementUpgradeList
