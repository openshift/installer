...
// must be unique across shards.
type ProvisionShardMaestroConfig = api_v1alpha1.ProvisionShardMaestroConfig
...
const ProvisionShardMaestroConfigListKind = api_v1alpha1.ProvisionShardMaestroConfigListKind
...
const ProvisionShardMaestroConfigListLinkKind = api_v1alpha1.ProvisionShardMaestroConfigListLinkKind

// ProvisionShardMaestroConfigNilKind is the name of the type used to nil lists of objects of
// type 'provision_shard_maestro_config'.
const ProvisionShardMaestroConfigListNilKind = api_v1alpha1.ProvisionShardMaestroConfigListNilKind

type ProvisionShardMaestroConfigList = api_v1alpha1.ProvisionShardMaestroConfigList
