...
type CIDRBlockAllowAccess = api_v1alpha1.CIDRBlockAllowAccess

// CIDRBlockAllowAccessListKind is the name of the type used to represent list of objects of
// type 'CIDR_block_allow_access'.
const CIDRBlockAllowAccessListKind = api_v1alpha1.CIDRBlockAllowAccessListKind
...
const CIDRBlockAllowAccessListLinkKind = api_v1alpha1.CIDRBlockAllowAccessListLinkKind

// CIDRBlockAllowAccessNilKind is the name of the type used to nil lists of objects of
// type 'CIDR_block_allow_access'.
const CIDRBlockAllowAccessListNilKind = api_v1alpha1.CIDRBlockAllowAccessListNilKind

type CIDRBlockAllowAccessList = api_v1alpha1.CIDRBlockAllowAccessList
