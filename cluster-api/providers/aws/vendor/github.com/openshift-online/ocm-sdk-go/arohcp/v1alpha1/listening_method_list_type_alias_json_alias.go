...
// the given writer.
var MarshalListeningMethodList = api_v1alpha1.MarshalListeningMethodList

// WriteListeningMethodList writes a list of value of the 'listening_method' type to
// the given stream.
var WriteListeningMethodList = api_v1alpha1.WriteListeningMethodList

// UnmarshalListeningMethodList reads a list of values of the 'listening_method' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalListeningMethodList = api_v1alpha1.UnmarshalListeningMethodList

// ReadListeningMethodList reads list of values of the ”listening_method' type from
// the given iterator.
var ReadListeningMethodList = api_v1alpha1.ReadListeningMethodList
