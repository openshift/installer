...
// the given writer.
var MarshalClusterResourcesList = api_v1alpha1.MarshalClusterResourcesList

// WriteClusterResourcesList writes a list of value of the 'cluster_resources' type to
// the given stream.
var WriteClusterResourcesList = api_v1alpha1.WriteClusterResourcesList

// UnmarshalClusterResourcesList reads a list of values of the 'cluster_resources' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalClusterResourcesList = api_v1alpha1.UnmarshalClusterResourcesList

// ReadClusterResourcesList reads list of values of the ”cluster_resources' type from
// the given iterator.
var ReadClusterResourcesList = api_v1alpha1.ReadClusterResourcesList
