...
type ReleaseImages = api_v1alpha1.ReleaseImages

// ReleaseImagesListKind is the name of the type used to represent list of objects of
// type 'release_images'.
const ReleaseImagesListKind = api_v1alpha1.ReleaseImagesListKind

// ReleaseImagesListLinkKind is the name of the type used to represent links to list
// of objects of type 'release_images'.
const ReleaseImagesListLinkKind = api_v1alpha1.ReleaseImagesListLinkKind

// ReleaseImagesNilKind is the name of the type used to nil lists of objects of
// type 'release_images'.
const ReleaseImagesListNilKind = api_v1alpha1.ReleaseImagesListNilKind

type ReleaseImagesList = api_v1alpha1.ReleaseImagesList
