...
// the given writer.
var MarshalAlertInfoList = api_v1alpha1.MarshalAlertInfoList

// WriteAlertInfoList writes a list of value of the 'alert_info' type to
// the given stream.
var WriteAlertInfoList = api_v1alpha1.WriteAlertInfoList

// UnmarshalAlertInfoList reads a list of values of the 'alert_info' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAlertInfoList = api_v1alpha1.UnmarshalAlertInfoList

// ReadAlertInfoList reads list of values of the ”alert_info' type from
// the given iterator.
var ReadAlertInfoList = api_v1alpha1.ReadAlertInfoList
