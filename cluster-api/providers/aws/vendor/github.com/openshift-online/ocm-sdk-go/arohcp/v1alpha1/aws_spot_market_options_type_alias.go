...
const AWSSpotMarketOptionsListLinkKind = api_v1alpha1.AWSSpotMarketOptionsListLinkKind

// AWSSpotMarketOptionsNilKind is the name of the type used to nil lists of objects of
// type 'AWS_spot_market_options'.
const AWSSpotMarketOptionsListNilKind = api_v1alpha1.AWSSpotMarketOptionsListNilKind

type AWSSpotMarketOptionsList = api_v1alpha1.AWSSpotMarketOptionsList
