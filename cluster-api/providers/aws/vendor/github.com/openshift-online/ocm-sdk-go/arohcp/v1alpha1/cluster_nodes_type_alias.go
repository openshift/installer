...
type ClusterNodes = api_v1alpha1.ClusterNodes

// ClusterNodesListKind is the name of the type used to represent list of objects of
// type 'cluster_nodes'.
const ClusterNodesListKind = api_v1alpha1.ClusterNodesListKind

// ClusterNodesListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_nodes'.
const ClusterNodesListLinkKind = api_v1alpha1.ClusterNodesListLinkKind

// ClusterNodesNilKind is the name of the type used to nil lists of objects of
// type 'cluster_nodes'.
const ClusterNodesListNilKind = api_v1alpha1.ClusterNodesListNilKind

type ClusterNodesList = api_v1alpha1.ClusterNodesList
