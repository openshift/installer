...
type HypershiftConfig = api_v1alpha1.HypershiftConfig

// HypershiftConfigListKind is the name of the type used to represent list of objects of
// type 'hypershift_config'.
const HypershiftConfigListKind = api_v1alpha1.HypershiftConfigListKind

// HypershiftConfigListLinkKind is the name of the type used to represent links to list
// of objects of type 'hypershift_config'.
const HypershiftConfigListLinkKind = api_v1alpha1.HypershiftConfigListLinkKind

// HypershiftConfigNilKind is the name of the type used to nil lists of objects of
// type 'hypershift_config'.
const HypershiftConfigListNilKind = api_v1alpha1.HypershiftConfigListNilKind

type HypershiftConfigList = api_v1alpha1.HypershiftConfigList
