...
// the given writer.
var MarshalExternalAuthClientConfigList = api_v1alpha1.MarshalExternalAuthClientConfigList

// WriteExternalAuthClientConfigList writes a list of value of the 'external_auth_client_config' type to
// the given stream.
var WriteExternalAuthClientConfigList = api_v1alpha1.WriteExternalAuthClientConfigList

// UnmarshalExternalAuthClientConfigList reads a list of values of the 'external_auth_client_config' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalExternalAuthClientConfigList = api_v1alpha1.UnmarshalExternalAuthClientConfigList

// ReadExternalAuthClientConfigList reads list of values of the ”external_auth_client_config' type from
// the given iterator.
var ReadExternalAuthClientConfigList = api_v1alpha1.ReadExternalAuthClientConfigList
