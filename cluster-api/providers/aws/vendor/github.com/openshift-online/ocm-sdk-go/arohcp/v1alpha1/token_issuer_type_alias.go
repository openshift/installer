...
type TokenIssuer = api_v1alpha1.TokenIssuer

// TokenIssuerListKind is the name of the type used to represent list of objects of
// type 'token_issuer'.
const TokenIssuerListKind = api_v1alpha1.TokenIssuerListKind

// TokenIssuerListLinkKind is the name of the type used to represent links to list
// of objects of type 'token_issuer'.
const TokenIssuerListLinkKind = api_v1alpha1.TokenIssuerListLinkKind

// TokenIssuerNilKind is the name of the type used to nil lists of objects of
// type 'token_issuer'.
const TokenIssuerListNilKind = api_v1alpha1.TokenIssuerListNilKind

type TokenIssuerList = api_v1alpha1.TokenIssuerList
