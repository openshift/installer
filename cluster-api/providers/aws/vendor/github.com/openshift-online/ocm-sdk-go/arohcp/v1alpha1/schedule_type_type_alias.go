...
type ScheduleType = api_v1alpha1.ScheduleType
...
const (
	...
	ScheduleTypeAutomatic ScheduleType = api_v1alpha1.ScheduleTypeAutomatic
	// Manual schedule type is for upgrades scheduled manually by a user, to a specific version, at a specific time.
	ScheduleTypeManual ScheduleType = api_v1alpha1.ScheduleTypeManual
)
