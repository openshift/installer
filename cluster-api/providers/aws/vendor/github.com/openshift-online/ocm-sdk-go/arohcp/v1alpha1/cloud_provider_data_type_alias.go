...
type CloudProviderData = api_v1alpha1.CloudProviderData

// CloudProviderDataListKind is the name of the type used to represent list of objects of
// type 'cloud_provider_data'.
const CloudProviderDataListKind = api_v1alpha1.CloudProviderDataListKind
...
const CloudProviderDataListLinkKind = api_v1alpha1.CloudProviderDataListLinkKind

// CloudProviderDataNilKind is the name of the type used to nil lists of objects of
// type 'cloud_provider_data'.
const CloudProviderDataListNilKind = api_v1alpha1.CloudProviderDataListNilKind

type CloudProviderDataList = api_v1alpha1.CloudProviderDataList
