...
type OidcConfig = api_v1alpha1.OidcConfig

// OidcConfigListKind is the name of the type used to represent list of objects of
// type 'oidc_config'.
const OidcConfigListKind = api_v1alpha1.OidcConfigListKind

// OidcConfigListLinkKind is the name of the type used to represent links to list
// of objects of type 'oidc_config'.
const OidcConfigListLinkKind = api_v1alpha1.OidcConfigListLinkKind

// OidcConfigNilKind is the name of the type used to nil lists of objects of
// type 'oidc_config'.
const OidcConfigListNilKind = api_v1alpha1.OidcConfigListNilKind

type OidcConfigList = api_v1alpha1.OidcConfigList
