...
type WifSupport = api_v1alpha1.WifSupport

// WifSupportListKind is the name of the type used to represent list of objects of
// type 'wif_support'.
const WifSupportListKind = api_v1alpha1.WifSupportListKind

// WifSupportListLinkKind is the name of the type used to represent links to list
// of objects of type 'wif_support'.
const WifSupportListLinkKind = api_v1alpha1.WifSupportListLinkKind

// WifSupportNilKind is the name of the type used to nil lists of objects of
// type 'wif_support'.
const WifSupportListNilKind = api_v1alpha1.WifSupportListNilKind

type WifSupportList = api_v1alpha1.WifSupportList
