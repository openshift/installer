...
type GcpAuthentication = api_v1alpha1.GcpAuthentication

// GcpAuthenticationListKind is the name of the type used to represent list of objects of
// type 'gcp_authentication'.
const GcpAuthenticationListKind = api_v1alpha1.GcpAuthenticationListKind
...
const GcpAuthenticationListLinkKind = api_v1alpha1.GcpAuthenticationListLinkKind

// GcpAuthenticationNilKind is the name of the type used to nil lists of objects of
// type 'gcp_authentication'.
const GcpAuthenticationListNilKind = api_v1alpha1.GcpAuthenticationListNilKind

type GcpAuthenticationList = api_v1alpha1.GcpAuthenticationList
