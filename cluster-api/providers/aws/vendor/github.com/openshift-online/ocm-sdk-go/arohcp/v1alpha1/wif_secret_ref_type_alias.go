...
type WifSecretRef = api_v1alpha1.WifSecretRef

// WifSecretRefListKind is the name of the type used to represent list of objects of
// type 'wif_secret_ref'.
const WifSecretRefListKind = api_v1alpha1.WifSecretRefListKind

// WifSecretRefListLinkKind is the name of the type used to represent links to list
// of objects of type 'wif_secret_ref'.
const WifSecretRefListLinkKind = api_v1alpha1.WifSecretRefListLinkKind

// WifSecretRefNilKind is the name of the type used to nil lists of objects of
// type 'wif_secret_ref'.
const WifSecretRefListNilKind = api_v1alpha1.WifSecretRefListNilKind

type WifSecretRefList = api_v1alpha1.WifSecretRefList
