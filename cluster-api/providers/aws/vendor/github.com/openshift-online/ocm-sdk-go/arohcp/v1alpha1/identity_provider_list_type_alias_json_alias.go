...
// the given writer.
var MarshalIdentityProviderList = api_v1alpha1.MarshalIdentityProviderList

// WriteIdentityProviderList writes a list of value of the 'identity_provider' type to
// the given stream.
var WriteIdentityProviderList = api_v1alpha1.WriteIdentityProviderList

// UnmarshalIdentityProviderList reads a list of values of the 'identity_provider' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalIdentityProviderList = api_v1alpha1.UnmarshalIdentityProviderList

// ReadIdentityProviderList reads list of values of the ”identity_provider' type from
// the given iterator.
var ReadIdentityProviderList = api_v1alpha1.ReadIdentityProviderList
