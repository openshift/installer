...
type ManagedService = api_v1alpha1.ManagedService

// ManagedServiceListKind is the name of the type used to represent list of objects of
// type 'managed_service'.
const ManagedServiceListKind = api_v1alpha1.ManagedServiceListKind

// ManagedServiceListLinkKind is the name of the type used to represent links to list
// of objects of type 'managed_service'.
const ManagedServiceListLinkKind = api_v1alpha1.ManagedServiceListLinkKind

// ManagedServiceNilKind is the name of the type used to nil lists of objects of
// type 'managed_service'.
const ManagedServiceListNilKind = api_v1alpha1.ManagedServiceListNilKind

type ManagedServiceList = api_v1alpha1.ManagedServiceList
