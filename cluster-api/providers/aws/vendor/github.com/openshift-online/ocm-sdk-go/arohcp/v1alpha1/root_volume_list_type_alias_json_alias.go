...
// the given writer.
var MarshalRootVolumeList = api_v1alpha1.MarshalRootVolumeList

// WriteRootVolumeList writes a list of value of the 'root_volume' type to
// the given stream.
var WriteRootVolumeList = api_v1alpha1.WriteRootVolumeList

// UnmarshalRootVolumeList reads a list of values of the 'root_volume' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalRootVolumeList = api_v1alpha1.UnmarshalRootVolumeList

// ReadRootVolumeList reads list of values of the ”root_volume' type from
// the given iterator.
var ReadRootVolumeList = api_v1alpha1.ReadRootVolumeList
