...
// the given writer.
var MarshalAWSInfrastructureAccessRoleGrantList = api_v1alpha1.MarshalAWSInfrastructureAccessRoleGrantList

// WriteAWSInfrastructureAccessRoleGrantList writes a list of value of the 'AWS_infrastructure_access_role_grant' type to
// the given stream.
var WriteAWSInfrastructureAccessRoleGrantList = api_v1alpha1.WriteAWSInfrastructureAccessRoleGrantList
...
var UnmarshalAWSInfrastructureAccessRoleGrantList = api_v1alpha1.UnmarshalAWSInfrastructureAccessRoleGrantList

// ReadAWSInfrastructureAccessRoleGrantList reads list of values of the ”AWS_infrastructure_access_role_grant' type from
// the given iterator.
var ReadAWSInfrastructureAccessRoleGrantList = api_v1alpha1.ReadAWSInfrastructureAccessRoleGrantList
