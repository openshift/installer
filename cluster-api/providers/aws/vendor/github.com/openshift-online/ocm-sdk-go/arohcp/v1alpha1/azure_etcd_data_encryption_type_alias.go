...
type AzureEtcdDataEncryption = api_v1alpha1.AzureEtcdDataEncryption
...
const AzureEtcdDataEncryptionListKind = api_v1alpha1.AzureEtcdDataEncryptionListKind
...
const AzureEtcdDataEncryptionListLinkKind = api_v1alpha1.AzureEtcdDataEncryptionListLinkKind

// AzureEtcdDataEncryptionNilKind is the name of the type used to nil lists of objects of
// type 'azure_etcd_data_encryption'.
const AzureEtcdDataEncryptionListNilKind = api_v1alpha1.AzureEtcdDataEncryptionListNilKind

type AzureEtcdDataEncryptionList = api_v1alpha1.AzureEtcdDataEncryptionList
