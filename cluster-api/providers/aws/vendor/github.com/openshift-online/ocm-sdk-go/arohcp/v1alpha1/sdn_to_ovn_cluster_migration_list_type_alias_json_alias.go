...
// the given writer.
var MarshalSdnToOvnClusterMigrationList = api_v1alpha1.MarshalSdnToOvnClusterMigrationList

// WriteSdnToOvnClusterMigrationList writes a list of value of the 'sdn_to_ovn_cluster_migration' type to
// the given stream.
var WriteSdnToOvnClusterMigrationList = api_v1alpha1.WriteSdnToOvnClusterMigrationList

// UnmarshalSdnToOvnClusterMigrationList reads a list of values of the 'sdn_to_ovn_cluster_migration' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalSdnToOvnClusterMigrationList = api_v1alpha1.UnmarshalSdnToOvnClusterMigrationList

// ReadSdnToOvnClusterMigrationList reads list of values of the ”sdn_to_ovn_cluster_migration' type from
// the given iterator.
var ReadSdnToOvnClusterMigrationList = api_v1alpha1.ReadSdnToOvnClusterMigrationList
