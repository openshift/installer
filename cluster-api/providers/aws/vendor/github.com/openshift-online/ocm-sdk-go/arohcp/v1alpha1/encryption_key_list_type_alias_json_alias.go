...
// the given writer.
var MarshalEncryptionKeyList = api_v1alpha1.MarshalEncryptionKeyList

// WriteEncryptionKeyList writes a list of value of the 'encryption_key' type to
// the given stream.
var WriteEncryptionKeyList = api_v1alpha1.WriteEncryptionKeyList

// UnmarshalEncryptionKeyList reads a list of values of the 'encryption_key' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalEncryptionKeyList = api_v1alpha1.UnmarshalEncryptionKeyList

// ReadEncryptionKeyList reads list of values of the ”encryption_key' type from
// the given iterator.
var ReadEncryptionKeyList = api_v1alpha1.ReadEncryptionKeyList
