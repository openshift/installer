...
type ClusterLink = api_v1alpha1.ClusterLink

// ClusterLinkListKind is the name of the type used to represent list of objects of
// type 'cluster_link'.
const ClusterLinkListKind = api_v1alpha1.ClusterLinkListKind

// ClusterLinkListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_link'.
const ClusterLinkListLinkKind = api_v1alpha1.ClusterLinkListLinkKind

// ClusterLinkNilKind is the name of the type used to nil lists of objects of
// type 'cluster_link'.
const ClusterLinkListNilKind = api_v1alpha1.ClusterLinkListNilKind

type ClusterLinkList = api_v1alpha1.ClusterLinkList
