...
// the given writer.
var MarshalOpenIDIdentityProviderList = api_v1alpha1.MarshalOpenIDIdentityProviderList

// WriteOpenIDIdentityProviderList writes a list of value of the 'open_ID_identity_provider' type to
// the given stream.
var WriteOpenIDIdentityProviderList = api_v1alpha1.WriteOpenIDIdentityProviderList

// UnmarshalOpenIDIdentityProviderList reads a list of values of the 'open_ID_identity_provider' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalOpenIDIdentityProviderList = api_v1alpha1.UnmarshalOpenIDIdentityProviderList

// ReadOpenIDIdentityProviderList reads list of values of the ”open_ID_identity_provider' type from
// the given iterator.
var ReadOpenIDIdentityProviderList = api_v1alpha1.ReadOpenIDIdentityProviderList
