...
type ResourceRange = api_v1alpha1.ResourceRange

// ResourceRangeListKind is the name of the type used to represent list of objects of
// type 'resource_range'.
const ResourceRangeListKind = api_v1alpha1.ResourceRangeListKind

// ResourceRangeListLinkKind is the name of the type used to represent links to list
// of objects of type 'resource_range'.
const ResourceRangeListLinkKind = api_v1alpha1.ResourceRangeListLinkKind

// ResourceRangeNilKind is the name of the type used to nil lists of objects of
// type 'resource_range'.
const ResourceRangeListNilKind = api_v1alpha1.ResourceRangeListNilKind

type ResourceRangeList = api_v1alpha1.ResourceRangeList
