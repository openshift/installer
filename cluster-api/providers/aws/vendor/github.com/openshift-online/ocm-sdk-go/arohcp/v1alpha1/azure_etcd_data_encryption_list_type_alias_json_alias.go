...
// the given writer.
var MarshalAzureEtcdDataEncryptionList = api_v1alpha1.MarshalAzureEtcdDataEncryptionList

// WriteAzureEtcdDataEncryptionList writes a list of value of the 'azure_etcd_data_encryption' type to
// the given stream.
var WriteAzureEtcdDataEncryptionList = api_v1alpha1.WriteAzureEtcdDataEncryptionList

// UnmarshalAzureEtcdDataEncryptionList reads a list of values of the 'azure_etcd_data_encryption' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureEtcdDataEncryptionList = api_v1alpha1.UnmarshalAzureEtcdDataEncryptionList

// ReadAzureEtcdDataEncryptionList reads list of values of the ”azure_etcd_data_encryption' type from
// the given iterator.
var ReadAzureEtcdDataEncryptionList = api_v1alpha1.ReadAzureEtcdDataEncryptionList
