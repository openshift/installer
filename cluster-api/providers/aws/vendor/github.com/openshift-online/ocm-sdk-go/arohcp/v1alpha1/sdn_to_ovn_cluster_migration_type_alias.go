...
type SdnToOvnClusterMigration = api_v1alpha1.SdnToOvnClusterMigration
...
const SdnToOvnClusterMigrationListKind = api_v1alpha1.SdnToOvnClusterMigrationListKind
...
const SdnToOvnClusterMigrationListLinkKind = api_v1alpha1.SdnToOvnClusterMigrationListLinkKind

// SdnToOvnClusterMigrationNilKind is the name of the type used to nil lists of objects of
// type 'sdn_to_ovn_cluster_migration'.
const SdnToOvnClusterMigrationListNilKind = api_v1alpha1.SdnToOvnClusterMigrationListNilKind

type SdnToOvnClusterMigrationList = api_v1alpha1.SdnToOvnClusterMigrationList
