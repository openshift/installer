...
type GCPMachinePool = api_v1alpha1.GCPMachinePool

// GCPMachinePoolListKind is the name of the type used to represent list of objects of
// type 'GCP_machine_pool'.
const GCPMachinePoolListKind = api_v1alpha1.GCPMachinePoolListKind

// GCPMachinePoolListLinkKind is the name of the type used to represent links to list
// of objects of type 'GCP_machine_pool'.
const GCPMachinePoolListLinkKind = api_v1alpha1.GCPMachinePoolListLinkKind

// GCPMachinePoolNilKind is the name of the type used to nil lists of objects of
// type 'GCP_machine_pool'.
const GCPMachinePoolListNilKind = api_v1alpha1.GCPMachinePoolListNilKind

type GCPMachinePoolList = api_v1alpha1.GCPMachinePoolList
