...
const BreakGlassCredentialListLinkKind = api_v1alpha1.BreakGlassCredentialListLinkKind

// BreakGlassCredentialNilKind is the name of the type used to nil lists of objects of
// type 'break_glass_credential'.
const BreakGlassCredentialListNilKind = api_v1alpha1.BreakGlassCredentialListNilKind

type BreakGlassCredentialList = api_v1alpha1.BreakGlassCredentialList
