...
type ClusterState = api_v1alpha1.ClusterState

const (
	// Error during installation.
	ClusterStateError ClusterState = api_v1alpha1.ClusterStateError
	// The cluster will consume marginal cloud provider infrastructure but will be counted for quota.
	ClusterStateHibernating ClusterState = api_v1alpha1.ClusterStateHibernating
	// The cluster is still being installed.
	ClusterStateInstalling ClusterState = api_v1alpha1.ClusterStateInstalling
	// The cluster is pending resources before being provisioned.
	ClusterStatePending ClusterState = api_v1alpha1.ClusterStatePending
	// The cluster is moving from 'Ready' state to 'Hibernating'.
	ClusterStatePoweringDown ClusterState = api_v1alpha1.ClusterStatePoweringDown
	// The cluster is ready to use.
	ClusterStateReady ClusterState = api_v1alpha1.ClusterStateReady
	// The cluster is moving from 'Hibernating' state to 'Ready'.
	ClusterStateResuming ClusterState = api_v1alpha1.ClusterStateResuming
	...
	ClusterStateWaiting ClusterState = api_v1alpha1.ClusterStateWaiting
)
