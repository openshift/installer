...
const UpgradePolicyKind = api_v1alpha1.UpgradePolicyKind

// UpgradePolicyLinkKind is the name of the type used to represent links
// to objects of type 'upgrade_policy'.
const UpgradePolicyLinkKind = api_v1alpha1.UpgradePolicyLinkKind

// UpgradePolicyNilKind is the name of the type used to nil references
// to objects of type 'upgrade_policy'.
const UpgradePolicyNilKind = api_v1alpha1.UpgradePolicyNilKind
...
type UpgradePolicy = api_v1alpha1.UpgradePolicy

// UpgradePolicyListKind is the name of the type used to represent list of objects of
// type 'upgrade_policy'.
const UpgradePolicyListKind = api_v1alpha1.UpgradePolicyListKind

// UpgradePolicyListLinkKind is the name of the type used to represent links to list
// of objects of type 'upgrade_policy'.
const UpgradePolicyListLinkKind = api_v1alpha1.UpgradePolicyListLinkKind

// UpgradePolicyNilKind is the name of the type used to nil lists of objects of
// type 'upgrade_policy'.
const UpgradePolicyListNilKind = api_v1alpha1.UpgradePolicyListNilKind

type UpgradePolicyList = api_v1alpha1.UpgradePolicyList
