...
// the given writer.
var MarshalBillingModelItemList = api_v1alpha1.MarshalBillingModelItemList

// WriteBillingModelItemList writes a list of value of the 'billing_model_item' type to
// the given stream.
var WriteBillingModelItemList = api_v1alpha1.WriteBillingModelItemList

// UnmarshalBillingModelItemList reads a list of values of the 'billing_model_item' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalBillingModelItemList = api_v1alpha1.UnmarshalBillingModelItemList

// ReadBillingModelItemList reads list of values of the ”billing_model_item' type from
// the given iterator.
var ReadBillingModelItemList = api_v1alpha1.ReadBillingModelItemList
