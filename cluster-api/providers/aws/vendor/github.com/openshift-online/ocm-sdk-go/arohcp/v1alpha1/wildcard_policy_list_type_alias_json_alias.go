...
// the given writer.
var MarshalWildcardPolicyList = api_v1alpha1.MarshalWildcardPolicyList

// WriteWildcardPolicyList writes a list of value of the 'wildcard_policy' type to
// the given stream.
var WriteWildcardPolicyList = api_v1alpha1.WriteWildcardPolicyList

// UnmarshalWildcardPolicyList reads a list of values of the 'wildcard_policy' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalWildcardPolicyList = api_v1alpha1.UnmarshalWildcardPolicyList

// ReadWildcardPolicyList reads list of values of the ”wildcard_policy' type from
// the given iterator.
var ReadWildcardPolicyList = api_v1alpha1.ReadWildcardPolicyList
