...
// the given writer.
var MarshalMachinePoolSecurityGroupFilterList = api_v1alpha1.MarshalMachinePoolSecurityGroupFilterList

// WriteMachinePoolSecurityGroupFilterList writes a list of value of the 'machine_pool_security_group_filter' type to
// the given stream.
var WriteMachinePoolSecurityGroupFilterList = api_v1alpha1.WriteMachinePoolSecurityGroupFilterList
...
var UnmarshalMachinePoolSecurityGroupFilterList = api_v1alpha1.UnmarshalMachinePoolSecurityGroupFilterList

// ReadMachinePoolSecurityGroupFilterList reads list of values of the ”machine_pool_security_group_filter' type from
// the given iterator.
var ReadMachinePoolSecurityGroupFilterList = api_v1alpha1.ReadMachinePoolSecurityGroupFilterList
