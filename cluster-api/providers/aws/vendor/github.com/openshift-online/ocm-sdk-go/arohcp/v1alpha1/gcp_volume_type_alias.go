...
type GCPVolume = api_v1alpha1.GCPVolume

// GCPVolumeListKind is the name of the type used to represent list of objects of
// type 'GCP_volume'.
const GCPVolumeListKind = api_v1alpha1.GCPVolumeListKind

// GCPVolumeListLinkKind is the name of the type used to represent links to list
// of objects of type 'GCP_volume'.
const GCPVolumeListLinkKind = api_v1alpha1.GCPVolumeListLinkKind

// GCPVolumeNilKind is the name of the type used to nil lists of objects of
// type 'GCP_volume'.
const GCPVolumeListNilKind = api_v1alpha1.GCPVolumeListNilKind

type GCPVolumeList = api_v1alpha1.GCPVolumeList
