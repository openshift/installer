...
type ObjectReference = api_v1.ObjectReference

// ObjectReferenceListKind is the name of the type used to represent list of objects of
// type 'object_reference'.
const ObjectReferenceListKind = api_v1.ObjectReferenceListKind

// ObjectReferenceListLinkKind is the name of the type used to represent links to list
// of objects of type 'object_reference'.
const ObjectReferenceListLinkKind = api_v1.ObjectReferenceListLinkKind

// ObjectReferenceNilKind is the name of the type used to nil lists of objects of
// type 'object_reference'.
const ObjectReferenceListNilKind = api_v1.ObjectReferenceListNilKind

type ObjectReferenceList = api_v1.ObjectReferenceList
