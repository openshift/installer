...
type MetricsFederation = api_v1.MetricsFederation

// MetricsFederationListKind is the name of the type used to represent list of objects of
// type 'metrics_federation'.
const MetricsFederationListKind = api_v1.MetricsFederationListKind
...
const MetricsFederationListLinkKind = api_v1.MetricsFederationListLinkKind

// MetricsFederationNilKind is the name of the type used to nil lists of objects of
// type 'metrics_federation'.
const MetricsFederationListNilKind = api_v1.MetricsFederationListNilKind

type MetricsFederationList = api_v1.MetricsFederationList
