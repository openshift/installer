...
// the given writer.
var MarshalAdditionalCatalogSourceList = api_v1.MarshalAdditionalCatalogSourceList

// WriteAdditionalCatalogSourceList writes a list of value of the 'additional_catalog_source' type to
// the given stream.
var WriteAdditionalCatalogSourceList = api_v1.WriteAdditionalCatalogSourceList

// UnmarshalAdditionalCatalogSourceList reads a list of values of the 'additional_catalog_source' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAdditionalCatalogSourceList = api_v1.UnmarshalAdditionalCatalogSourceList

// ReadAdditionalCatalogSourceList reads list of values of the ”additional_catalog_source' type from
// the given iterator.
var ReadAdditionalCatalogSourceList = api_v1.ReadAdditionalCatalogSourceList
