...
type ResourceReviewRequest = api_v1.ResourceReviewRequest

// ResourceReviewRequestListKind is the name of the type used to represent list of objects of
// type 'resource_review_request'.
const ResourceReviewRequestListKind = api_v1.ResourceReviewRequestListKind
...
const ResourceReviewRequestListLinkKind = api_v1.ResourceReviewRequestListLinkKind

// ResourceReviewRequestNilKind is the name of the type used to nil lists of objects of
// type 'resource_review_request'.
const ResourceReviewRequestListNilKind = api_v1.ResourceReviewRequestListNilKind

type ResourceReviewRequestList = api_v1.ResourceReviewRequestList
