...
type FeatureReviewRequest = api_v1.FeatureReviewRequest

// FeatureReviewRequestListKind is the name of the type used to represent list of objects of
// type 'feature_review_request'.
const FeatureReviewRequestListKind = api_v1.FeatureReviewRequestListKind
...
const FeatureReviewRequestListLinkKind = api_v1.FeatureReviewRequestListLinkKind

// FeatureReviewRequestNilKind is the name of the type used to nil lists of objects of
// type 'feature_review_request'.
const FeatureReviewRequestListNilKind = api_v1.FeatureReviewRequestListNilKind

type FeatureReviewRequestList = api_v1.FeatureReviewRequestList
