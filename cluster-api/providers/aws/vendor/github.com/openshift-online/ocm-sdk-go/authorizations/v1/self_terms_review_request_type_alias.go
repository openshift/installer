...
// review requests.
type SelfTermsReviewRequest = api_v1.SelfTermsReviewRequest
...
const SelfTermsReviewRequestListKind = api_v1.SelfTermsReviewRequestListKind
...
const SelfTermsReviewRequestListLinkKind = api_v1.SelfTermsReviewRequestListLinkKind

// SelfTermsReviewRequestNilKind is the name of the type used to nil lists of objects of
// type 'self_terms_review_request'.
const SelfTermsReviewRequestListNilKind = api_v1.SelfTermsReviewRequestListNilKind

type SelfTermsReviewRequestList = api_v1.SelfTermsReviewRequestList
