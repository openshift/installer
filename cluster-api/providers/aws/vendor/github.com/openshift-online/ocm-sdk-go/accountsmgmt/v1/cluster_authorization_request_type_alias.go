...
type ClusterAuthorizationRequest = api_v1.ClusterAuthorizationRequest
...
const ClusterAuthorizationRequestListKind = api_v1.ClusterAuthorizationRequestListKind
...
const ClusterAuthorizationRequestListLinkKind = api_v1.ClusterAuthorizationRequestListLinkKind

// ClusterAuthorizationRequestNilKind is the name of the type used to nil lists of objects of
// type 'cluster_authorization_request'.
const ClusterAuthorizationRequestListNilKind = api_v1.ClusterAuthorizationRequestListNilKind

type ClusterAuthorizationRequestList = api_v1.ClusterAuthorizationRequestList
