...
const SupportCaseResponseListLinkKind = api_v1.SupportCaseResponseListLinkKind

// SupportCaseResponseNilKind is the name of the type used to nil lists of objects of
// type 'support_case_response'.
const SupportCaseResponseListNilKind = api_v1.SupportCaseResponseListNilKind

type SupportCaseResponseList = api_v1.SupportCaseResponseList
