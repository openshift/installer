...
type QuotaAuthorizationResponse = api_v1.QuotaAuthorizationResponse
...
const QuotaAuthorizationResponseListKind = api_v1.QuotaAuthorizationResponseListKind
...
const QuotaAuthorizationResponseListLinkKind = api_v1.QuotaAuthorizationResponseListLinkKind

// QuotaAuthorizationResponseNilKind is the name of the type used to nil lists of objects of
// type 'quota_authorization_response'.
const QuotaAuthorizationResponseListNilKind = api_v1.QuotaAuthorizationResponseListNilKind

type QuotaAuthorizationResponseList = api_v1.QuotaAuthorizationResponseList
