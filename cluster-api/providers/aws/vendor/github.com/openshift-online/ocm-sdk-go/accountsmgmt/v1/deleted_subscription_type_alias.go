...
const DeletedSubscriptionListLinkKind = api_v1.DeletedSubscriptionListLinkKind

// DeletedSubscriptionNilKind is the name of the type used to nil lists of objects of
// type 'deleted_subscription'.
const DeletedSubscriptionListNilKind = api_v1.DeletedSubscriptionListNilKind

type DeletedSubscriptionList = api_v1.DeletedSubscriptionList
