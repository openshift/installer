...
type SubscriptionRegistration = api_v1.SubscriptionRegistration
...
const SubscriptionRegistrationListKind = api_v1.SubscriptionRegistrationListKind
...
const SubscriptionRegistrationListLinkKind = api_v1.SubscriptionRegistrationListLinkKind

// SubscriptionRegistrationNilKind is the name of the type used to nil lists of objects of
// type 'subscription_registration'.
const SubscriptionRegistrationListNilKind = api_v1.SubscriptionRegistrationListNilKind

type SubscriptionRegistrationList = api_v1.SubscriptionRegistrationList
