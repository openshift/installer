...
// the given writer.
var MarshalAccountGroupAssignmentList = api_v1.MarshalAccountGroupAssignmentList

// WriteAccountGroupAssignmentList writes a list of value of the 'account_group_assignment' type to
// the given stream.
var WriteAccountGroupAssignmentList = api_v1.WriteAccountGroupAssignmentList

// UnmarshalAccountGroupAssignmentList reads a list of values of the 'account_group_assignment' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAccountGroupAssignmentList = api_v1.UnmarshalAccountGroupAssignmentList

// ReadAccountGroupAssignmentList reads list of values of the ”account_group_assignment' type from
// the given iterator.
var ReadAccountGroupAssignmentList = api_v1.ReadAccountGroupAssignmentList
