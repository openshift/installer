...
type DefaultCapability = api_v1.DefaultCapability

// DefaultCapabilityListKind is the name of the type used to represent list of objects of
// type 'default_capability'.
const DefaultCapabilityListKind = api_v1.DefaultCapabilityListKind
...
const DefaultCapabilityListLinkKind = api_v1.DefaultCapabilityListLinkKind

// DefaultCapabilityNilKind is the name of the type used to nil lists of objects of
// type 'default_capability'.
const DefaultCapabilityListNilKind = api_v1.DefaultCapabilityListNilKind

type DefaultCapabilityList = api_v1.DefaultCapabilityList
