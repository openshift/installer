...
type ClusterRegistrationResponse = api_v1.ClusterRegistrationResponse
...
const ClusterRegistrationResponseListKind = api_v1.ClusterRegistrationResponseListKind
...
const ClusterRegistrationResponseListLinkKind = api_v1.ClusterRegistrationResponseListLinkKind

// ClusterRegistrationResponseNilKind is the name of the type used to nil lists of objects of
// type 'cluster_registration_response'.
const ClusterRegistrationResponseListNilKind = api_v1.ClusterRegistrationResponseListNilKind

type ClusterRegistrationResponseList = api_v1.ClusterRegistrationResponseList
