...
type SubscriptionMetrics = api_v1.SubscriptionMetrics

// SubscriptionMetricsListKind is the name of the type used to represent list of objects of
// type 'subscription_metrics'.
const SubscriptionMetricsListKind = api_v1.SubscriptionMetricsListKind
...
const SubscriptionMetricsListLinkKind = api_v1.SubscriptionMetricsListLinkKind

// SubscriptionMetricsNilKind is the name of the type used to nil lists of objects of
// type 'subscription_metrics'.
const SubscriptionMetricsListNilKind = api_v1.SubscriptionMetricsListNilKind

type SubscriptionMetricsList = api_v1.SubscriptionMetricsList
