...
type FeatureToggleQueryRequest = api_v1.FeatureToggleQueryRequest
...
const FeatureToggleQueryRequestListKind = api_v1.FeatureToggleQueryRequestListKind
...
const FeatureToggleQueryRequestListLinkKind = api_v1.FeatureToggleQueryRequestListLinkKind

// FeatureToggleQueryRequestNilKind is the name of the type used to nil lists of objects of
// type 'feature_toggle_query_request'.
const FeatureToggleQueryRequestListNilKind = api_v1.FeatureToggleQueryRequestListNilKind

type FeatureToggleQueryRequestList = api_v1.FeatureToggleQueryRequestList
