...
type NotificationDetailsRequest = api_v1.NotificationDetailsRequest
...
const NotificationDetailsRequestListKind = api_v1.NotificationDetailsRequestListKind
...
const NotificationDetailsRequestListLinkKind = api_v1.NotificationDetailsRequestListLinkKind

// NotificationDetailsRequestNilKind is the name of the type used to nil lists of objects of
// type 'notification_details_request'.
const NotificationDetailsRequestListNilKind = api_v1.NotificationDetailsRequestListNilKind

type NotificationDetailsRequestList = api_v1.NotificationDetailsRequestList
