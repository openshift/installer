...
func writeAccountGroupAssignmentsAddRequest(request *AccountGroupAssignmentsAddRequest, writer io.Writer) error {
	return MarshalAccountGroupAssignment(request.body, writer)
}
func readAccountGroupAssignmentsAddResponse(response *AccountGroupAssignmentsAddResponse, reader io.Reader) error {
	var err error
...
func readAccountGroupAssignmentsListResponse(response *AccountGroupAssignmentsListResponse, reader io.Reader) error {
	...
	for {
		...
		case "items":
			...
			responseItems := &AccountGroupAssignmentList{}
