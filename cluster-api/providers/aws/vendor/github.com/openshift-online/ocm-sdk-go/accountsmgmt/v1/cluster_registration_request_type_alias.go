...
type ClusterRegistrationRequest = api_v1.ClusterRegistrationRequest
...
const ClusterRegistrationRequestListKind = api_v1.ClusterRegistrationRequestListKind
...
const ClusterRegistrationRequestListLinkKind = api_v1.ClusterRegistrationRequestListLinkKind

// ClusterRegistrationRequestNilKind is the name of the type used to nil lists of objects of
// type 'cluster_registration_request'.
const ClusterRegistrationRequestListNilKind = api_v1.ClusterRegistrationRequestListNilKind

type ClusterRegistrationRequestList = api_v1.ClusterRegistrationRequestList
