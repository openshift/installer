...
type QuotaAuthorizationRequest = api_v1.QuotaAuthorizationRequest
...
const QuotaAuthorizationRequestListKind = api_v1.QuotaAuthorizationRequestListKind
...
const QuotaAuthorizationRequestListLinkKind = api_v1.QuotaAuthorizationRequestListLinkKind

// QuotaAuthorizationRequestNilKind is the name of the type used to nil lists of objects of
// type 'quota_authorization_request'.
const QuotaAuthorizationRequestListNilKind = api_v1.QuotaAuthorizationRequestListNilKind

type QuotaAuthorizationRequestList = api_v1.QuotaAuthorizationRequestList
