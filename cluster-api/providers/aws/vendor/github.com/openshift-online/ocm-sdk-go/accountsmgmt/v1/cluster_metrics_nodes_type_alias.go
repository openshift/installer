...
type ClusterMetricsNodes = api_v1.ClusterMetricsNodes

// ClusterMetricsNodesListKind is the name of the type used to represent list of objects of
// type 'cluster_metrics_nodes'.
const ClusterMetricsNodesListKind = api_v1.ClusterMetricsNodesListKind
...
const ClusterMetricsNodesListLinkKind = api_v1.ClusterMetricsNodesListLinkKind

// ClusterMetricsNodesNilKind is the name of the type used to nil lists of objects of
// type 'cluster_metrics_nodes'.
const ClusterMetricsNodesListNilKind = api_v1.ClusterMetricsNodesListNilKind

type ClusterMetricsNodesList = api_v1.ClusterMetricsNodesList
