...
type ContractDimension = api_v1.ContractDimension

// ContractDimensionListKind is the name of the type used to represent list of objects of
// type 'contract_dimension'.
const ContractDimensionListKind = api_v1.ContractDimensionListKind
...
const ContractDimensionListLinkKind = api_v1.ContractDimensionListLinkKind

// ContractDimensionNilKind is the name of the type used to nil lists of objects of
// type 'contract_dimension'.
const ContractDimensionListNilKind = api_v1.ContractDimensionListNilKind

type ContractDimensionList = api_v1.ContractDimensionList
