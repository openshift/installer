...
type ClusterResource = api_v1.ClusterResource

// ClusterResourceListKind is the name of the type used to represent list of objects of
// type 'cluster_resource'.
const ClusterResourceListKind = api_v1.ClusterResourceListKind

// ClusterResourceListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_resource'.
const ClusterResourceListLinkKind = api_v1.ClusterResourceListLinkKind

// ClusterResourceNilKind is the name of the type used to nil lists of objects of
// type 'cluster_resource'.
const ClusterResourceListNilKind = api_v1.ClusterResourceListNilKind

type ClusterResourceList = api_v1.ClusterResourceList
