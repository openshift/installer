...
The Apache 2.0 license (the "License") set forth below applies to all parts of the NSX Operator project. You may not use this file except in compliance with the License.
