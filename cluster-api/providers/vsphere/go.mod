...
require sigs.k8s.io/cluster-api-provider-vsphere v1.11.1
...
replace sigs.k8s.io/cluster-api-provider-vsphere => github.com/vr4manta/cluster-api-provider-vsphere v0.0.0-20241011142218-bfea6dcafeea
...
require (
	...
	github.com/vmware-tanzu/nsx-operator/pkg/apis v0.0.0-20240827061921-8f0982975508 // indirect
