...
func (assignment *SqlRoleAssignment) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20231115.SqlRoleAssignment)
	if !ok {
...
func (assignment *SqlRoleAssignment) defaultImpl(ctx context.Context, obj *v20231115.SqlRoleAssignment) error {
	return nil
}
...
func (assignment *SqlRoleAssignment) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20231115.SqlRoleAssignment)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/documentdb/v1api20231115/SqlRoleAssignment, but got %T", resource)
	}
	validations := assignment.createValidations()
	var temp any = assignment
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20231115.SqlRoleAssignment]); ok {
...
func (assignment *SqlRoleAssignment) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20231115.SqlRoleAssignment)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/documentdb/v1api20231115/SqlRoleAssignment, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20231115.SqlRoleAssignment)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/documentdb/v1api20231115/SqlRoleAssignment, but got %T", oldResource)
	}
...
func (assignment *SqlRoleAssignment) deleteValidations() []func(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (assignment *SqlRoleAssignment) updateValidations() []func(ctx context.Context, oldObj *v20231115.SqlRoleAssignment, newObj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20231115.SqlRoleAssignment, newObj *v20231115.SqlRoleAssignment) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20231115.SqlRoleAssignment, newObj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
...
func (assignment *SqlRoleAssignment) validateConfigMapDestinations(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
...
func (assignment *SqlRoleAssignment) validateOptionalConfigMapReferences(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
...
func (assignment *SqlRoleAssignment) validateOwnerReference(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (assignment *SqlRoleAssignment) validateResourceReferences(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
...
func (assignment *SqlRoleAssignment) validateSecretDestinations(ctx context.Context, obj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (assignment *SqlRoleAssignment) validateWriteOnceProperties(ctx context.Context, oldObj *v20231115.SqlRoleAssignment, newObj *v20231115.SqlRoleAssignment) (admission.Warnings, error) {
