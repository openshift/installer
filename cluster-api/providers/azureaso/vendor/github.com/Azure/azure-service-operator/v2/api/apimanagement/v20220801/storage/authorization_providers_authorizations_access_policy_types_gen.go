...
func (policy *AuthorizationProvidersAuthorizationsAccessPolicy) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/AuthorizationProvidersAuthorizationsAccessPolicy but received %T instead", hub)
	}
...
// Storage version of v20220801.AuthorizationProvidersAuthorizationsAccessPolicy_Spec
...
// Storage version of v20220801.AuthorizationProvidersAuthorizationsAccessPolicy_STATUS
