...
const (
	PublicIPPrefixSku_Name_Standard   = PublicIPPrefixSku_Name("Standard")
	PublicIPPrefixSku_Name_StandardV2 = PublicIPPrefixSku_Name("StandardV2")
)
...
var publicIPPrefixSku_Name_Values = map[string]PublicIPPrefixSku_Name{
	...
	"standardv2": PublicIPPrefixSku_Name_StandardV2,
}

type PublicIPPrefixSku_Name_STATUS string

const (
	PublicIPPrefixSku_Name_STATUS_Standard   = PublicIPPrefixSku_Name_STATUS("Standard")
	PublicIPPrefixSku_Name_STATUS_StandardV2 = PublicIPPrefixSku_Name_STATUS("StandardV2")
)
...
var publicIPPrefixSku_Name_STATUS_Values = map[string]PublicIPPrefixSku_Name_STATUS{
	...
	"standardv2": PublicIPPrefixSku_Name_STATUS_StandardV2,
}
