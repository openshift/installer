...
func (service *StorageAccountsTableService) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsTableService, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-storage-azure-com-v20230101-storageaccountstableservice,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=storage.azure.com,resources=storageaccountstableservices,verbs=create;update,versions=v20230101,name=validate.v20230101.storageaccountstableservices.storage.azure.com,admissionReviewVersions=v1
...
func (service *StorageAccountsTableService) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsTableService, but got %T", resource)
	}
...
func (service *StorageAccountsTableService) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsTableService, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230101.StorageAccountsTableService)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsTableService, but got %T", oldResource)
	}
...
func (service *StorageAccountsTableService) createValidations() []func(ctx context.Context, obj *v20230101.StorageAccountsTableService) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20230101.StorageAccountsTableService) (admission.Warnings, error){
