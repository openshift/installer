...
func (product *Product) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/Product but received %T instead", hub)
	}
...
// Storage version of v20220801.Product_Spec
...
// Storage version of v20220801.Product_STATUS
