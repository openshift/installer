...
func (policy *ProductPolicy) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/ProductPolicy but received %T instead", hub)
	}
...
// Storage version of v20220801.ProductPolicy_Spec
...
// Storage version of v20220801.ProductPolicy_STATUS
