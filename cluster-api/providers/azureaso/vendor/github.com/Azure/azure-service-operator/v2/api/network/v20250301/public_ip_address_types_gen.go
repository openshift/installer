...
// +kubebuilder:validation:Enum={"Basic","Standard","StandardV2"}
...
const (
	...
	PublicIPAddressSku_Name_StandardV2 = PublicIPAddressSku_Name("StandardV2")
)
...
var publicIPAddressSku_Name_Values = map[string]PublicIPAddressSku_Name{
	...
	"standardv2": PublicIPAddressSku_Name_StandardV2,
}
...
const (
	...
	PublicIPAddressSku_Name_STATUS_StandardV2 = PublicIPAddressSku_Name_STATUS("StandardV2")
)
...
var publicIPAddressSku_Name_STATUS_Values = map[string]PublicIPAddressSku_Name_STATUS{
	...
	"standardv2": PublicIPAddressSku_Name_STATUS_StandardV2,
}
