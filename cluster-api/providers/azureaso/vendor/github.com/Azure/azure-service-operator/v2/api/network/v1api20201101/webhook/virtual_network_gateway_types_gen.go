...
func (gateway *VirtualNetworkGateway) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20201101.VirtualNetworkGateway)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/network/v1api20201101/VirtualNetworkGateway, but got %T", obj)
	}
...
func (gateway *VirtualNetworkGateway) defaultAzureName(ctx context.Context, obj *v20201101.VirtualNetworkGateway) error {
...
func (gateway *VirtualNetworkGateway) defaultImpl(ctx context.Context, obj *v20201101.VirtualNetworkGateway) error {
...
func (gateway *VirtualNetworkGateway) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20201101.VirtualNetworkGateway)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/network/v1api20201101/VirtualNetworkGateway, but got %T", resource)
	}
	validations := gateway.createValidations()
	var temp any = gateway
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20201101.VirtualNetworkGateway]); ok {
...
func (gateway *VirtualNetworkGateway) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20201101.VirtualNetworkGateway)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/network/v1api20201101/VirtualNetworkGateway, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20201101.VirtualNetworkGateway)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/network/v1api20201101/VirtualNetworkGateway, but got %T", oldResource)
	}
...
func (gateway *VirtualNetworkGateway) deleteValidations() []func(ctx context.Context, obj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (gateway *VirtualNetworkGateway) updateValidations() []func(ctx context.Context, oldObj *v20201101.VirtualNetworkGateway, newObj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20201101.VirtualNetworkGateway, newObj *v20201101.VirtualNetworkGateway) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20201101.VirtualNetworkGateway, newObj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
...
func (gateway *VirtualNetworkGateway) validateConfigMapDestinations(ctx context.Context, obj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
...
func (gateway *VirtualNetworkGateway) validateOwnerReference(ctx context.Context, obj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (gateway *VirtualNetworkGateway) validateResourceReferences(ctx context.Context, obj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
...
func (gateway *VirtualNetworkGateway) validateSecretDestinations(ctx context.Context, obj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (gateway *VirtualNetworkGateway) validateWriteOnceProperties(ctx context.Context, oldObj *v20201101.VirtualNetworkGateway, newObj *v20201101.VirtualNetworkGateway) (admission.Warnings, error) {
