...
func (workspace *Workspace) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20210701.Workspace)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/machinelearningservices/v1api20210701/Workspace, but got %T", obj)
	}
...
func (workspace *Workspace) defaultAzureName(ctx context.Context, obj *v20210701.Workspace) error {
...
func (workspace *Workspace) defaultImpl(ctx context.Context, obj *v20210701.Workspace) error {
...
func (workspace *Workspace) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20210701.Workspace)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/machinelearningservices/v1api20210701/Workspace, but got %T", resource)
	}
	validations := workspace.createValidations()
	var temp any = workspace
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20210701.Workspace]); ok {
...
func (workspace *Workspace) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20210701.Workspace)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/machinelearningservices/v1api20210701/Workspace, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210701.Workspace)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/machinelearningservices/v1api20210701/Workspace, but got %T", oldResource)
	}
...
func (workspace *Workspace) deleteValidations() []func(ctx context.Context, obj *v20210701.Workspace) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (workspace *Workspace) updateValidations() []func(ctx context.Context, oldObj *v20210701.Workspace, newObj *v20210701.Workspace) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20210701.Workspace, newObj *v20210701.Workspace) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20210701.Workspace, newObj *v20210701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateConfigMapDestinations(ctx context.Context, obj *v20210701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateOwnerReference(ctx context.Context, obj *v20210701.Workspace) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (workspace *Workspace) validateResourceReferences(ctx context.Context, obj *v20210701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateSecretDestinations(ctx context.Context, obj *v20210701.Workspace) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (workspace *Workspace) validateWriteOnceProperties(ctx context.Context, oldObj *v20210701.Workspace, newObj *v20210701.Workspace) (admission.Warnings, error) {
