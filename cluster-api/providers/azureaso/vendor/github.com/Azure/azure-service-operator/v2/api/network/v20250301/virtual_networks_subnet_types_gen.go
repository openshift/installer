...
func (subnet *VirtualNetworksSubnet_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if subnet.AddressPrefix != nil ||
		...
		subnet.IpamPoolPrefixAllocations != nil ||
	...
	for _, item := range subnet.IpamPoolPrefixAllocations {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.Properties.IpamPoolPrefixAllocations = append(result.Properties.IpamPoolPrefixAllocations, *item_ARM.(*arm.IpamPoolPrefixAllocation))
	}
...
func (subnet *VirtualNetworksSubnet_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "IpamPoolPrefixAllocations":
	// copying flattened property:
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.IpamPoolPrefixAllocations {
			var item1 IpamPoolPrefixAllocation
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
			subnet.IpamPoolPrefixAllocations = append(subnet.IpamPoolPrefixAllocations, item1)
		}
	}
...
func (subnet *VirtualNetworksSubnet_Spec) AssignProperties_From_VirtualNetworksSubnet_Spec(source *storage.VirtualNetworksSubnet_Spec) error {
	...
	if source.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]IpamPoolPrefixAllocation, len(source.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range source.IpamPoolPrefixAllocations {
			var ipamPoolPrefixAllocation IpamPoolPrefixAllocation
			err := ipamPoolPrefixAllocation.AssignProperties_From_IpamPoolPrefixAllocation(&ipamPoolPrefixAllocationItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IpamPoolPrefixAllocation() to populate field IpamPoolPrefixAllocations")
			}
			ipamPoolPrefixAllocationList[ipamPoolPrefixAllocationIndex] = ipamPoolPrefixAllocation
		}
		subnet.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
	} else {
		subnet.IpamPoolPrefixAllocations = nil
	}
...
func (subnet *VirtualNetworksSubnet_Spec) AssignProperties_To_VirtualNetworksSubnet_Spec(destination *storage.VirtualNetworksSubnet_Spec) error {
	...
	// IpamPoolPrefixAllocations
	if subnet.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]storage.IpamPoolPrefixAllocation, len(subnet.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range subnet.IpamPoolPrefixAllocations {
			var ipamPoolPrefixAllocation storage.IpamPoolPrefixAllocation
			err := ipamPoolPrefixAllocationItem.AssignProperties_To_IpamPoolPrefixAllocation(&ipamPoolPrefixAllocation)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IpamPoolPrefixAllocation() to populate field IpamPoolPrefixAllocations")
			}
			ipamPoolPrefixAllocationList[ipamPoolPrefixAllocationIndex] = ipamPoolPrefixAllocation
		}
		destination.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
	} else {
...
func (subnet *VirtualNetworksSubnet_Spec) Initialize_From_VirtualNetworksSubnet_STATUS(source *VirtualNetworksSubnet_STATUS) error {
	...
	if source.IpamPoolPrefixAllocations != nil {
		...
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range source.IpamPoolPrefixAllocations {
			var ipamPoolPrefixAllocation IpamPoolPrefixAllocation
			err := ipamPoolPrefixAllocation.Initialize_From_IpamPoolPrefixAllocation_STATUS(&ipamPoolPrefixAllocationItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_IpamPoolPrefixAllocation_STATUS() to populate field IpamPoolPrefixAllocations")
			}
			ipamPoolPrefixAllocationList[ipamPoolPrefixAllocationIndex] = ipamPoolPrefixAllocation
		}
		subnet.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
...
type VirtualNetworksSubnet_STATUS struct {
	...
	// IpamPoolPrefixAllocations: A list of IPAM Pools for allocating IP address prefixes.
	IpamPoolPrefixAllocations []IpamPoolPrefixAllocation_STATUS `json:"ipamPoolPrefixAllocations,omitempty"`
...
func (subnet *VirtualNetworksSubnet_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.IpamPoolPrefixAllocations {
			var item1 IpamPoolPrefixAllocation_STATUS
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
...
func (subnet *VirtualNetworksSubnet_STATUS) AssignProperties_From_VirtualNetworksSubnet_STATUS(source *storage.VirtualNetworksSubnet_STATUS) error {
	...
	// IpamPoolPrefixAllocations
	if source.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]IpamPoolPrefixAllocation_STATUS, len(source.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range source.IpamPoolPrefixAllocations {
			var ipamPoolPrefixAllocation IpamPoolPrefixAllocation_STATUS
			err := ipamPoolPrefixAllocation.AssignProperties_From_IpamPoolPrefixAllocation_STATUS(&ipamPoolPrefixAllocationItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IpamPoolPrefixAllocation_STATUS() to populate field IpamPoolPrefixAllocations")
			}
			ipamPoolPrefixAllocationList[ipamPoolPrefixAllocationIndex] = ipamPoolPrefixAllocation
		}
		subnet.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
...
func (subnet *VirtualNetworksSubnet_STATUS) AssignProperties_To_VirtualNetworksSubnet_STATUS(destination *storage.VirtualNetworksSubnet_STATUS) error {
	...
	// IpamPoolPrefixAllocations
	if subnet.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]storage.IpamPoolPrefixAllocation_STATUS, len(subnet.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range subnet.IpamPoolPrefixAllocations {
			var ipamPoolPrefixAllocation storage.IpamPoolPrefixAllocation_STATUS
			err := ipamPoolPrefixAllocationItem.AssignProperties_To_IpamPoolPrefixAllocation_STATUS(&ipamPoolPrefixAllocation)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IpamPoolPrefixAllocation_STATUS() to populate field IpamPoolPrefixAllocations")
			}
			ipamPoolPrefixAllocationList[ipamPoolPrefixAllocationIndex] = ipamPoolPrefixAllocation
		}
		destination.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
...
type IpamPoolPrefixAllocation struct {
	...
	// Reference: Resource id of the associated Azure IpamPool resource.
	Reference *genruntime.ResourceReference `armReference:"Id" json:"reference,omitempty"`
}

var _ genruntime.ARMTransformer = &IpamPoolPrefixAllocation{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (allocation *IpamPoolPrefixAllocation) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if allocation == nil {
		return nil, nil
	}
	result := &arm.IpamPoolPrefixAllocation{}

	// Set property "NumberOfIpAddresses":
	if allocation.NumberOfIpAddresses != nil {
		numberOfIpAddresses := *allocation.NumberOfIpAddresses
		result.NumberOfIpAddresses = &numberOfIpAddresses
	}

	// Set property "Pool":
	if allocation.Reference != nil {
		result.Pool = &arm.IpamPoolPrefixAllocation_Pool{}
	}
	if allocation.Reference != nil {
		idARMID, err := resolved.ResolvedReferences.Lookup(*allocation.Reference)
		if err != nil {
			return nil, err
		}
		id := idARMID
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (allocation *IpamPoolPrefixAllocation) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IpamPoolPrefixAllocation{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (allocation *IpamPoolPrefixAllocation) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IpamPoolPrefixAllocation)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IpamPoolPrefixAllocation, got %T", armInput)
	}

	// Set property "NumberOfIpAddresses":
	if typedInput.NumberOfIpAddresses != nil {
		numberOfIpAddresses := *typedInput.NumberOfIpAddresses
		allocation.NumberOfIpAddresses = &numberOfIpAddresses
	}
...
// AssignProperties_From_IpamPoolPrefixAllocation populates our IpamPoolPrefixAllocation from the provided source IpamPoolPrefixAllocation
func (allocation *IpamPoolPrefixAllocation) AssignProperties_From_IpamPoolPrefixAllocation(source *storage.IpamPoolPrefixAllocation) error {

	// NumberOfIpAddresses
	allocation.NumberOfIpAddresses = genruntime.ClonePointerToString(source.NumberOfIpAddresses)
...
// AssignProperties_To_IpamPoolPrefixAllocation populates the provided destination IpamPoolPrefixAllocation from our IpamPoolPrefixAllocation
func (allocation *IpamPoolPrefixAllocation) AssignProperties_To_IpamPoolPrefixAllocation(destination *storage.IpamPoolPrefixAllocation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// NumberOfIpAddresses
	destination.NumberOfIpAddresses = genruntime.ClonePointerToString(allocation.NumberOfIpAddresses)

	// Reference
	if allocation.Reference != nil {
		reference := allocation.Reference.Copy()
		destination.Reference = &reference
	} else {
		destination.Reference = nil
	}
...
// Initialize_From_IpamPoolPrefixAllocation_STATUS populates our IpamPoolPrefixAllocation from the provided source IpamPoolPrefixAllocation_STATUS
func (allocation *IpamPoolPrefixAllocation) Initialize_From_IpamPoolPrefixAllocation_STATUS(source *IpamPoolPrefixAllocation_STATUS) error {
...
// IpamPool prefix allocation reference.
type IpamPoolPrefixAllocation_STATUS struct {
...
var _ genruntime.FromARMConverter = &IpamPoolPrefixAllocation_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (allocation *IpamPoolPrefixAllocation_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IpamPoolPrefixAllocation_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (allocation *IpamPoolPrefixAllocation_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IpamPoolPrefixAllocation_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IpamPoolPrefixAllocation_STATUS, got %T", armInput)
	}

	// Set property "AllocatedAddressPrefixes":
	for _, item := range typedInput.AllocatedAddressPrefixes {
		allocation.AllocatedAddressPrefixes = append(allocation.AllocatedAddressPrefixes, item)
	}

	// Set property "Id":
	// copying flattened property:
	if typedInput.Pool != nil {
		if typedInput.Pool.Id != nil {
			id := *typedInput.Pool.Id
			allocation.Id = &id
		}
	}
...
// AssignProperties_From_IpamPoolPrefixAllocation_STATUS populates our IpamPoolPrefixAllocation_STATUS from the provided source IpamPoolPrefixAllocation_STATUS
func (allocation *IpamPoolPrefixAllocation_STATUS) AssignProperties_From_IpamPoolPrefixAllocation_STATUS(source *storage.IpamPoolPrefixAllocation_STATUS) error {

	// AllocatedAddressPrefixes
	allocation.AllocatedAddressPrefixes = genruntime.CloneSliceOfString(source.AllocatedAddressPrefixes)

	// Id
	allocation.Id = genruntime.ClonePointerToString(source.Id)
...
// AssignProperties_To_IpamPoolPrefixAllocation_STATUS populates the provided destination IpamPoolPrefixAllocation_STATUS from our IpamPoolPrefixAllocation_STATUS
func (allocation *IpamPoolPrefixAllocation_STATUS) AssignProperties_To_IpamPoolPrefixAllocation_STATUS(destination *storage.IpamPoolPrefixAllocation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AllocatedAddressPrefixes
	destination.AllocatedAddressPrefixes = genruntime.CloneSliceOfString(allocation.AllocatedAddressPrefixes)

	// Id
	destination.Id = genruntime.ClonePointerToString(allocation.Id)
