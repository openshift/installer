...
type VirtualNetwork_STATUS struct {
	...
	DefaultPublicNatGateway *SubResource_STATUS `json:"defaultPublicNatGateway,omitempty"`
	...
	ProvisioningState *VirtualNetworkProvisioningState_STATUS `json:"provisioningState,omitempty"`
...
func (network *VirtualNetwork_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DefaultPublicNatGateway":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DefaultPublicNatGateway != nil {
			var defaultPublicNatGateway1 SubResource_STATUS
			err := defaultPublicNatGateway1.PopulateFromARM(owner, *typedInput.Properties.DefaultPublicNatGateway)
			if err != nil {
				return err
			}
			defaultPublicNatGateway := defaultPublicNatGateway1
			network.DefaultPublicNatGateway = &defaultPublicNatGateway
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			provisioningState := VirtualNetworkProvisioningState_STATUS(temp)
...
func (network *VirtualNetwork_STATUS) AssignProperties_From_VirtualNetwork_STATUS(source *storage.VirtualNetwork_STATUS) error {
	...
	if source.DefaultPublicNatGateway != nil {
		var defaultPublicNatGateway SubResource_STATUS
		err := defaultPublicNatGateway.AssignProperties_From_SubResource_STATUS(source.DefaultPublicNatGateway)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field DefaultPublicNatGateway")
		}
		network.DefaultPublicNatGateway = &defaultPublicNatGateway
	} else {
		network.DefaultPublicNatGateway = nil
	}
	...
	if source.ProvisioningState != nil {
		...
		provisioningStateTemp := genruntime.ToEnum(provisioningState, virtualNetworkProvisioningState_STATUS_Values)
...
func (network *VirtualNetwork_STATUS) AssignProperties_To_VirtualNetwork_STATUS(destination *storage.VirtualNetwork_STATUS) error {
	...
	// DefaultPublicNatGateway
	if network.DefaultPublicNatGateway != nil {
		var defaultPublicNatGateway storage.SubResource_STATUS
		err := network.DefaultPublicNatGateway.AssignProperties_To_SubResource_STATUS(&defaultPublicNatGateway)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field DefaultPublicNatGateway")
		}
...
func (space *AddressSpace) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	for _, item := range space.IpamPoolPrefixAllocations {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.IpamPoolPrefixAllocations = append(result.IpamPoolPrefixAllocations, *item_ARM.(*arm.IpamPoolPrefixAllocation))
	}
	return result, nil
}
...
func (space *AddressSpace) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "IpamPoolPrefixAllocations":
	for _, item := range typedInput.IpamPoolPrefixAllocations {
		var item1 IpamPoolPrefixAllocation
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		space.IpamPoolPrefixAllocations = append(space.IpamPoolPrefixAllocations, item1)
	}
...
func (space *AddressSpace) AssignProperties_From_AddressSpace(source *storage.AddressSpace) error {
	...
	if source.IpamPoolPrefixAllocations != nil {
		...
		space.IpamPoolPrefixAllocations = ipamPoolPrefixAllocationList
	} else {
		space.IpamPoolPrefixAllocations = nil
	}
...
func (space *AddressSpace) AssignProperties_To_AddressSpace(destination *storage.AddressSpace) error {
	...
	// IpamPoolPrefixAllocations
	if space.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]storage.IpamPoolPrefixAllocation, len(space.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range space.IpamPoolPrefixAllocations {
...
func (space *AddressSpace_STATUS) AssignProperties_To_AddressSpace_STATUS(destination *storage.AddressSpace_STATUS) error {
	...
	// IpamPoolPrefixAllocations
	if space.IpamPoolPrefixAllocations != nil {
		ipamPoolPrefixAllocationList := make([]storage.IpamPoolPrefixAllocation_STATUS, len(space.IpamPoolPrefixAllocations))
		for ipamPoolPrefixAllocationIndex, ipamPoolPrefixAllocationItem := range space.IpamPoolPrefixAllocations {
...
type VirtualNetworkProvisioningState_STATUS string

const (
	VirtualNetworkProvisioningState_STATUS_Deleting  = VirtualNetworkProvisioningState_STATUS("Deleting")
	VirtualNetworkProvisioningState_STATUS_Failed    = VirtualNetworkProvisioningState_STATUS("Failed")
	VirtualNetworkProvisioningState_STATUS_Succeeded = VirtualNetworkProvisioningState_STATUS("Succeeded")
	VirtualNetworkProvisioningState_STATUS_Updating  = VirtualNetworkProvisioningState_STATUS("Updating")
)

// Mapping from string to VirtualNetworkProvisioningState_STATUS
var virtualNetworkProvisioningState_STATUS_Values = map[string]VirtualNetworkProvisioningState_STATUS{
	"deleting":  VirtualNetworkProvisioningState_STATUS_Deleting,
	"failed":    VirtualNetworkProvisioningState_STATUS_Failed,
	"succeeded": VirtualNetworkProvisioningState_STATUS_Succeeded,
	"updating":  VirtualNetworkProvisioningState_STATUS_Updating,
}
