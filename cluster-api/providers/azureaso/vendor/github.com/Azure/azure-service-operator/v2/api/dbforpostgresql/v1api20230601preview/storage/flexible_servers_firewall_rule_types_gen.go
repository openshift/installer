...
type augmentConversionForFlexibleServersFirewallRule interface {
	AssignPropertiesFrom(src *v20221201s.FlexibleServersFirewallRule) error
	AssignPropertiesTo(dst *v20221201s.FlexibleServersFirewallRule) error
}
...
type augmentConversionForFlexibleServers_FirewallRule_Spec interface {
	AssignPropertiesFrom(src *v20221201s.FlexibleServers_FirewallRule_Spec) error
	AssignPropertiesTo(dst *v20221201s.FlexibleServers_FirewallRule_Spec) error
}

type augmentConversionForFlexibleServers_FirewallRule_STATUS interface {
	AssignPropertiesFrom(src *v20221201s.FlexibleServers_FirewallRule_STATUS) error
	AssignPropertiesTo(dst *v20221201s.FlexibleServers_FirewallRule_STATUS) error
}
