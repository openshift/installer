...
// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v20230501preview-policy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=policies,verbs=create;update,versions=v20230501preview,name=default.v20230501preview.policies.apimanagement.azure.com,admissionReviewVersions=v1
...
func (policy *Policy) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Policy, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v20230501preview-policy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=policies,verbs=create;update,versions=v20230501preview,name=validate.v20230501preview.policies.apimanagement.azure.com,admissionReviewVersions=v1
...
func (policy *Policy) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Policy, but got %T", resource)
	}
...
func (policy *Policy) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Policy, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230501p.Policy)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Policy, but got %T", oldResource)
	}
...
func (policy *Policy) createValidations() []func(ctx context.Context, obj *v20230501p.Policy) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20230501p.Policy) (admission.Warnings, error){
