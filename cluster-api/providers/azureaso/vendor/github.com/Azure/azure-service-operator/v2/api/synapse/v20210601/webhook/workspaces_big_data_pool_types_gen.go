...
func (pool *WorkspacesBigDataPool) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/WorkspacesBigDataPool, but got %T", obj)
	}
...
func (pool *WorkspacesBigDataPool) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/WorkspacesBigDataPool, but got %T", resource)
	}
...
func (pool *WorkspacesBigDataPool) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/WorkspacesBigDataPool, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210601.WorkspacesBigDataPool)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/WorkspacesBigDataPool, but got %T", oldResource)
	}
