...
func (rule *FlexibleServersFirewallRule) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20230601ps.FlexibleServersFirewallRule
...
func (rule *FlexibleServersFirewallRule) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20230601ps.FlexibleServersFirewallRule
...
func (rule *FlexibleServersFirewallRule) AssignProperties_To_FlexibleServersFirewallRule(destination *v20230601ps.FlexibleServersFirewallRule) error {
	...
	// Spec
	var spec v20230601ps.FlexibleServers_FirewallRule_Spec
	...
	// Status
	var status v20230601ps.FlexibleServers_FirewallRule_STATUS
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230601ps.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	src = &v20230601ps.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230601ps.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230601ps.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230601ps.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230601ps.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230601ps.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230601ps.FlexibleServers_FirewallRule_STATUS{}
