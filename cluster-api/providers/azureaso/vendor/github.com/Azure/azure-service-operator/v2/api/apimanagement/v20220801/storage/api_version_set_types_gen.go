...
func (versionSet *ApiVersionSet) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/ApiVersionSet but received %T instead", hub)
	}
...
// Storage version of v20220801.ApiVersionSet_Spec
...
// Storage version of v20220801.ApiVersionSet_STATUS
