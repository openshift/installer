...
import (
	"context"
	"fmt"
	v20210601 "github.com/Azure/azure-service-operator/v2/api/synapse/v20210601"
...
// +kubebuilder:webhook:path=/mutate-synapse-azure-com-v20210601-workspace,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=synapse.azure.com,resources=workspaces,verbs=create;update,versions=v20210601,name=default.v20210601.workspaces.synapse.azure.com,admissionReviewVersions=v1
...
func (workspace *Workspace) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/Workspace, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-synapse-azure-com-v20210601-workspace,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=synapse.azure.com,resources=workspaces,verbs=create;update,versions=v20210601,name=validate.v20210601.workspaces.synapse.azure.com,admissionReviewVersions=v1
...
func (workspace *Workspace) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/Workspace, but got %T", resource)
	}
...
func (workspace *Workspace) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/Workspace, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210601.Workspace)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/synapse/v20210601/Workspace, but got %T", oldResource)
	}
