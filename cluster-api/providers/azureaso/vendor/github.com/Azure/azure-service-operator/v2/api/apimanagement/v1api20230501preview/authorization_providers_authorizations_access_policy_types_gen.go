...
func (policy *AuthorizationProvidersAuthorizationsAccessPolicy) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20230501ps.AuthorizationProvidersAuthorizationsAccessPolicy
...
func (policy *AuthorizationProvidersAuthorizationsAccessPolicy) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20230501ps.AuthorizationProvidersAuthorizationsAccessPolicy
...
func (policy *AuthorizationProvidersAuthorizationsAccessPolicy) AssignProperties_From_AuthorizationProvidersAuthorizationsAccessPolicy(source *v20230501ps.AuthorizationProvidersAuthorizationsAccessPolicy) error {
...
func (policy *AuthorizationProvidersAuthorizationsAccessPolicy) AssignProperties_To_AuthorizationProvidersAuthorizationsAccessPolicy(destination *v20230501ps.AuthorizationProvidersAuthorizationsAccessPolicy) error {

	// ObjectMeta
	destination.ObjectMeta = *policy.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec
	...
	// Status
	var status v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec)
	if ok {
	...
	src = &v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec{}
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec{}
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) AssignProperties_From_Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec(source *v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) error {
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) AssignProperties_To_Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec(destination *v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_Spec) error {
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS{}
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS{}
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) AssignProperties_From_Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS(source *v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) error {
...
func (policy *Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) AssignProperties_To_Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS(destination *v20230501ps.Service_AuthorizationProviders_Authorizations_AccessPolicy_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
