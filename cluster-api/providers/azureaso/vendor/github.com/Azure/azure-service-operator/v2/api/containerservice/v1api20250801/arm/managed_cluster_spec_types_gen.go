...
type AdvancedNetworkingSecurity struct {
	...
	AdvancedNetworkPolicies *AdvancedNetworkingSecurity_AdvancedNetworkPolicies `json:"advancedNetworkPolicies,omitempty"`
...
type AdvancedNetworkingSecurity_AdvancedNetworkPolicies string

const (
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_FQDN = AdvancedNetworkingSecurity_AdvancedNetworkPolicies("FQDN")
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_L7   = AdvancedNetworkingSecurity_AdvancedNetworkPolicies("L7")
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_None = AdvancedNetworkingSecurity_AdvancedNetworkPolicies("None")
)

// Mapping from string to AdvancedNetworkingSecurity_AdvancedNetworkPolicies
var advancedNetworkingSecurity_AdvancedNetworkPolicies_Values = map[string]AdvancedNetworkingSecurity_AdvancedNetworkPolicies{
	"fqdn": AdvancedNetworkingSecurity_AdvancedNetworkPolicies_FQDN,
	"l7":   AdvancedNetworkingSecurity_AdvancedNetworkPolicies_L7,
	"none": AdvancedNetworkingSecurity_AdvancedNetworkPolicies_None,
}
