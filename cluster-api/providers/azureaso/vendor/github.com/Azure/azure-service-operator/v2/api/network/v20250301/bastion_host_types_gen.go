...
func (host *BastionHost_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if host.DisableCopyPaste != nil ||
		...
		host.EnablePrivateOnlyBastion != nil ||
	...
	if host.EnablePrivateOnlyBastion != nil {
		enablePrivateOnlyBastion := *host.EnablePrivateOnlyBastion
		result.Properties.EnablePrivateOnlyBastion = &enablePrivateOnlyBastion
	}
...
func (host *BastionHost_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "EnablePrivateOnlyBastion":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.EnablePrivateOnlyBastion != nil {
			enablePrivateOnlyBastion := *typedInput.Properties.EnablePrivateOnlyBastion
			host.EnablePrivateOnlyBastion = &enablePrivateOnlyBastion
		}
	}
...
func (host *BastionHost_Spec) AssignProperties_From_BastionHost_Spec(source *storage.BastionHost_Spec) error {
	...
	if source.EnablePrivateOnlyBastion != nil {
		enablePrivateOnlyBastion := *source.EnablePrivateOnlyBastion
		host.EnablePrivateOnlyBastion = &enablePrivateOnlyBastion
	} else {
		host.EnablePrivateOnlyBastion = nil
	}
