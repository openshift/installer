...
func (firewall *AzureFirewall_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if firewall.ExtendedLocation != nil {
		extendedLocation_ARM, err := firewall.ExtendedLocation.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
...
func (firewall *AzureFirewall_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.ExtendedLocation != nil {
		...
		firewall.ExtendedLocation = &extendedLocation
	}
...
func (firewall *AzureFirewall_Spec) AssignProperties_To_AzureFirewall_Spec(destination *storage.AzureFirewall_Spec) error {
	...
	if firewall.ExtendedLocation != nil {
		...
		err := firewall.ExtendedLocation.AssignProperties_To_ExtendedLocation(&extendedLocation)
		if err != nil {
...
type AzureFirewall_STATUS struct {
	...
	ProvisioningState *AzureFirewallProvisioningState_STATUS `json:"provisioningState,omitempty"`
...
func (firewall *AzureFirewall_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			provisioningState := AzureFirewallProvisioningState_STATUS(temp)
...
func (firewall *AzureFirewall_STATUS) AssignProperties_From_AzureFirewall_STATUS(source *storage.AzureFirewall_STATUS) error {
	...
	if source.ProvisioningState != nil {
		...
		provisioningStateTemp := genruntime.ToEnum(provisioningState, azureFirewallProvisioningState_STATUS_Values)
...
func (firewall *AzureFirewall_STATUS) AssignProperties_To_AzureFirewall_STATUS(destination *storage.AzureFirewall_STATUS) error {
	...
	if firewall.ExtendedLocation != nil {
		...
		err := firewall.ExtendedLocation.AssignProperties_To_ExtendedLocation_STATUS(&extendedLocation)
		if err != nil {
...
type AzureFirewallProvisioningState_STATUS string

const (
	AzureFirewallProvisioningState_STATUS_Deleting  = AzureFirewallProvisioningState_STATUS("Deleting")
	AzureFirewallProvisioningState_STATUS_Failed    = AzureFirewallProvisioningState_STATUS("Failed")
	AzureFirewallProvisioningState_STATUS_Succeeded = AzureFirewallProvisioningState_STATUS("Succeeded")
	AzureFirewallProvisioningState_STATUS_Updating  = AzureFirewallProvisioningState_STATUS("Updating")
)

// Mapping from string to AzureFirewallProvisioningState_STATUS
var azureFirewallProvisioningState_STATUS_Values = map[string]AzureFirewallProvisioningState_STATUS{
	"deleting":  AzureFirewallProvisioningState_STATUS_Deleting,
	"failed":    AzureFirewallProvisioningState_STATUS_Failed,
	"succeeded": AzureFirewallProvisioningState_STATUS_Succeeded,
	"updating":  AzureFirewallProvisioningState_STATUS_Updating,
}
