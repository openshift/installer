...
// +kubebuilder:webhook:path=/mutate-storage-azure-com-v20220901-storageaccountsblobservicescontainer,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=storage.azure.com,resources=storageaccountsblobservicescontainers,verbs=create;update,versions=v20220901,name=default.v20220901.storageaccountsblobservicescontainers.storage.azure.com,admissionReviewVersions=v1
...
func (container *StorageAccountsBlobServicesContainer) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20220901/StorageAccountsBlobServicesContainer, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-storage-azure-com-v20220901-storageaccountsblobservicescontainer,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=storage.azure.com,resources=storageaccountsblobservicescontainers,verbs=create;update,versions=v20220901,name=validate.v20220901.storageaccountsblobservicescontainers.storage.azure.com,admissionReviewVersions=v1
...
func (container *StorageAccountsBlobServicesContainer) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20220901/StorageAccountsBlobServicesContainer, but got %T", resource)
	}
...
func (container *StorageAccountsBlobServicesContainer) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20220901/StorageAccountsBlobServicesContainer, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20220901.StorageAccountsBlobServicesContainer)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20220901/StorageAccountsBlobServicesContainer, but got %T", oldResource)
	}
