...
func (provider *AuthorizationProvider) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/AuthorizationProvider but received %T instead", hub)
	}
...
// Storage version of v20220801.AuthorizationProvider_Spec
...
// Storage version of v20220801.AuthorizationProvider_STATUS
