...
// +kubebuilder:validation:Enum={"All","Quic","Tcp","Udp"}
type TransportProtocol string

const (
	TransportProtocol_All  = TransportProtocol("All")
	TransportProtocol_Quic = TransportProtocol("Quic")
...
const (
	...
	TransportProtocol_STATUS_Quic = TransportProtocol_STATUS("Quic")
...
var transportProtocol_STATUS_Values = map[string]TransportProtocol_STATUS{
	...
	"quic": TransportProtocol_STATUS_Quic,
