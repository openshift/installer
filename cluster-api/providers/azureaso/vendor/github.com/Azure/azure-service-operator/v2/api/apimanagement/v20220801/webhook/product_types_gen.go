...
// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v20220801-product,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=products,verbs=create;update,versions=v20220801,name=default.v20220801.products.apimanagement.azure.com,admissionReviewVersions=v1
...
func (product *Product) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/Product, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v20220801-product,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=products,verbs=create;update,versions=v20220801,name=validate.v20220801.products.apimanagement.azure.com,admissionReviewVersions=v1
...
func (product *Product) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/Product, but got %T", resource)
	}
...
func (product *Product) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/Product, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20220801.Product)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/Product, but got %T", oldResource)
	}
...
func (product *Product) createValidations() []func(ctx context.Context, obj *v20220801.Product) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20220801.Product) (admission.Warnings, error){
