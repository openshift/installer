...
func (record *PrivateDnsZonesCNAMERecord) validateOptionalConfigMapReferences(ctx context.Context, obj *v20240601.PrivateDnsZonesCNAMERecord) (admission.Warnings, error) {
