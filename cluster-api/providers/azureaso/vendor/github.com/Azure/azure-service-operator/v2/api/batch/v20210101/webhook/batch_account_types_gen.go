...
import (
	"context"
	"fmt"
	v20210101 "github.com/Azure/azure-service-operator/v2/api/batch/v20210101"
...
// +kubebuilder:webhook:path=/mutate-batch-azure-com-v20210101-batchaccount,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v20210101,name=default.v20210101.batchaccounts.batch.azure.com,admissionReviewVersions=v1
...
func (account *BatchAccount) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/batch/v20210101/BatchAccount, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-batch-azure-com-v20210101-batchaccount,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v20210101,name=validate.v20210101.batchaccounts.batch.azure.com,admissionReviewVersions=v1
...
func (account *BatchAccount) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/batch/v20210101/BatchAccount, but got %T", resource)
	}
...
func (account *BatchAccount) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/batch/v20210101/BatchAccount, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210101.BatchAccount)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/batch/v20210101/BatchAccount, but got %T", oldResource)
	}
