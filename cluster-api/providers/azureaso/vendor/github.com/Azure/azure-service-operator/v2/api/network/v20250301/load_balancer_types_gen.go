...
type LoadBalancer_Spec struct {
	...
	// Scope: Indicates the scope of the load balancer: external (Public) or internal (Private).
	Scope *LoadBalancerPropertiesFormat_Scope `json:"scope,omitempty"`
...
func (balancer *LoadBalancer_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if balancer.Scope != nil {
		var temp string
		temp = string(*balancer.Scope)
		scope := arm.LoadBalancerPropertiesFormat_Scope(temp)
...
func (balancer *LoadBalancer_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.Scope != nil {
			...
			scope := LoadBalancerPropertiesFormat_Scope(temp)
			balancer.Scope = &scope
		}
	}
...
func (balancer *LoadBalancer_Spec) AssignProperties_From_LoadBalancer_Spec(source *storage.LoadBalancer_Spec) error {
	...
	if source.Scope != nil {
		scope := *source.Scope
		scopeTemp := genruntime.ToEnum(scope, loadBalancerPropertiesFormat_Scope_Values)
		balancer.Scope = &scopeTemp
	} else {
		balancer.Scope = nil
	}
...
func (balancer *LoadBalancer_Spec) Initialize_From_LoadBalancer_STATUS(source *LoadBalancer_STATUS) error {
	...
	// Scope
	if source.Scope != nil {
		scope := genruntime.ToEnum(string(*source.Scope), loadBalancerPropertiesFormat_Scope_Values)
		balancer.Scope = &scope
	} else {
		balancer.Scope = nil
	}
...
type LoadBalancer_STATUS struct {
	...
	ProvisioningState *LoadBalancerProvisioningState_STATUS `json:"provisioningState,omitempty"`

	// ResourceGuid: The resource GUID property of the load balancer resource.
	ResourceGuid *string `json:"resourceGuid,omitempty"`

	// Scope: Indicates the scope of the load balancer: external (Public) or internal (Private).
	Scope *LoadBalancerPropertiesFormat_Scope_STATUS `json:"scope,omitempty"`
...
func (balancer *LoadBalancer_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			provisioningState := LoadBalancerProvisioningState_STATUS(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.Scope != nil {
			var temp string
			temp = string(*typedInput.Properties.Scope)
			scope := LoadBalancerPropertiesFormat_Scope_STATUS(temp)
			balancer.Scope = &scope
		}
	}
...
func (balancer *LoadBalancer_STATUS) AssignProperties_From_LoadBalancer_STATUS(source *storage.LoadBalancer_STATUS) error {
	...
	if source.ProvisioningState != nil {
		...
		provisioningStateTemp := genruntime.ToEnum(provisioningState, loadBalancerProvisioningState_STATUS_Values)
	...
	if source.Scope != nil {
		scope := *source.Scope
		scopeTemp := genruntime.ToEnum(scope, loadBalancerPropertiesFormat_Scope_STATUS_Values)
		balancer.Scope = &scopeTemp
	} else {
		balancer.Scope = nil
	}
...
type LoadBalancerPropertiesFormat_Scope string

const (
	LoadBalancerPropertiesFormat_Scope_Private = LoadBalancerPropertiesFormat_Scope("Private")
	LoadBalancerPropertiesFormat_Scope_Public  = LoadBalancerPropertiesFormat_Scope("Public")
)

// Mapping from string to LoadBalancerPropertiesFormat_Scope
var loadBalancerPropertiesFormat_Scope_Values = map[string]LoadBalancerPropertiesFormat_Scope{
	"private": LoadBalancerPropertiesFormat_Scope_Private,
	"public":  LoadBalancerPropertiesFormat_Scope_Public,
}

type LoadBalancerPropertiesFormat_Scope_STATUS string

const (
	LoadBalancerPropertiesFormat_Scope_STATUS_Private = LoadBalancerPropertiesFormat_Scope_STATUS("Private")
	LoadBalancerPropertiesFormat_Scope_STATUS_Public  = LoadBalancerPropertiesFormat_Scope_STATUS("Public")
)

// Mapping from string to LoadBalancerPropertiesFormat_Scope_STATUS
var loadBalancerPropertiesFormat_Scope_STATUS_Values = map[string]LoadBalancerPropertiesFormat_Scope_STATUS{
	"private": LoadBalancerPropertiesFormat_Scope_STATUS_Private,
	"public":  LoadBalancerPropertiesFormat_Scope_STATUS_Public,
}

// The current provisioning state.
type LoadBalancerProvisioningState_STATUS string

const (
	LoadBalancerProvisioningState_STATUS_Deleting  = LoadBalancerProvisioningState_STATUS("Deleting")
	LoadBalancerProvisioningState_STATUS_Failed    = LoadBalancerProvisioningState_STATUS("Failed")
	LoadBalancerProvisioningState_STATUS_Succeeded = LoadBalancerProvisioningState_STATUS("Succeeded")
	LoadBalancerProvisioningState_STATUS_Updating  = LoadBalancerProvisioningState_STATUS("Updating")
)

// Mapping from string to LoadBalancerProvisioningState_STATUS
var loadBalancerProvisioningState_STATUS_Values = map[string]LoadBalancerProvisioningState_STATUS{
	"deleting":  LoadBalancerProvisioningState_STATUS_Deleting,
	"failed":    LoadBalancerProvisioningState_STATUS_Failed,
	"succeeded": LoadBalancerProvisioningState_STATUS_Succeeded,
	"updating":  LoadBalancerProvisioningState_STATUS_Updating,
}
...
func (rule *LoadBalancingRule) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if rule.BackendAddressPool != nil ||
		...
		rule.EnableConnectionTracking != nil ||
	...
	if rule.EnableConnectionTracking != nil {
		enableConnectionTracking := *rule.EnableConnectionTracking
		result.Properties.EnableConnectionTracking = &enableConnectionTracking
	}
...
func (rule *LoadBalancingRule) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "EnableConnectionTracking":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.EnableConnectionTracking != nil {
			enableConnectionTracking := *typedInput.Properties.EnableConnectionTracking
			rule.EnableConnectionTracking = &enableConnectionTracking
		}
	}
...
func (rule *LoadBalancingRule) AssignProperties_From_LoadBalancingRule(source *storage.LoadBalancingRule) error {
	...
	if source.EnableConnectionTracking != nil {
		enableConnectionTracking := *source.EnableConnectionTracking
		rule.EnableConnectionTracking = &enableConnectionTracking
	} else {
		rule.EnableConnectionTracking = nil
	}
