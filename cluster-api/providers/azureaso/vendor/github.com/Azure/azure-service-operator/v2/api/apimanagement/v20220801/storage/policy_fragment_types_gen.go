...
func (fragment *PolicyFragment) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/PolicyFragment but received %T instead", hub)
	}
...
// Storage version of v20220801.PolicyFragment_Spec
...
// Storage version of v20220801.PolicyFragment_STATUS
