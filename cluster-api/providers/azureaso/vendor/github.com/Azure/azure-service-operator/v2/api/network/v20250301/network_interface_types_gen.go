...
func (networkInterface *NetworkInterface_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DefaultOutboundConnectivityEnabled":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DefaultOutboundConnectivityEnabled != nil {
			defaultOutboundConnectivityEnabled := *typedInput.Properties.DefaultOutboundConnectivityEnabled
			networkInterface.DefaultOutboundConnectivityEnabled = &defaultOutboundConnectivityEnabled
		}
	}
...
func (networkInterface *NetworkInterface_STATUS) AssignProperties_From_NetworkInterface_STATUS(source *storage.NetworkInterface_STATUS) error {
	...
	if source.DefaultOutboundConnectivityEnabled != nil {
		defaultOutboundConnectivityEnabled := *source.DefaultOutboundConnectivityEnabled
		networkInterface.DefaultOutboundConnectivityEnabled = &defaultOutboundConnectivityEnabled
	} else {
		networkInterface.DefaultOutboundConnectivityEnabled = nil
	}
...
func (networkInterface *NetworkInterface_STATUS) AssignProperties_To_NetworkInterface_STATUS(destination *storage.NetworkInterface_STATUS) error {
	...
	// DefaultOutboundConnectivityEnabled
	if networkInterface.DefaultOutboundConnectivityEnabled != nil {
		defaultOutboundConnectivityEnabled := *networkInterface.DefaultOutboundConnectivityEnabled
