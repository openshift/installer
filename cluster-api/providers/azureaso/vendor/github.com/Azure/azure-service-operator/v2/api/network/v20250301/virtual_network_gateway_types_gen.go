...
type VirtualNetworkGateway_Spec struct {
	...
	// EnableHighBandwidthVpnGateway: To enable Advanced Connectivity feature for VPN gateway
...
func (gateway *VirtualNetworkGateway_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if gateway.ActiveActive != nil ||
		...
		gateway.EnableHighBandwidthVpnGateway != nil ||
		...
		gateway.VirtualNetworkGatewayMigrationStatus != nil ||
	...
	if gateway.EnableHighBandwidthVpnGateway != nil {
		enableHighBandwidthVpnGateway := *gateway.EnableHighBandwidthVpnGateway
		result.Properties.EnableHighBandwidthVpnGateway = &enableHighBandwidthVpnGateway
	}
	...
	if gateway.VirtualNetworkGatewayMigrationStatus != nil {
		virtualNetworkGatewayMigrationStatus_ARM, err := gateway.VirtualNetworkGatewayMigrationStatus.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		virtualNetworkGatewayMigrationStatus := *virtualNetworkGatewayMigrationStatus_ARM.(*arm.VirtualNetworkGatewayMigrationStatus)
		result.Properties.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
	}
...
func (gateway *VirtualNetworkGateway_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "EnableHighBandwidthVpnGateway":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.EnableHighBandwidthVpnGateway != nil {
			enableHighBandwidthVpnGateway := *typedInput.Properties.EnableHighBandwidthVpnGateway
			gateway.EnableHighBandwidthVpnGateway = &enableHighBandwidthVpnGateway
		}
	}
	...
	// Set property "VirtualNetworkGatewayMigrationStatus":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.VirtualNetworkGatewayMigrationStatus != nil {
			var virtualNetworkGatewayMigrationStatus1 VirtualNetworkGatewayMigrationStatus
			err := virtualNetworkGatewayMigrationStatus1.PopulateFromARM(owner, *typedInput.Properties.VirtualNetworkGatewayMigrationStatus)
			if err != nil {
				return err
			}
			virtualNetworkGatewayMigrationStatus := virtualNetworkGatewayMigrationStatus1
			gateway.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
		}
	}
...
func (gateway *VirtualNetworkGateway_Spec) AssignProperties_From_VirtualNetworkGateway_Spec(source *storage.VirtualNetworkGateway_Spec) error {
	...
	if source.EnableHighBandwidthVpnGateway != nil {
		enableHighBandwidthVpnGateway := *source.EnableHighBandwidthVpnGateway
		gateway.EnableHighBandwidthVpnGateway = &enableHighBandwidthVpnGateway
	} else {
		gateway.EnableHighBandwidthVpnGateway = nil
	}
	...
	if source.VirtualNetworkGatewayMigrationStatus != nil {
		var virtualNetworkGatewayMigrationStatus VirtualNetworkGatewayMigrationStatus
		err := virtualNetworkGatewayMigrationStatus.AssignProperties_From_VirtualNetworkGatewayMigrationStatus(source.VirtualNetworkGatewayMigrationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_VirtualNetworkGatewayMigrationStatus() to populate field VirtualNetworkGatewayMigrationStatus")
		}
		gateway.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
	} else {
		gateway.VirtualNetworkGatewayMigrationStatus = nil
...
func (gateway *VirtualNetworkGateway_Spec) AssignProperties_To_VirtualNetworkGateway_Spec(destination *storage.VirtualNetworkGateway_Spec) error {
	...
	// VirtualNetworkGatewayMigrationStatus
	if gateway.VirtualNetworkGatewayMigrationStatus != nil {
		var virtualNetworkGatewayMigrationStatus storage.VirtualNetworkGatewayMigrationStatus
		err := gateway.VirtualNetworkGatewayMigrationStatus.AssignProperties_To_VirtualNetworkGatewayMigrationStatus(&virtualNetworkGatewayMigrationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_VirtualNetworkGatewayMigrationStatus() to populate field VirtualNetworkGatewayMigrationStatus")
		}
...
func (gateway *VirtualNetworkGateway_Spec) Initialize_From_VirtualNetworkGateway_STATUS(source *VirtualNetworkGateway_STATUS) error {
	...
	if source.VirtualNetworkGatewayMigrationStatus != nil {
		var virtualNetworkGatewayMigrationStatus VirtualNetworkGatewayMigrationStatus
		err := virtualNetworkGatewayMigrationStatus.Initialize_From_VirtualNetworkGatewayMigrationStatus_STATUS(source.VirtualNetworkGatewayMigrationStatus)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_VirtualNetworkGatewayMigrationStatus_STATUS() to populate field VirtualNetworkGatewayMigrationStatus")
		}
		gateway.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
	} else {
		gateway.VirtualNetworkGatewayMigrationStatus = nil
...
type VirtualNetworkGateway_STATUS struct {
	...
	ProvisioningState *VirtualNetworkGatewayProvisioningState_STATUS `json:"provisioningState,omitempty"`
	...
	// VirtualNetworkGatewayMigrationStatus: The reference to the VirtualNetworkGatewayMigrationStatus which represents the
	// status of migration.
	VirtualNetworkGatewayMigrationStatus *VirtualNetworkGatewayMigrationStatus_STATUS `json:"virtualNetworkGatewayMigrationStatus,omitempty"`
...
func (gateway *VirtualNetworkGateway_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			provisioningState := VirtualNetworkGatewayProvisioningState_STATUS(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.VirtualNetworkGatewayMigrationStatus != nil {
			var virtualNetworkGatewayMigrationStatus1 VirtualNetworkGatewayMigrationStatus_STATUS
			err := virtualNetworkGatewayMigrationStatus1.PopulateFromARM(owner, *typedInput.Properties.VirtualNetworkGatewayMigrationStatus)
			if err != nil {
				return err
			}
...
func (gateway *VirtualNetworkGateway_STATUS) AssignProperties_From_VirtualNetworkGateway_STATUS(source *storage.VirtualNetworkGateway_STATUS) error {
	...
	if source.ProvisioningState != nil {
		...
		provisioningStateTemp := genruntime.ToEnum(provisioningState, virtualNetworkGatewayProvisioningState_STATUS_Values)
	...
	// VirtualNetworkGatewayMigrationStatus
	if source.VirtualNetworkGatewayMigrationStatus != nil {
		var virtualNetworkGatewayMigrationStatus VirtualNetworkGatewayMigrationStatus_STATUS
		err := virtualNetworkGatewayMigrationStatus.AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS(source.VirtualNetworkGatewayMigrationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS() to populate field VirtualNetworkGatewayMigrationStatus")
		}
		gateway.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
	} else {
		gateway.VirtualNetworkGatewayMigrationStatus = nil
...
func (gateway *VirtualNetworkGateway_STATUS) AssignProperties_To_VirtualNetworkGateway_STATUS(destination *storage.VirtualNetworkGateway_STATUS) error {
	...
	// VirtualNetworkGatewayMigrationStatus
	if gateway.VirtualNetworkGatewayMigrationStatus != nil {
		var virtualNetworkGatewayMigrationStatus storage.VirtualNetworkGatewayMigrationStatus_STATUS
		err := gateway.VirtualNetworkGatewayMigrationStatus.AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS(&virtualNetworkGatewayMigrationStatus)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS() to populate field VirtualNetworkGatewayMigrationStatus")
		}
		destination.VirtualNetworkGatewayMigrationStatus = &virtualNetworkGatewayMigrationStatus
	} else {
		destination.VirtualNetworkGatewayMigrationStatus = nil
...
type VirtualNetworkGatewayMigrationStatus struct {
	// ErrorMessage: Error if any occurs during migration.
	ErrorMessage *string `json:"errorMessage,omitempty"`

	// Phase: Represent the current migration phase of gateway.
	Phase *VirtualNetworkGatewayMigrationStatus_Phase `json:"phase,omitempty"`

	// State: Represent the current state of gateway migration.
	State *VirtualNetworkGatewayMigrationStatus_State `json:"state,omitempty"`
}

var _ genruntime.ARMTransformer = &VirtualNetworkGatewayMigrationStatus{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (status *VirtualNetworkGatewayMigrationStatus) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if status == nil {
		return nil, nil
	}
	result := &arm.VirtualNetworkGatewayMigrationStatus{}
	...
	if status.Phase != nil {
		var temp string
		temp = string(*status.Phase)
		phase := arm.VirtualNetworkGatewayMigrationStatus_Phase(temp)
		result.Phase = &phase
	}
	...
	if status.State != nil {
		var temp string
		temp = string(*status.State)
		state := arm.VirtualNetworkGatewayMigrationStatus_State(temp)
		result.State = &state
	}
	return result, nil
}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *VirtualNetworkGatewayMigrationStatus) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.VirtualNetworkGatewayMigrationStatus{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *VirtualNetworkGatewayMigrationStatus) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.VirtualNetworkGatewayMigrationStatus)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.VirtualNetworkGatewayMigrationStatus, got %T", armInput)
	}
	...
	// Set property "Phase":
	if typedInput.Phase != nil {
		var temp string
		temp = string(*typedInput.Phase)
		phase := VirtualNetworkGatewayMigrationStatus_Phase(temp)
		status.Phase = &phase
	}
	...
	if typedInput.State != nil {
		...
		state := VirtualNetworkGatewayMigrationStatus_State(temp)
		status.State = &state
	}
...
// AssignProperties_From_VirtualNetworkGatewayMigrationStatus populates our VirtualNetworkGatewayMigrationStatus from the provided source VirtualNetworkGatewayMigrationStatus
func (status *VirtualNetworkGatewayMigrationStatus) AssignProperties_From_VirtualNetworkGatewayMigrationStatus(source *storage.VirtualNetworkGatewayMigrationStatus) error {

	// ErrorMessage
	status.ErrorMessage = genruntime.ClonePointerToString(source.ErrorMessage)

	// Phase
	if source.Phase != nil {
		phase := *source.Phase
		phaseTemp := genruntime.ToEnum(phase, virtualNetworkGatewayMigrationStatus_Phase_Values)
		status.Phase = &phaseTemp
	} else {
		status.Phase = nil
	}
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, virtualNetworkGatewayMigrationStatus_State_Values)
...
// AssignProperties_To_VirtualNetworkGatewayMigrationStatus populates the provided destination VirtualNetworkGatewayMigrationStatus from our VirtualNetworkGatewayMigrationStatus
func (status *VirtualNetworkGatewayMigrationStatus) AssignProperties_To_VirtualNetworkGatewayMigrationStatus(destination *storage.VirtualNetworkGatewayMigrationStatus) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ErrorMessage
	destination.ErrorMessage = genruntime.ClonePointerToString(status.ErrorMessage)
...
// Initialize_From_VirtualNetworkGatewayMigrationStatus_STATUS populates our VirtualNetworkGatewayMigrationStatus from the provided source VirtualNetworkGatewayMigrationStatus_STATUS
func (status *VirtualNetworkGatewayMigrationStatus) Initialize_From_VirtualNetworkGatewayMigrationStatus_STATUS(source *VirtualNetworkGatewayMigrationStatus_STATUS) error {
	...
	// Phase
	if source.Phase != nil {
		phase := genruntime.ToEnum(string(*source.Phase), virtualNetworkGatewayMigrationStatus_Phase_Values)
		status.Phase = &phase
	} else {
		status.Phase = nil
	}
	...
	// State
	if source.State != nil {
		state := genruntime.ToEnum(string(*source.State), virtualNetworkGatewayMigrationStatus_State_Values)
		status.State = &state
	} else {
		status.State = nil
	}
...
// Migration status for the Virtual Network Gateway.
type VirtualNetworkGatewayMigrationStatus_STATUS struct {
	// ErrorMessage: Error if any occurs during migration.
	ErrorMessage *string `json:"errorMessage,omitempty"`

	// Phase: Represent the current migration phase of gateway.
	Phase *VirtualNetworkGatewayMigrationStatus_Phase_STATUS `json:"phase,omitempty"`

	// State: Represent the current state of gateway migration.
	State *VirtualNetworkGatewayMigrationStatus_State_STATUS `json:"state,omitempty"`
}

var _ genruntime.FromARMConverter = &VirtualNetworkGatewayMigrationStatus_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *VirtualNetworkGatewayMigrationStatus_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.VirtualNetworkGatewayMigrationStatus_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *VirtualNetworkGatewayMigrationStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.VirtualNetworkGatewayMigrationStatus_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.VirtualNetworkGatewayMigrationStatus_STATUS, got %T", armInput)
	}
	...
	if typedInput.Phase != nil {
		var temp string
		temp = string(*typedInput.Phase)
		phase := VirtualNetworkGatewayMigrationStatus_Phase_STATUS(temp)
		status.Phase = &phase
	}
	...
	if typedInput.State != nil {
		var temp string
		temp = string(*typedInput.State)
		state := VirtualNetworkGatewayMigrationStatus_State_STATUS(temp)
		status.State = &state
	}
...
// AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS populates our VirtualNetworkGatewayMigrationStatus_STATUS from the provided source VirtualNetworkGatewayMigrationStatus_STATUS
func (status *VirtualNetworkGatewayMigrationStatus_STATUS) AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS(source *storage.VirtualNetworkGatewayMigrationStatus_STATUS) error {
	...
	if source.Phase != nil {
		phase := *source.Phase
		phaseTemp := genruntime.ToEnum(phase, virtualNetworkGatewayMigrationStatus_Phase_STATUS_Values)
		status.Phase = &phaseTemp
	} else {
		status.Phase = nil
	}
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, virtualNetworkGatewayMigrationStatus_State_STATUS_Values)
		status.State = &stateTemp
	} else {
		status.State = nil
	}
...
// AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS populates the provided destination VirtualNetworkGatewayMigrationStatus_STATUS from our VirtualNetworkGatewayMigrationStatus_STATUS
func (status *VirtualNetworkGatewayMigrationStatus_STATUS) AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS(destination *storage.VirtualNetworkGatewayMigrationStatus_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
type VirtualNetworkGatewayProvisioningState_STATUS string

const (
	VirtualNetworkGatewayProvisioningState_STATUS_Deleting  = VirtualNetworkGatewayProvisioningState_STATUS("Deleting")
	VirtualNetworkGatewayProvisioningState_STATUS_Failed    = VirtualNetworkGatewayProvisioningState_STATUS("Failed")
	VirtualNetworkGatewayProvisioningState_STATUS_Succeeded = VirtualNetworkGatewayProvisioningState_STATUS("Succeeded")
	VirtualNetworkGatewayProvisioningState_STATUS_Updating  = VirtualNetworkGatewayProvisioningState_STATUS("Updating")
)

// Mapping from string to VirtualNetworkGatewayProvisioningState_STATUS
var virtualNetworkGatewayProvisioningState_STATUS_Values = map[string]VirtualNetworkGatewayProvisioningState_STATUS{
	"deleting":  VirtualNetworkGatewayProvisioningState_STATUS_Deleting,
	"failed":    VirtualNetworkGatewayProvisioningState_STATUS_Failed,
	"succeeded": VirtualNetworkGatewayProvisioningState_STATUS_Succeeded,
	"updating":  VirtualNetworkGatewayProvisioningState_STATUS_Updating,
}
...
// +kubebuilder:validation:Enum={"Abort","AbortSucceeded","Commit","CommitSucceeded","Execute","ExecuteSucceeded","None","Prepare","PrepareSucceeded"}
type VirtualNetworkGatewayMigrationStatus_Phase string

const (
	VirtualNetworkGatewayMigrationStatus_Phase_Abort            = VirtualNetworkGatewayMigrationStatus_Phase("Abort")
	VirtualNetworkGatewayMigrationStatus_Phase_AbortSucceeded   = VirtualNetworkGatewayMigrationStatus_Phase("AbortSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_Commit           = VirtualNetworkGatewayMigrationStatus_Phase("Commit")
	VirtualNetworkGatewayMigrationStatus_Phase_CommitSucceeded  = VirtualNetworkGatewayMigrationStatus_Phase("CommitSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_Execute          = VirtualNetworkGatewayMigrationStatus_Phase("Execute")
	VirtualNetworkGatewayMigrationStatus_Phase_ExecuteSucceeded = VirtualNetworkGatewayMigrationStatus_Phase("ExecuteSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_None             = VirtualNetworkGatewayMigrationStatus_Phase("None")
	VirtualNetworkGatewayMigrationStatus_Phase_Prepare          = VirtualNetworkGatewayMigrationStatus_Phase("Prepare")
	VirtualNetworkGatewayMigrationStatus_Phase_PrepareSucceeded = VirtualNetworkGatewayMigrationStatus_Phase("PrepareSucceeded")
)

// Mapping from string to VirtualNetworkGatewayMigrationStatus_Phase
var virtualNetworkGatewayMigrationStatus_Phase_Values = map[string]VirtualNetworkGatewayMigrationStatus_Phase{
	"abort":            VirtualNetworkGatewayMigrationStatus_Phase_Abort,
	"abortsucceeded":   VirtualNetworkGatewayMigrationStatus_Phase_AbortSucceeded,
	"commit":           VirtualNetworkGatewayMigrationStatus_Phase_Commit,
	"commitsucceeded":  VirtualNetworkGatewayMigrationStatus_Phase_CommitSucceeded,
	"execute":          VirtualNetworkGatewayMigrationStatus_Phase_Execute,
	"executesucceeded": VirtualNetworkGatewayMigrationStatus_Phase_ExecuteSucceeded,
	"none":             VirtualNetworkGatewayMigrationStatus_Phase_None,
	"prepare":          VirtualNetworkGatewayMigrationStatus_Phase_Prepare,
	"preparesucceeded": VirtualNetworkGatewayMigrationStatus_Phase_PrepareSucceeded,
}

type VirtualNetworkGatewayMigrationStatus_Phase_STATUS string

const (
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Abort            = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("Abort")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_AbortSucceeded   = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("AbortSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Commit           = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("Commit")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_CommitSucceeded  = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("CommitSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Execute          = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("Execute")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_ExecuteSucceeded = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("ExecuteSucceeded")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_None             = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("None")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Prepare          = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("Prepare")
	VirtualNetworkGatewayMigrationStatus_Phase_STATUS_PrepareSucceeded = VirtualNetworkGatewayMigrationStatus_Phase_STATUS("PrepareSucceeded")
)

// Mapping from string to VirtualNetworkGatewayMigrationStatus_Phase_STATUS
var virtualNetworkGatewayMigrationStatus_Phase_STATUS_Values = map[string]VirtualNetworkGatewayMigrationStatus_Phase_STATUS{
	"abort":            VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Abort,
	"abortsucceeded":   VirtualNetworkGatewayMigrationStatus_Phase_STATUS_AbortSucceeded,
	"commit":           VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Commit,
	"commitsucceeded":  VirtualNetworkGatewayMigrationStatus_Phase_STATUS_CommitSucceeded,
	"execute":          VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Execute,
	"executesucceeded": VirtualNetworkGatewayMigrationStatus_Phase_STATUS_ExecuteSucceeded,
	"none":             VirtualNetworkGatewayMigrationStatus_Phase_STATUS_None,
	"prepare":          VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Prepare,
	"preparesucceeded": VirtualNetworkGatewayMigrationStatus_Phase_STATUS_PrepareSucceeded,
}

// +kubebuilder:validation:Enum={"Failed","InProgress","None","Succeeded"}
type VirtualNetworkGatewayMigrationStatus_State string

const (
	VirtualNetworkGatewayMigrationStatus_State_Failed     = VirtualNetworkGatewayMigrationStatus_State("Failed")
	VirtualNetworkGatewayMigrationStatus_State_InProgress = VirtualNetworkGatewayMigrationStatus_State("InProgress")
	VirtualNetworkGatewayMigrationStatus_State_None       = VirtualNetworkGatewayMigrationStatus_State("None")
	VirtualNetworkGatewayMigrationStatus_State_Succeeded  = VirtualNetworkGatewayMigrationStatus_State("Succeeded")
)

// Mapping from string to VirtualNetworkGatewayMigrationStatus_State
var virtualNetworkGatewayMigrationStatus_State_Values = map[string]VirtualNetworkGatewayMigrationStatus_State{
	"failed":     VirtualNetworkGatewayMigrationStatus_State_Failed,
	"inprogress": VirtualNetworkGatewayMigrationStatus_State_InProgress,
	"none":       VirtualNetworkGatewayMigrationStatus_State_None,
	"succeeded":  VirtualNetworkGatewayMigrationStatus_State_Succeeded,
}

type VirtualNetworkGatewayMigrationStatus_State_STATUS string

const (
	VirtualNetworkGatewayMigrationStatus_State_STATUS_Failed     = VirtualNetworkGatewayMigrationStatus_State_STATUS("Failed")
	VirtualNetworkGatewayMigrationStatus_State_STATUS_InProgress = VirtualNetworkGatewayMigrationStatus_State_STATUS("InProgress")
	VirtualNetworkGatewayMigrationStatus_State_STATUS_None       = VirtualNetworkGatewayMigrationStatus_State_STATUS("None")
	VirtualNetworkGatewayMigrationStatus_State_STATUS_Succeeded  = VirtualNetworkGatewayMigrationStatus_State_STATUS("Succeeded")
)

// Mapping from string to VirtualNetworkGatewayMigrationStatus_State_STATUS
var virtualNetworkGatewayMigrationStatus_State_STATUS_Values = map[string]VirtualNetworkGatewayMigrationStatus_State_STATUS{
	"failed":     VirtualNetworkGatewayMigrationStatus_State_STATUS_Failed,
	"inprogress": VirtualNetworkGatewayMigrationStatus_State_STATUS_InProgress,
	"none":       VirtualNetworkGatewayMigrationStatus_State_STATUS_None,
	"succeeded":  VirtualNetworkGatewayMigrationStatus_State_STATUS_Succeeded,
}
