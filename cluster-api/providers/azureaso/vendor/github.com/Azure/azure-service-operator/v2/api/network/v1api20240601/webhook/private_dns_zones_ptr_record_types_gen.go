...
func (record *PrivateDnsZonesPTRRecord) validateOptionalConfigMapReferences(ctx context.Context, obj *v20240601.PrivateDnsZonesPTRRecord) (admission.Warnings, error) {
