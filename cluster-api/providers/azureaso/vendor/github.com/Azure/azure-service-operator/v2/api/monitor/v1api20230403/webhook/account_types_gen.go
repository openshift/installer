...
func (account *Account) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20230403.Account)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/monitor/v1api20230403/Account, but got %T", obj)
	}
...
func (account *Account) defaultAzureName(ctx context.Context, obj *v20230403.Account) error {
...
func (account *Account) defaultImpl(ctx context.Context, obj *v20230403.Account) error {
...
func (account *Account) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20230403.Account)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/monitor/v1api20230403/Account, but got %T", resource)
	}
	validations := account.createValidations()
	var temp any = account
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20230403.Account]); ok {
...
func (account *Account) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20230403.Account)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/monitor/v1api20230403/Account, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230403.Account)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/monitor/v1api20230403/Account, but got %T", oldResource)
	}
...
func (account *Account) deleteValidations() []func(ctx context.Context, obj *v20230403.Account) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (account *Account) updateValidations() []func(ctx context.Context, oldObj *v20230403.Account, newObj *v20230403.Account) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20230403.Account, newObj *v20230403.Account) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20230403.Account, newObj *v20230403.Account) (admission.Warnings, error) {
...
func (account *Account) validateConfigMapDestinations(ctx context.Context, obj *v20230403.Account) (admission.Warnings, error) {
...
func (account *Account) validateOwnerReference(ctx context.Context, obj *v20230403.Account) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (account *Account) validateResourceReferences(ctx context.Context, obj *v20230403.Account) (admission.Warnings, error) {
...
func (account *Account) validateSecretDestinations(ctx context.Context, obj *v20230403.Account) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (account *Account) validateWriteOnceProperties(ctx context.Context, oldObj *v20230403.Account, newObj *v20230403.Account) (admission.Warnings, error) {
