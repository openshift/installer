...
// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v20220801-apiversionset,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=apiversionsets,verbs=create;update,versions=v20220801,name=default.v20220801.apiversionsets.apimanagement.azure.com,admissionReviewVersions=v1
...
func (versionSet *ApiVersionSet) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/ApiVersionSet, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v20220801-apiversionset,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=apiversionsets,verbs=create;update,versions=v20220801,name=validate.v20220801.apiversionsets.apimanagement.azure.com,admissionReviewVersions=v1
...
func (versionSet *ApiVersionSet) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/ApiVersionSet, but got %T", resource)
	}
...
func (versionSet *ApiVersionSet) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/ApiVersionSet, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20220801.ApiVersionSet)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20220801/ApiVersionSet, but got %T", oldResource)
	}
