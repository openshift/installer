...
// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v20230501preview-service,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=services,verbs=create;update,versions=v20230501preview,name=default.v20230501preview.services.apimanagement.azure.com,admissionReviewVersions=v1
...
func (service *Service) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Service, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v20230501preview-service,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=services,verbs=create;update,versions=v20230501preview,name=validate.v20230501preview.services.apimanagement.azure.com,admissionReviewVersions=v1
...
func (service *Service) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Service, but got %T", resource)
	}
...
func (service *Service) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Service, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230501p.Service)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/apimanagement/v20230501preview/Service, but got %T", oldResource)
	}
