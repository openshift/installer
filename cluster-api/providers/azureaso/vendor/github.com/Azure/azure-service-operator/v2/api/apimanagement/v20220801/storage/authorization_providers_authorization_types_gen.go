...
func (authorization *AuthorizationProvidersAuthorization) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/AuthorizationProvidersAuthorization but received %T instead", hub)
	}
...
// Storage version of v20220801.AuthorizationProvidersAuthorization_Spec
...
// Storage version of v20220801.AuthorizationProvidersAuthorization_STATUS
