...
func (service *Service) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/Service but received %T instead", hub)
	}
...
// Storage version of v20220801.Service_Spec
...
// Storage version of v20220801.Service_STATUS
...
// Storage version of v20220801.UserIdentityProperties_STATUS
