...
func (service *StorageAccountsFileService) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsFileService, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-storage-azure-com-v20230101-storageaccountsfileservice,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=storage.azure.com,resources=storageaccountsfileservices,verbs=create;update,versions=v20230101,name=validate.v20230101.storageaccountsfileservices.storage.azure.com,admissionReviewVersions=v1
...
func (service *StorageAccountsFileService) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsFileService, but got %T", resource)
	}
...
func (service *StorageAccountsFileService) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsFileService, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230101.StorageAccountsFileService)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v20230101/StorageAccountsFileService, but got %T", oldResource)
	}
