...
func (productApi *ProductApi) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v20240501/storage/ProductApi but received %T instead", hub)
	}
...
// Storage version of v20220801.ProductApi_Spec
...
// Storage version of v20220801.ProductApi_STATUS
