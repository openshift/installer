...
echo "checking yq"
yq --version &>/dev/null || throw "jq is not installed, please install. https://github.com/mikefarah/yq/releases"
echo "checking oc client"
oc version &>/dev/null || throw "oc is not installed, please install. https://docs.openshift.com/container-platform/4.2/cli_reference/openshift_cli/getting-started-cli.html#cli-installing-cli_cli-developer-commands"
echo "checking kubectl"
kubectl version &>/dev/null || throw "kubectl is not installed, please install. https://kubernetes.io/docs/tasks/tools/install-kubectl/"
echo "checking openshift-install"
openshift-install version &>/dev/null || throw "openshift-install is not installed, please install. https://docs.openshift.com/container-platform/4.2/installing/installing_azure/installing-azure-default.html#installation-obtaining-installer_installing-azure-default"
