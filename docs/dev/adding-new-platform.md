...
No PR will be merged to openshift/installer for platform support that cannot
...
When adding a new platform to the installer, the infrastructure setting should
