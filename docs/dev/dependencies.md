...
# For example, go get sigs.k8s.io/cluster-api-provider-aws/v2@17a09f591
go get sigs.k8s.io/cluster-api-provider-aws/v2@<commit-hash>
...
git fetch origin && git checkout <commit-hash>
```
