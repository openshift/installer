	...
	cases := []struct {
		...
		},
		{
			...
			platform: &baremetal.Platform{
				...
				ClusterProvisioningIP:   "172.22.0.3",
				BootstrapProvisioningIP: "172.22.0.2",
				ProvisioningDHCPRange:   &[]string{"172.22.0.10,172.22.0.50"}[0],
				ExternalBridge:          "br0",
				ProvisioningBridge:      "br1",
			},
			network: network,
		},
		{
			...
			platform: &baremetal.Platform{
				...
				ClusterProvisioningIP:   "172.22.0.3",
				BootstrapProvisioningIP: "172.22.0.2",
				ProvisioningDHCPRange:   &[]string{"172.22.0.10,"}[0],
				ExternalBridge:          "br0",
				ProvisioningBridge:      "br1",
			},
			network:  network,
		...
		},
		{
			...
			platform: &baremetal.Platform{
				...
				ClusterProvisioningIP:   "172.22.0.3",
				BootstrapProvisioningIP: "172.22.0.2",
				ProvisioningDHCPRange:   &[]string{"172.22.0.19"}[0],
				ExternalBridge:          "br0",
				ProvisioningBridge:      "br1",
			},
			network:  network,
		...
		},
		{
			...
			platform: &baremetal.Platform{
				...
				ClusterProvisioningIP:   "172.22.0.3",
				BootstrapProvisioningIP: "172.22.0.2",
				ProvisioningDHCPRange:   &[]string{"192.168.128.1,172.22.0.100"}[0],
				ExternalBridge:          "br0",
				ProvisioningBridge:      "br1",
			},
			network:  network,
