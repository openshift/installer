...
func NeedsRHCOSUpload(projectID, region string, mpool *MachinePool) bool {
	return GetCloudEnvironment(projectID, region) == CloudEnvironmentSovereign && mpool.OSImage == nil
}
