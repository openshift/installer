...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfidentialCluster) DeepCopyInto(out *ConfidentialCluster) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfidentialCluster.
func (in *ConfidentialCluster) DeepCopy() *ConfidentialCluster {
	if in == nil {
		return nil
	}
	out := new(ConfidentialCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstallConfig) DeepCopyInto(out *InstallConfig) {
	*out = *in
	...
	if in.ConfidentialCluster != nil {
		in, out := &in.ConfidentialCluster, &out.ConfidentialCluster
		*out = new(ConfidentialCluster)
		**out = **in
	}
	return
