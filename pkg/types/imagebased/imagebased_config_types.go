...
type InstallationConfig struct {
	...
	// +optional
	DeprecatedImageContentSources []types.ImageContentSource `json:"imageContentSources,omitempty"`
	...
	// IgnitionConfigOverride JSON formatted string containing the user overrides
	// for the initial ignition config. This will be merged with the ignition
	// config generated by the ibi-cli for installation iso. Supported version is
	// 3.2.
	// +optional
