...
func (in *ComponentCredentials) DeepCopyInto(out *ComponentCredentials) {
	*out = *in
	out.MachineManagement = in.MachineManagement
	out.Storage = in.Storage
	out.CloudControllerManager = in.CloudControllerManager
	out.VSphereProblemDetector = in.VSphereProblemDetector
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentCredentials.
func (in *ComponentCredentials) DeepCopy() *ComponentCredentials {
	if in == nil {
		return nil
	}
	out := new(ComponentCredentials)
	in.DeepCopyInto(out)
	return out
}
