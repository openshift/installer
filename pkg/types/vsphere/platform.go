...
type Platform struct {
	...
	// +kubebuilder:validation:Optional
	DeploymentZones []DeploymentZoneSpec `json:"deploymentZones,omitempty"`
	...
	// If this is omitted failure domains (regions and zones) will not be used.
	// +kubebuilder:validation:Optional
	FailureDomains []FailureDomainSpec `json:"failureDomains,omitempty"`
}

// FailureDomain holds the name of the associated tag, the type
...
// FailureDomainSpec holds the region and zone failure domain and
// the vCenter topology of that failure domain.
type FailureDomainSpec struct {
	// name defines the name of the FailureDomainSpec
	// This name is abritary but will be used
	...
	// region defines a FailureDomain which
...
// VCenterSpec stores the vCenter connection fields
...
// DeploymentZoneSpec holds the association between a
// vCenter, failure domain and the virtual machine placementConstraints
type DeploymentZoneSpec struct {

	// name is the abritary name of the DeploymentZoneSpec
