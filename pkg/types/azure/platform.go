...
const (
	// API server LB
	InternalFrontendIPv4ConfigName     = "internal-lb-frontend-ipv4"
	InternalFrontendIPv6ConfigName     = "internal-lb-frontend-ipv6"
	InternalBackendAddressPoolIPv4Name = "internal-lb-backend-ipv4"
	InternalBackendAddressPoolIPv6Name = "internal-lb-backend-ipv6"

	// Public LB
	PublicFrontendIPv4ConfigName     = "public-lb-frontend-ipv4"
	PublicFrontendIPv6ConfigName     = "public-lb-frontend-ipv6"
	PublicBackendAddressPoolIPv4Name = "public-lb-backend-ipv4"
	PublicBackendAddressPoolIPv6Name = "public-lb-backend-ipv6"

	// Outbound LB
	OutboundBackendAddressPoolIPv4Name = "public-lb-outbound-ipv4"
	OutboundBackendAddressPoolIPv6Name = "public-lb-outbound-ipv6"
)
