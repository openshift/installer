...
// DiskCategory is the category of the ECS disk. Valid values:
// cloud_essd: ESSD.
// cloud_efficiency: ultra disk.
type DiskCategory string

const (
	// CloudEfficiencySystemDisk is the disk category for ultra disk.
	CloudEfficiencySystemDisk DiskCategory = "cloud_efficiency"

	// CloudESSDSystemDisk is the disk category for ESSD.
	CloudESSDSystemDisk DiskCategory = "cloud_essd"
)
