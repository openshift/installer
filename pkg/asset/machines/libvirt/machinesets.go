...
func MachineSets(clusterID string, config *types.InstallConfig, pool *types.MachinePool, role types.MachineRole, userDataSecret string) ([]*machineapi.MachineSet, error) {
