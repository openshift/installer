...
import (
	...
	equinixmetal "github.com/openshift/installer/pkg/asset/cluster/equinixmetal"
...
func (m *Metadata) Generate(parents asset.Parents) (err error) {
	...
	case equinixtypes.Name:
		metadata.ClusterPlatformMetadata.EquinixMetal = equinixmetal.Metadata(installConfig.Config)
	case nonetypes.Name:
	default:
