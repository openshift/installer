...
func TestFilterUserCaBundle(t *testing.T) {
	filtered := filterCaBundleData(certs)
	assert.Equal(t, userCert, filtered)
}

const userCert = `-----BEGIN CERTIFICATE-----
MIID0zCCArugAwIBAgIUFMfnyXUogJfKSeKtHcTL5Q9tM3MwDQYJKoZIhvcNAQEL
...
BAMMEnRlc3QubWV0YWxrdWJlLm9yZzAeFw0yNTAzMTcxMjA5MzBaFw0yNjAzMTcx
MjA5MzBaMHIxCzAJBgNVBAYTAlVTMQswCQYDVQQIDAJOQzEQMA4GA1UEBwwHUmFs
...

-----END CERTIFICATE-----`
