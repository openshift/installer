...
// List of the trusted CA certs from CoreOS 9.2. Clusters created
// by the agent-based installer method in 4.15 will have these certs
// erroneously included in the user CA list.
var coreOS92CaCerts = map[string]struct{}{
	`-----BEGIN CERTIFICATE-----
