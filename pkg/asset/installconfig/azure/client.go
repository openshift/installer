...
type API interface {
	...
	CheckIfExistsStorageAccount(ctx context.Context, resourceGroup, storageAccountName string) error
}
...
// purposes.
func (c *Client) CheckIfExistsStorageAccount(ctx context.Context, resourceGroup, storageAccountName string) error {
	...
	_, err = storageClient.GetProperties(ctx, resourceGroup, storageAccountName, nil)
	return err
}
