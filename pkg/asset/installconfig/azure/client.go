...
type API interface {
	...
	CheckIfExistsStorageAccount(ctx context.Context, storageAccountURI string) error
}
...
// CheckIfExistsStorageAccount checks if the storage account URI provided already exists for diagnostics
// purposes.
func (c *Client) CheckIfExistsStorageAccount(ctx context.Context, storageAccountURI string) error {
