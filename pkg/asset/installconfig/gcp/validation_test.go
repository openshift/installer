...
func TestValidateInstanceType(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			confidentialCompute: "Enabled",
			expectedError:       true,
			expectedErrMsg:      `^\[instance.type: Invalid value: "c3-standard-4": Machine type does not support Enabled. Machine types supporting Enabled: c2d, n2d, c3d\]`,
		},
		{
		...
		},
		{
			...
			confidentialCompute: "AMDEncryptedVirtualization",
			expectedError:       true,
			expectedErrMsg:      `^\[instance.type: Invalid value: "c3-standard-4": Machine type does not support AMDEncryptedVirtualization. Machine types supporting AMDEncryptedVirtualization: c2d, n2d, c3d\]`,
		},
		{
		...
		},
		{
			...
			confidentialCompute: "AMDEncryptedVirtualizationNestedPaging",
			expectedError:       true,
			expectedErrMsg:      `^\[instance.type: Invalid value: "c2d-standard-4": Machine type does not support AMDEncryptedVirtualizationNestedPaging. Machine types supporting AMDEncryptedVirtualizationNestedPaging: n2d\]`,
		},
		{
		...
		},
		{
			...
			confidentialCompute: "IntelTrustedDomainExtensions",
			expectedError:       true,
			expectedErrMsg:      `^\[instance.type: Invalid value: "n2d-standard-4": Machine type does not support IntelTrustedDomainExtensions. Machine types supporting IntelTrustedDomainExtensions: c3\]`,
		},
		{
