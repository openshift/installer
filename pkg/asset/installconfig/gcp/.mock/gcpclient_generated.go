...
// GetListOfProjects mocks base method.
func (m *MockAPI) GetListOfProjects(ctx context.Context) (map[string]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetListOfProjects", ctx)
	ret0, _ := ret[0].(map[string]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetListOfProjects indicates an expected call of GetListOfProjects.
func (mr *MockAPIMockRecorder) GetListOfProjects(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetListOfProjects", reflect.TypeOf((*MockAPI)(nil).GetListOfProjects), ctx)
}
