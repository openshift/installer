...
// VSphereComponentCredsSecretData holds per-component credentials for vSphere
type VSphereComponentCredsSecretData struct {
	MachineAPI      *[]*VSphereCredsSecretData
	CSIDriver       *[]*VSphereCredsSecretData
	CloudController *[]*VSphereCredsSecretData
	Diagnostics     *[]*VSphereCredsSecretData
}
