...
func TestGenerateIngerssDefaultPlacement(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			installConfigBuildOptions:   []icOption{icBuild.withLBTypeAndEIPAllocations(configv1.NLB, "eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>")},
			controlPlaneTopology:        configv1.HighlyAvailableTopologyMode,
			infrastructureTopology:      configv1.HighlyAvailableTopologyMode,
			expectedIngressPlacement:    configv1.DefaultPlacementWorkers,
			expectedIngressAWSLBType:    configv1.NLB,
			expectedIngressPlatformType: configv1.AWSPlatformType,
			expectedAllocatedEIP:        "eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>,eipalloc-<redacted>",
		},
		{
