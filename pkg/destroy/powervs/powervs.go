...
type ClusterUninstaller struct {
	APIKey           string //nolint:gosec // G117: field name matches secret pattern but value is not a hardcoded secret
	BaseDomain       string
...
func (o *ClusterUninstaller) loadSDKServices() error {
	...
	if len(o.CISInstanceCRN) > 0 {
		...
		cisURL := powervstypes.EndpointURLForService(string(configv1.IBMCloudServiceCIS), o.ServiceEndpoints)
		...
		cisURLForRecords := powervstypes.EndpointURLForService(string(configv1.IBMCloudServiceCIS), o.ServiceEndpoints)
